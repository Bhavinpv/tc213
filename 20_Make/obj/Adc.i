...
# 20 "../30_Bsw/Mcal/Adc/Adc.c" 2
# 1 "../30_Bsw/Mcal/Adc/Adc_cfg.h" 1
# 24 "../30_Bsw/Mcal/Adc/Adc_cfg.h"
...
# 25 "../30_Bsw/Mcal/Adc/Adc_cfg.h" 2



# 1 "../30_Bsw/Common/mcu_cfg.h" 1
# 29 "../30_Bsw/Mcal/Adc/Adc_cfg.h" 2
# 87 "../30_Bsw/Mcal/Adc/Adc_cfg.h"
extern void Adc_cfg(void);
extern void Adc_cfg_ch_B01(void);
extern void Adc_cfg_ch_C0(void);
# 21 "../30_Bsw/Mcal/Adc/Adc.c" 2
...
# 22 "../30_Bsw/Mcal/Adc/Adc.c" 2
# 1 "../30_Bsw/Mcal/Adc/Adc_scfg.h" 1
# 23 "../30_Bsw/Mcal/Adc/Adc.c" 2
# 1 "../40_Appl/HsfbMeas/HsfbMeas_GetInitOffset.h" 1
# 24 "../30_Bsw/Mcal/Adc/Adc.c" 2
...
void Adc_cfg(void)
{
    ...
    (*(Ifx_VADC *)0xF0020000u).CLC.U = 0u;
    IfxScuWdt_setCpuEndinit(IfxScuWdt_getCpuWatchdogPassword());


    (*(Ifx_VADC *)0xF0020000u).G[0].ARBCFG.U = ((3u) | ((uint32)0u) | ((uint32)1u << 7u));
    (*(Ifx_VADC *)0xF0020000u).G[1].ARBCFG.U = ((3u) | ((uint32)0u) | ((uint32)1u << 7u));


    (*(Ifx_VADC *)0xF0020000u).GLOBCFG.U = (((3u) - 1u) | ((((1u) - 1u)*2u) << 8u) | ((uint32)0u << 14u) | ((uint32)1u << 15u) | ((uint32)3u << 16u) | ((uint32)1u << 31u));


    for(u16Index= 0u; u16Index < (12u); u16Index++)
    {
        (*(Ifx_VADC *)0xF0020000u).G[0].CHCTR[u16Index].U |= ((uint32)(u16Index) << 16u);
        (*(Ifx_VADC *)0xF0020000u).G[1].CHCTR[u16Index].U |= ((uint32)(u16Index) << 16u);
    }
# 85 "../30_Bsw/Mcal/Adc/Adc.c"
    (*(Ifx_VADC *)0xF0020000u).G[0].ICLASS[0].B.STCS = 3;
    (*(Ifx_VADC *)0xF0020000u).G[1].ICLASS[0].B.STCS = 3;
    ...
    (*(Ifx_VADC *)0xF0020000u).G[0].ARBPR.U = (((uint32)7u << 24u) | ((((uint32)0x3u) ) | (((uint32)0x2u) << 4) | (((uint32)0x1u) << 8) | (((uint32)0x0u) << 12) ));


    (*(Ifx_VADC *)0xF0020000u).G[1].ARBPR.U = (((uint32)7u << 24u) | (1u << (3u + (4u*(0)))) | ((((uint32)0x3u) ) | (((uint32)0x2u) << 4) | (((uint32)0x1u) << 8) | (((uint32)0x0u) << 12) ));

    while((((*(volatile Ifx_VADC_G_ARBCFG *)0xF0020480u)).U & 0x30000000) != 0x20000000){ __asm("nop") ;}
    while((((*(volatile Ifx_VADC_G_ARBCFG *)0xF0020880u)).U & 0x30000000) != 0x20000000){ __asm("nop") ;}
}

void Adc_cfg_ch_HwVer1(void)
{

    (*(Ifx_VADC *)0xF0020000u).G[0].QINR0.U = (((uint32)(0)) | ((uint32)1u << 5u) | ((uint32)1u << 7u));
    (*(Ifx_VADC *)0xF0020000u).G[0].QINR0.U = (((uint32)(1)) | ((uint32)1u << 5u) | ((uint32)0u << 7u));
    (*(Ifx_VADC *)0xF0020000u).G[0].QINR0.U = (((uint32)(2)) | ((uint32)1u << 5u) | ((uint32)0u << 7u));
    (*(Ifx_VADC *)0xF0020000u).G[0].QINR0.U = (((uint32)(4)) | ((uint32)1u << 5u) | ((uint32)0u << 7u));

    (*(Ifx_VADC *)0xF0020000u).G[0].QCTRL0.U = ((((uint32)(0xFu) << 8u) | ((uint32)1u << 15u)) | (((uint32)2u << 13u) | ((uint32)1u << 15u)) | (((uint32)(0) << 16u) | ((uint32)1u << 23u)));
    (*(Ifx_VADC *)0xF0020000u).G[0].QMR0.U = (((uint32)1u) | ((uint32)1u << 2u));


    (*(Ifx_VADC *)0xF0020000u).G[1].QINR0.U = (((uint32)(0)) | ((uint32)1u << 5u) | ((uint32)1u << 7u));
    (*(Ifx_VADC *)0xF0020000u).G[1].QINR0.U = (((uint32)(2)) | ((uint32)1u << 5u) | ((uint32)0u << 7u));
    (*(Ifx_VADC *)0xF0020000u).G[1].QINR0.U = (((uint32)(5)) | ((uint32)1u << 5u) | ((uint32)0u << 7u));
    (*(Ifx_VADC *)0xF0020000u).G[1].QINR0.U = (((uint32)(11)) | ((uint32)1u << 5u) | ((uint32)0u << 7u));

    (*(Ifx_VADC *)0xF0020000u).G[1].QCTRL0.U = ((((uint32)(0xFu) << 8u) | ((uint32)1u << 15u)) | (((uint32)2u << 13u) | ((uint32)1u << 15u)) | (((uint32)(0) << 16u) | ((uint32)1u << 23u)));
    (*(Ifx_VADC *)0xF0020000u).G[1].QMR0.U = (((uint32)1u) | ((uint32)1u << 2u));


    (*(Ifx_VADC *)0xF0020000u).G[0].ASCTRL.U = ((((uint32)(0xFu) << 8u) | ((uint32)1u << 15u)) | (((uint32)2u << 13u) | ((uint32)1u << 15u)) | (((uint32)(1) << 16u) | ((uint32)1u << 23u)));
    (*(Ifx_VADC *)0xF0020000u).G[0].ASMR.U = (((uint32)1u) | ((uint32)1u << 2u) );
    (*(Ifx_VADC *)0xF0020000u).G[0].ASSEL.U = (((uint32)1u << (0)) | ((uint32)1u << (3)) | ((uint32)1u << (5)) | ((uint32)1u << (6)) | ((uint32)1u << (7)));


    (*(Ifx_VADC *)0xF0020000u).G[1].ASCTRL.U = ((((uint32)(0xFu) << 8u) | ((uint32)1u << 15u)) | (((uint32)2u << 13u) | ((uint32)1u << 15u)) | (((uint32)(1) << 16u) | ((uint32)1u << 23u)));
    (*(Ifx_VADC *)0xF0020000u).G[1].ASMR.U = (((uint32)1u) | ((uint32)1u << 2u) );
    (*(Ifx_VADC *)0xF0020000u).G[1].ASSEL.U = (((uint32)1u << (1)) | ((uint32)1u << (3))| ((uint32)1u << (4)) | ((uint32)1u << (6)) |
             ((uint32)1u << (7)) | ((uint32)1u << (8))| ((uint32)1u << (9)) | ((uint32)1u << (10)));
...
void Adc_cfg_ch_HwVer0(void)
{
 ...
 (*(Ifx_VADC *)0xF0020000u).G[0].QINR0.U = (((uint32)(0)) | ((uint32)1u << 5u) | ((uint32)1u << 7u));
    ...
    (*(Ifx_VADC *)0xF0020000u).G[0].ASCTRL.U = ((((uint32)(0xFu) << 8u) | ((uint32)1u << 15u)) | (((uint32)2u << 13u) | ((uint32)1u << 15u)) | (((uint32)(1) << 16u) | ((uint32)1u << 23u)));
    (*(Ifx_VADC *)0xF0020000u).G[0].ASMR.U = (((uint32)1u) | ((uint32)1u << 2u) );
    (*(Ifx_VADC *)0xF0020000u).G[0].ASSEL.U = (((uint32)1u << (3)) | ((uint32)1u << (5)) | ((uint32)1u << (6)) | ((uint32)1u << (7)));


    (*(Ifx_VADC *)0xF0020000u).G[1].ASCTRL.U = ((((uint32)(0xFu) << 8u) | ((uint32)1u << 15u)) | (((uint32)2u << 13u) | ((uint32)1u << 15u)) | (((uint32)(1) << 16u) | ((uint32)1u << 23u)));
    (*(Ifx_VADC *)0xF0020000u).G[1].ASMR.U = (((uint32)1u) | ((uint32)1u << 2u) );
    (*(Ifx_VADC *)0xF0020000u).G[1].ASSEL.U = (((uint32)1u << (1)) | ((uint32)1u << (2)) | ((uint32)1u << (3))| ((uint32)1u << (4)) | ((uint32)1u << (6)));
}
...
void Adc_Pt_Init(void)
{
 ...
 for(i = 0; i < 24; i++)
 {
  AdcResPt[i] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020BACu).U);
 }
...
void Adc_Pt_Init_HwVer1(void)
{
 AdcResPt[ADC_E_Ipri] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020B88u).U);
 AdcResPt[ADC_E_Vin] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020B94u).U);
 AdcResPt[ADC_E_Iout] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020788u).U);
 AdcResPt[ADC_E_Vout] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020790u).U);

 AdcResPt[ADC_E_VoutDiag] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020B80u).U);
 AdcResPt[ADC_E_IproFet] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020784u).U);
 AdcResPt[ADC_E_Vaux] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF002078Cu).U);
 AdcResPt[ADC_E_Vkl30] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020B98u).U);
 AdcResPt[ADC_E_Vkl30C] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020794u).U);

 AdcResPt[ADC_E_Vcomp] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020BA8u).U);
 AdcResPt[ADC_E_VrefDiag] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020B9Cu).U);
 AdcResPt[ADC_E_Vhw16V] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020BA0u).U);
 AdcResPt[ADC_E_Vhw19V] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020BA4u).U);

 AdcResPt[ADC_E_NtcPri] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020B90u).U);
 AdcResPt[ADC_E_NtcSrA] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020780u).U);
 AdcResPt[ADC_E_NtcSrB] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020B8Cu).U);
 AdcResPt[ADC_E_NtcWaterIn] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF002079Cu).U);
 AdcResPt[ADC_E_NtcWaterOut] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020798u).U);
 AdcResPt[ADC_E_NtcWaterOutDiag] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020B84u).U);
}

void Adc_Pt_Init_HwVer0(void)
{
 AdcResPt[ADC_E_Ipri] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020780u).U);
 AdcResPt[ADC_E_Vin] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020784u).U);
 AdcResPt[ADC_E_Iout] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020788u).U);
 AdcResPt[ADC_E_Vout] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020790u).U);

 AdcResPt[ADC_E_VoutDiag] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020B80u).U);
 AdcResPt[ADC_E_IproFet] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020B94u).U);
 AdcResPt[ADC_E_Vaux] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF002078Cu).U);
 AdcResPt[ADC_E_Vkl30] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020B98u).U);
 AdcResPt[ADC_E_Vkl30C] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020794u).U);

 AdcResPt[ADC_E_NtcPri] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020B90u).U);
 AdcResPt[ADC_E_NtcSrA] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020B88u).U);
 AdcResPt[ADC_E_NtcSrB] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020B8Cu).U);
 AdcResPt[ADC_E_NtcWaterIn] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF002079Cu).U);
 AdcResPt[ADC_E_NtcWaterOut] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020798u).U);
 AdcResPt[ADC_E_NtcWaterOutDiag] = (u16 *)&((*(volatile Ifx_VADC_G_RESD *)0xF0020B84u).U);
...
#pragma section
# 268 "../30_Bsw/Mcal/Adc/Adc.c" 2


# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 271 "../30_Bsw/Mcal/Adc/Adc.c" 2
void Adc_ShortDetect_10ms(void)
{
 Adc_FlyBackEnable = (((Main_HwVer.Ver == MAIN_E_HW_C1_C01)|| (Main_HwVer.Ver == MAIN_E_HW_C1_C01_DV))||((Main_HwVer.Ver == MAIN_E_HW_C1_C02)|| (Main_HwVer.Ver == MAIN_E_HW_C1_C02_DV))) && (HsfbPwm_Status.Operation == 0) && (PwmStatus15us.PwmState == HSFBPWM_E_STATE_SteadyRun);
