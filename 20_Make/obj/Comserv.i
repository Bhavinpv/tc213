# 1 "../30_Bsw/ComStack/ComServ/Comserv.c"
...
# 5 "../30_Bsw/ComStack/ComServ/Comserv.c" 2
...
# 6 "../30_Bsw/ComStack/ComServ/Comserv.c" 2
...
# 6 "../30_Bsw/ComStack/ComServ/ComServ_api.h" 2
...
# 7 "../30_Bsw/ComStack/ComServ/Comserv.c" 2
# 1 "../30_Bsw/ComStack/ComServ/ComServ_cfg.h" 1
...
# 8 "../30_Bsw/ComStack/ComServ/ComServ_cfg.h" 2
...
# 9 "../30_Bsw/ComStack/ComServ/ComServ_cfg.h" 2
# 1 "../30_Bsw/Scheduler/Scheduler_api.h" 1
# 27 "../30_Bsw/Scheduler/Scheduler_api.h"
...
# 28 "../30_Bsw/Scheduler/Scheduler_api.h" 2
# 1 "../30_Bsw/ComStack/ComServ/ComServ_api.h" 1
# 29 "../30_Bsw/Scheduler/Scheduler_api.h" 2
# 1 "../30_Bsw/ComStack/ComServ/ComServ_scb.h" 1
...
extern void ComServ_Init(void);
extern void ComServ_1msTask(void);
extern void ComServ_10msTask(void);
# 30 "../30_Bsw/Scheduler/Scheduler_api.h" 2
...
# 35 "../30_Bsw/Scheduler/Scheduler_api.h" 2

# 1 "../30_Bsw/Mcal/Adc/Adc_scb.h" 1
...
# 37 "../30_Bsw/Scheduler/Scheduler_api.h" 2
# 1 "../30_Bsw/Mcal/Can/can_driver.h" 1
# 38 "../30_Bsw/Scheduler/Scheduler_api.h" 2
...
# 39 "../30_Bsw/Scheduler/Scheduler_api.h" 2
...
# 41 "../30_Bsw/Scheduler/Scheduler_api.h" 2
...
# 42 "../30_Bsw/Scheduler/Scheduler_api.h" 2
# 1 "../30_Bsw/ComStack/Uds/Uds.h" 1
# 24 "../30_Bsw/ComStack/Uds/Uds.h"
...
# 25 "../30_Bsw/ComStack/Uds/Uds.h" 2
...
# 43 "../30_Bsw/Scheduler/Scheduler_api.h" 2
# 1 "../30_Bsw/iohw/Static/iohwsf_AccessProt.h" 1
# 30 "../30_Bsw/iohw/Static/iohwsf_AccessProt.h"
...
# 31 "../30_Bsw/iohw/Static/iohwsf_AccessProt.h" 2


# 1 "../30_Bsw/Compilers/IfxCpu_IntrinsicsGnuc.h" 1
# 34 "../30_Bsw/iohw/Static/iohwsf_AccessProt.h" 2
# 58 "../30_Bsw/iohw/Static/iohwsf_AccessProt.h"
extern void IOHWSF_ACCESSPROT_vConfigureAccessProtection(void);
# 72 "../30_Bsw/iohw/Static/iohwsf_AccessProt.h"
static inline void __attribute__((__always_inline__)) IOHWSF_ACCESSPROT_vSwitchToQmISR(void)
{
  Ifx_CPU_PSW PSWRegisterValue;
  PSWRegisterValue.U = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xFE04" : "=d" (__res) :: "memory"); __res; }));
  PSWRegisterValue.B.S = 0;
  PSWRegisterValue.B.IO = 0;
  do { unsigned __newval = (unsigned) (PSWRegisterValue.U); __asm__ volatile ("mtcr LO:" "0xFE04" ", %0" :: "d" (__newval) : "memory"); } while (0);
  __isync();
...
# 44 "../30_Bsw/Scheduler/Scheduler_api.h" 2
# 128 "../30_Bsw/Scheduler/Scheduler_api.h"
...
# 10 "../30_Bsw/ComStack/ComServ/ComServ_cfg.h" 2
# 1 "../40_Appl/HsfbApp/HsfbApp_SetTx10ms.h" 1
# 11 "../30_Bsw/ComStack/ComServ/ComServ_cfg.h" 2
# 1 "../40_Appl/HsfbApp/HsfbApp_GetRx10ms.h" 1
# 12 "../30_Bsw/ComStack/ComServ/ComServ_cfg.h" 2
# 8 "../30_Bsw/ComStack/ComServ/Comserv.c" 2
# 1 "../30_Bsw/ComStack/ComServ/ComServ_scb.h" 1
# 9 "../30_Bsw/ComStack/ComServ/Comserv.c" 2
# 1 "../30_Bsw/ComStack/ComServ/ComServ_scfg.h" 1
# 10 "../30_Bsw/ComStack/ComServ/Comserv.c" 2
# 1 "../30_Bsw/Mcal/Can/can_defines.h" 1
# 18 "../30_Bsw/Mcal/Can/can_defines.h"
# 1 "../30_Bsw/Common/mcu_cfg.h" 1
# 19 "../30_Bsw/Mcal/Can/can_defines.h" 2
# 11 "../30_Bsw/ComStack/ComServ/Comserv.c" 2
# 1 "../30_Bsw/Mcal/Can/can_driver.h" 1
# 12 "../30_Bsw/ComStack/ComServ/Comserv.c" 2
# 1 "../30_Bsw/ComStack/Tp/tp.h" 1
# 13 "../30_Bsw/ComStack/ComServ/Comserv.c" 2
# 1 "../30_Bsw/Pma/Pma_api.h" 1
# 24 "../30_Bsw/Pma/Pma_api.h"
# 1 "../30_Bsw/Pma/Pma_cfg.h" 1
# 38 "../30_Bsw/Pma/Pma_cfg.h"
...
# 39 "../30_Bsw/Pma/Pma_cfg.h" 2
# 1 "../30_Bsw/Common/TC21x/IfxSmu_bf.h" 1
# 40 "../30_Bsw/Pma/Pma_cfg.h" 2

# 1 "../30_Bsw/Mcal/Can/can_driver.h" 1
# 42 "../30_Bsw/Pma/Pma_cfg.h" 2
# 62 "../30_Bsw/Pma/Pma_cfg.h"
typedef struct{
...
# 14 "../30_Bsw/ComStack/ComServ/Comserv.c" 2
...
# 20 "../30_Bsw/ComStack/ComServ/Comserv.c" 2
...
#pragma section
# 68 "../30_Bsw/ComStack/ComServ/Comserv.c" 2
...
# 74 "../30_Bsw/ComStack/ComServ/Comserv.c" 2
...
#pragma section
# 81 "../30_Bsw/ComStack/ComServ/Comserv.c" 2


# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 87 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".data.MPU_QM_VAR_INIT" aw 8
# 84 "../30_Bsw/ComStack/ComServ/Comserv.c" 2
static uint8 Param_recieved = 0;
static uint8 Calib_recieved = 0;

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 100 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 88 "../30_Bsw/ComStack/ComServ/Comserv.c" 2


# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 112 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".bss.MPU_QM_VAR_NOINIT" awB 8
# 91 "../30_Bsw/ComStack/ComServ/Comserv.c" 2
...
# 125 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 99 "../30_Bsw/ComStack/ComServ/Comserv.c" 2
...
# 125 "../30_Bsw/ComStack/ComServ/Comserv.c" 2
...
static void ComServ_InitStatus(void)
{
    ComServ_Status.AppDateTime =
            ((u32)((s16)ComServ_BuildInfo.Year - 2000) << 26) |
    ...
    ComServ_Status.AppVersion = ((u32)1 << 30) |
            ((u32)1 << 24) | ((u32)0 << 16) |
            ((u32)1 << 8) | ((u32)30 << 0);
    ComServ_Status.CfgVersion = 833410;
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 307 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 155 "../30_Bsw/ComStack/ComServ/Comserv.c" 2


# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 158 "../30_Bsw/ComStack/ComServ/Comserv.c" 2
...
void ComServ_EmergencyMode(void)
{
 ...
 {
  if(ComServ_Status.Operation == 0)
  {
   if(ComServ_Status.CanErrorCnt < 15000)
   {
...
{
    if(y->Enable && !ComServ_Status.Enable)
    {
          ...
          (y->Topology != ComServ_Status.Topology))
 {
    ...
    else if(ComServ_Status.EnableCnt < 4)
    {
     ComServ_Status.EnableCnt++;
    }
    else if(!y->Enable && ComServ_Status.Enable)
    {
     y->Enable = ComServ_Status.Enable;
     ComServ_Status.EnableCnt = 0;
    }
...
void HsfbApp_SetTx10ms(const HSFBAPP_S_TX *u)
{
 ...
 if(Iout_Data < 6090 && Iout_Data >6050)
 {
  Iout_Data = 6070;
 }
 ...
 {DCDC_Measure[3u] = ( (uint16_t)((uint16_t)(Iout_Data) & 0x00FFu) ); DCDC_Measure[4u] = ( (uint16_t)(((uint16_t)(Iout_Data) >> 8) & 0x003Fu) | (DCDC_Measure[4u] & 0xFFC0u));};

 {DCDC_Measure[5u] = ( (uint16_t)((uint16_t)(Vout_abs) & 0x00FFu) ); DCDC_Measure[6u] = ( (uint16_t)(((uint16_t)(Vout_abs) >> 8) & 0x001Fu) | (DCDC_Measure[6u] & 0xFFE0u));};
 {DCDC_Measure4[3u] = ( (uint16_t)((uint16_t)(Vin_abs) & 0x00FFu) ); DCDC_Measure4[4u] = ( (uint16_t)(((uint16_t)(Vin_abs) >> 8) & 0x003Fu) | (DCDC_Measure4[4u] & 0xFFC0u));};
 {DCDC_Measure2[4u] = ( (uint16_t)((Dsp_SatS16U12(Vkl30_abs) << 5) & 0x00E0u) | (DCDC_Measure2[4u] & 0xFF1Fu)); DCDC_Measure2[5u] = ( (uint16_t)((Dsp_SatS16U12(Vkl30_abs) >> 3) & 0x00FFu) ); DCDC_Measure2[6u] = ( (uint16_t)((Dsp_SatS16U12(Vkl30_abs) >> 11) & 0x0003u) | (DCDC_Measure2[6u] & 0xFFFCu));};
 {DCDC_Measure2[3u] = ( (uint16_t)(Dsp_SatS16U12(Vkl30C_abs) & 0x00FFu) ); DCDC_Measure2[4u] = ( (uint16_t)((Dsp_SatS16U12(Vkl30C_abs) >> 8) & 0x001Fu) | (DCDC_Measure2[4u] & 0xFFE0u));};
 {DCDC_Measure2[6u] = ( (uint16_t)(((uint16_t)(Iout_sign) << 2) & 0x000Cu) | (DCDC_Measure2[6u] & 0xFFF3u));};

 {DCDC_Measure3[5u] = ( (uint16_t)((uint16_t)(u->MeasStatus.VoutDiag.Data) & 0x00FFu) ); DCDC_Measure3[6u] = ( (uint16_t)(((uint16_t)(u->MeasStatus.VoutDiag.Data) >> 8) & 0x001Fu) | (DCDC_Measure3[6u] & 0xFFE0u));};

 if( u->AppStatus.Operation ==1 && ConvertState(HsfbState_State)== 2 )
 {
 {DCDC_Measure2[1u] = ( (uint16_t)(((uint16_t)(Ipri_Data) << 4) & 0x00F0u) | (DCDC_Measure2[1u] & 0xFF0Fu)); DCDC_Measure2[2u] = ( (uint16_t)(((uint16_t)(Ipri_Data) >> 4) & 0x00FFu) );};
 }
 else
 {
 {DCDC_Measure2[1u] = ( (uint16_t)(((uint16_t)(u->MeasStatus.Ipri.Data) << 4) & 0x00F0u) | (DCDC_Measure2[1u] & 0xFF0Fu)); DCDC_Measure2[2u] = ( (uint16_t)(((uint16_t)(u->MeasStatus.Ipri.Data) >> 4) & 0x00FFu) );};
 }

 {DCDC_Measure2[6u] = ( (uint16_t)((Dsp_SatS16U12(u->MeasStatus.IproFet.Data) << 4) & 0x00F0u) | (DCDC_Measure2[6u] & 0xFF0Fu)); DCDC_Measure2[7u] = ( (uint16_t)((Dsp_SatS16U12(u->MeasStatus.IproFet.Data) >> 4) & 0x00FFu) );};
 {DCDC_Measure[1u] = ( (uint16_t)((Dsp_SatS16U12(u->MeasStatus.Vaux.Data/10) << 4) & 0x00F0u) | (DCDC_Measure[1u] & 0xFF0Fu)); DCDC_Measure[2u] = ( (uint16_t)((Dsp_SatS16U12(u->MeasStatus.Vaux.Data/10) >> 4) & 0x00FFu) );};


 {DCDC_Measure3[0u] = ( (uint16_t)(ConvertTempToCan(u->NtcStatus.Pri.Temp) & 0x00FFu) );};
 {DCDC_Measure3[1u] = ( (uint16_t)(ConvertTempToCan(u->NtcStatus.SrA.Temp) & 0x00FFu) );};
 {DCDC_Measure3[2u] = ( (uint16_t)(ConvertTempToCan(u->NtcStatus.SrB.Temp) & 0x00FFu) );};
 {DCDC_Measure4[5u] = ( (uint16_t)(ConvertTempToCan(u->NtcStatus.WaterIn.Temp) & 0x00FFu) );};
 {DCDC_Measure4[6u] = ( (uint16_t)(ConvertTempToCan(u->NtcStatus.WaterOut.Temp) & 0x00FFu) );};
 {DCDC_Measure4[1u] = ( (uint16_t)((ConvertTempToCan(u->NtcStatus.WaterOutDiag.Temp) << 4) & 0x00F0u) | (DCDC_Measure4[1u] & 0xFF0Fu)); DCDC_Measure4[2u] = ( (uint16_t)((ConvertTempToCan(u->NtcStatus.WaterOutDiag.Temp) >> 4) & 0x007Fu) | (DCDC_Measure4[2u] & 0xFF80u));};

 {DCDC_Status_ErrCode[0u] = ( (uint16_t)((uint16_t)(u->DiagStatus.WarnCode0) & 0x00FFu) ); DCDC_Status_ErrCode[1u] = ( (uint16_t)(((uint16_t)(u->DiagStatus.WarnCode0) >> 8) & 0x00FFu) );};
 {DCDC_Status_ErrCode[2u] = ( (uint16_t)((uint16_t)(u->DiagStatus.WarnCode1) & 0x00FFu) ); DCDC_Status_ErrCode[3u] = ( (uint16_t)(((uint16_t)(u->DiagStatus.WarnCode1) >> 8) & 0x00FFu) );};
 {DCDC_Status_ErrCode[6u] = ( (uint16_t)((uint16_t)(u->DiagStatus.WarnCode3) & 0x00FFu) ); DCDC_Status_ErrCode[7u] = ( (uint16_t)(((uint16_t)(u->DiagStatus.WarnCode3) >> 8) & 0x00FFu) );};
# 328 "../30_Bsw/ComStack/ComServ/Comserv.c"
 {LvDc_Pma_ErrSrc[0u] = ( (uint16_t)((uint16_t)((Pma_AbortData.ErrCnt>>8)&0x00FF) & 0x00FFu) );};
 {LvDc_Pma_ErrSrc[5u] = ( (uint16_t)((uint16_t)(Pma_AbortData.ErrCnt&0x00FF) & 0x00FFu) );};
 {LvDc_Pma_ErrSrc[1u] = ( (uint16_t)((uint16_t)(Pma_AbortData.ErrSrc) & 0x00FFu) );};
 {LvDc_Pma_ErrSrc[7u] = ( (uint16_t)((uint16_t)(Pma_AbortData.ResetInfo.ShutdownSts) & 0x00FFu) );};
 {LvDc_Pma_ErrSrc[2u] = ( (uint16_t)((uint16_t)(Pma_AbortData.McSafeErr.IohwErr) & 0x00FFu) );};
 {LvDc_Pma_ErrSrc[3u] = ( (uint16_t)((uint16_t)(Pma_AbortData.McSafeErr.PfmSts.FailureCnt) & 0x00FFu) );};
 {LvDc_Pma_ErrSrc[4u] = ( (uint16_t)((uint16_t)(Pma_AbortData.McSafeErr.E2eSts.RxErrSum) & 0x00FFu) );};
 {LvDc_Pma_ErrSrc[6u] = ( (uint16_t)((uint16_t)(Pma_AbortData.CpuLoadMax) & 0x00FFu) );};


 {DcDc_Scope0[2u] = ( (uint16_t)((uint16_t)(Pfm_Capture.Isr_15usCnt) & 0x00FFu) ); DcDc_Scope0[3u] = ( (uint16_t)(((uint16_t)(Pfm_Capture.Isr_15usCnt) >> 8) & 0x000Fu) | (DcDc_Scope0[3u] & 0xFFF0u));};
 {DcDc_Scope0[0u] = ( (uint16_t)((uint16_t)(Pfm_Capture.Isr_100usCnt) & 0x00FFu) ); DcDc_Scope0[1u] = ( (uint16_t)(((uint16_t)(Pfm_Capture.Isr_100usCnt) >> 8) & 0x00FFu) );};
 {DcDc_Scope1[2u] = ( (uint16_t)((uint16_t)(Pfm_Capture.Isr_1msCnt) & 0x00FFu) ); DcDc_Scope1[3u] = ( (uint16_t)(((uint16_t)(Pfm_Capture.Isr_1msCnt) >> 8) & 0x00FFu) );};
 {DcDc_Scope1[0u] = ( (uint16_t)((uint16_t)(Pfm_Capture.TimerDiff_10ms/100U) & 0x00FFu) ); DcDc_Scope1[1u] = ( (uint16_t)(((uint16_t)(Pfm_Capture.TimerDiff_10ms/100U) >> 8) & 0x00FFu) );};
 {DcDc_Scope1[4u] = ( (uint16_t)((uint16_t)(Pfm_Capture.Sts) & 0x00FFu) ); DcDc_Scope1[5u] = ( (uint16_t)(((uint16_t)(Pfm_Capture.Sts) >> 8) & 0x00FFu) );};



 if(Main_DebugErrCode)
 {
  {DCDC_Status_ErrCode[4u] = ( (uint16_t)((uint16_t)Main_DebugErrCode & 0x00FFu) ); DCDC_Status_ErrCode[5u] = ( (uint16_t)(((uint16_t)Main_DebugErrCode >> 8) & 0x00FFu) );};
 }
 else
 {
  {DCDC_Status_ErrCode[4u] = ( (uint16_t)((uint16_t)(u->DiagStatus.WarnCode2) & 0x00FFu) ); DCDC_Status_ErrCode[5u] = ( (uint16_t)(((uint16_t)(u->DiagStatus.WarnCode2) >> 8) & 0x00FFu) );};
 }

 {DCDC_Status[3u] = ( (uint16_t)(((uint16_t)(u->AppStatus.Operation) << 2) & 0x000Cu) | (DCDC_Status[3u] & 0xFFF3u));};
 {DCDC_Status[1u] = ( (uint16_t)(((uint16_t)(u->AppStatus.Topology) << 2) & 0x000Cu) | (DCDC_Status[1u] & 0xFFF3u));};
 {DCDC_Measure3[4u] = ( (uint16_t)(((uint16_t)(u->AppStatus.IsrTime) << 1) & 0x00FEu) | (DCDC_Measure3[4u] & 0xFF01u));};
 {DCDC_Status[3u] = ( (uint16_t)(((uint16_t)(u->AppStatus.CpuTime) << 4) & 0x00F0u) | (DCDC_Status[3u] & 0xFF0Fu)); DCDC_Status[4u] = ( (uint16_t)(((uint16_t)(u->AppStatus.CpuTime) >> 4) & 0x000Fu) | (DCDC_Status[4u] & 0xFFF0u));};

 {LVDC_SafetyMeasure[2u] = ( (uint16_t)((ConvertSM(u->SafetyStatus.SafetyStatus.DCDC01_SM1) << 6) & 0x00C0u) | (LVDC_SafetyMeasure[2u] & 0xFF3Fu));};
 {LVDC_SafetyMeasure[3u] = ( (uint16_t)((ConvertSM(u->SafetyStatus.SafetyStatus.DCDC01_SM2) << 0) & 0x0003u) | (LVDC_SafetyMeasure[3u] & 0xFFFCu));};
 {LVDC_SafetyMeasure[3u] = ( (uint16_t)((ConvertSM(u->SafetyStatus.SafetyStatus.DCDC01_SM3) << 2) & 0x000Cu) | (LVDC_SafetyMeasure[3u] & 0xFFF3u));};
 {LVDC_SafetyMeasure[3u] = ( (uint16_t)((ConvertSM(u->SafetyStatus.SafetyStatus.DCDC01_SM4) << 4) & 0x0030u) | (LVDC_SafetyMeasure[3u] & 0xFFCFu));};

 {LVDC_SafetyMeasure[1u] = ( (uint16_t)((ConvertSM(u->SafetyStatus.SafetyStatus.DCDC01_LFD1) << 4) & 0x0030u) | (LVDC_SafetyMeasure[1u] & 0xFFCFu));};

 {LVDC_SafetyMeasure[2u] = ( (uint16_t)((ConvertSM(u->SafetyStatus.SafetyStatus.DCDC01_LFD3) << 0) & 0x0003u) | (LVDC_SafetyMeasure[2u] & 0xFFFCu));};
 {LVDC_SafetyMeasure[2u] = ( (uint16_t)((ConvertSM(u->SafetyStatus.SafetyStatus.DCDC01_LFD4) << 2) & 0x000Cu) | (LVDC_SafetyMeasure[2u] & 0xFFF3u));};
 {LVDC_SafetyMeasure[2u] = ( (uint16_t)((3 << 4) & 0x0030u) | (LVDC_SafetyMeasure[2u] & 0xFFCFu));};

 {LVDC_SafetyMeasure[5u] = ( (uint16_t)((ConvertSM(u->SafetyStatus.SafetyStatus.DCDC02_SM1) << 0) & 0x0003u) | (LVDC_SafetyMeasure[5u] & 0xFFFCu));};
 {LVDC_SafetyMeasure[5u] = ( (uint16_t)((ConvertSM(u->SafetyStatus.SafetyStatus.DCDC02_SM2) << 2) & 0x000Cu) | (LVDC_SafetyMeasure[5u] & 0xFFF3u));};
 {LVDC_SafetyMeasure[5u] = ( (uint16_t)((ConvertSM(u->SafetyStatus.SafetyStatus.DCDC02_SM3) << 4) & 0x0030u) | (LVDC_SafetyMeasure[5u] & 0xFFCFu));};
 {LVDC_SafetyMeasure[5u] = ( (uint16_t)((ConvertSM(u->SafetyStatus.SafetyStatus.DCDC02_SM4) << 6) & 0x00C0u) | (LVDC_SafetyMeasure[5u] & 0xFF3Fu));};

 {LVDC_SafetyMeasure[3u] = ( (uint16_t)((ConvertSM(u->SafetyStatus.SafetyStatus.DCDC02_LFD1) << 6) & 0x00C0u) | (LVDC_SafetyMeasure[3u] & 0xFF3Fu));};

 {LVDC_SafetyMeasure[4u] = ( (uint16_t)((ConvertSM(u->SafetyStatus.SafetyStatus.DCDC02_LFD3) << 2) & 0x000Cu) | (LVDC_SafetyMeasure[4u] & 0xFFF3u));};
 {LVDC_SafetyMeasure[4u] = ( (uint16_t)((ConvertSM(u->SafetyStatus.SafetyStatus.DCDC02_LFD4) << 4) & 0x0030u) | (LVDC_SafetyMeasure[4u] & 0xFFCFu));};

 {LVDC_SafetyMeasure[4u] = ( (uint16_t)((3 << 6) & 0x00C0u) | (LVDC_SafetyMeasure[4u] & 0xFF3Fu));};

 {LVDC_SafetyMeasure[7u] = ( (uint16_t)((ConvertSM(u->SafetyStatus.SafetyStatus.DCDC03_SM1) << 0) & 0x0003u) | (LVDC_SafetyMeasure[7u] & 0xFFFCu));};

 {LVDC_SafetyMeasure[7u] = ( (uint16_t)((3 << 4) & 0x0030u) | (LVDC_SafetyMeasure[7u] & 0xFFCFu));};
 {LVDC_SafetyMeasure[7u] = ( (uint16_t)((3 << 2) & 0x000Cu) | (LVDC_SafetyMeasure[7u] & 0xFFF3u));};
 {LVDC_SafetyMeasure[6u] = ( (uint16_t)((3 << 0) & 0x0003u) | (LVDC_SafetyMeasure[6u] & 0xFFFCu));};

 {LVDC_SafetyMeasure[6u] = ( (uint16_t)((ConvertSM(u->SafetyStatus.SafetyStatus.DCDC05_SM1) << 6) & 0x00C0u) | (LVDC_SafetyMeasure[6u] & 0xFF3Fu));};
 {LVDC_SafetyMeasure[6u] = ( (uint16_t)((ConvertSM(u->SafetyStatus.SafetyStatus.DCDC05_LFD1) << 2) & 0x000Cu) | (LVDC_SafetyMeasure[6u] & 0xFFF3u));};


 {LVDC_SafetyMeasure[1u] = ( (uint16_t)((ConvertAutoDiag(u->SafetyStatus.SafetyStatus.DCDC01_LFD2,u->SafetyStatus.AutoDiagStatus.EachFin[0]) << 6) & 0x00C0u) | (LVDC_SafetyMeasure[1u] & 0xFF3Fu));};
 {LVDC_SafetyMeasure[4u] = ( (uint16_t)((ConvertAutoDiag(u->SafetyStatus.SafetyStatus.DCDC02_LFD2,u->SafetyStatus.AutoDiagStatus.EachFin[1]) << 0) & 0x0003u) | (LVDC_SafetyMeasure[4u] & 0xFFFCu));};

 {LVDC_SafetyMeasure[6u] = ( (uint16_t)((ConvertAutoDiag(KLDiagFlag,1) << 4) & 0x0030u) | (LVDC_SafetyMeasure[6u] & 0xFFCFu));};
 {LVDC_WakeUpSleepManagement[0u] = ( (uint16_t)((2 << 0) & 0x0003u) | (LVDC_WakeUpSleepManagement[0u] & 0xFFFCu));};

 if(!Main_InitFin) return;

 {DCDC_Status[0u] = ( (uint16_t)(((uint16_t)(u->PortStatus.IoutPOcp) << 2) & 0x000Cu) | (DCDC_Status[0u] & 0xFFF3u));};
 {DCDC_Status[0u] = ( (uint16_t)(((uint16_t)(u->PortStatus.IoutNOcp) << 0) & 0x0003u) | (DCDC_Status[0u] & 0xFFFCu));};
 {DCDC_Status[2u] = ( (uint16_t)(((uint16_t)(u->PortStatus.IpriOcp) << 4) & 0x0030u) | (DCDC_Status[2u] & 0xFFCFu));};
 {DCDC_Status[2u] = ( (uint16_t)(((uint16_t)(u->PortStatus.VinOvp) << 2) & 0x000Cu) | (DCDC_Status[2u] & 0xFFF3u));};



 {DCDC_Status[4u] = ( (uint16_t)(((uint16_t)(u->PortStatus.FastTurnOff) << 4) & 0x0030u) | (DCDC_Status[4u] & 0xFFCFu));};

 if(!u->SafetyStatus.AutoDiagStatus.AutoDiagWait && !u->SafetyStatus.AutoDiagStatus.AutoDiagFin)
 {
  {DCDC_Status[1u] = ( (uint16_t)((0 << 0) & 0x0003u) | (DCDC_Status[1u] & 0xFFFCu));};
  {DCDC_Status[2u] = ( (uint16_t)((0 << 0) & 0x0003u) | (DCDC_Status[2u] & 0xFFFCu));};
  {DCDC_Status[4u] = ( (uint16_t)((0 << 6) & 0x00C0u) | (DCDC_Status[4u] & 0xFF3Fu));};
 }
 else
 {
  {DCDC_Status[1u] = ( (uint16_t)(((uint16_t)(u->PortStatus.Vout16VOvp) << 0) & 0x0003u) | (DCDC_Status[1u] & 0xFFFCu));};
  {DCDC_Status[2u] = ( (uint16_t)(((uint16_t)(u->PortStatus.Vout19VOvp) << 0) & 0x0003u) | (DCDC_Status[2u] & 0xFFFCu));};
  {DCDC_Status[4u] = ( (uint16_t)(((uint16_t)(u->PortStatus.WaterOutOtp) << 6) & 0x00C0u) | (DCDC_Status[4u] & 0xFF3Fu));};
 }

 {DCDC_Status[1u] = ( (uint16_t)(((uint16_t)((!u->PortStatus.PriDriveDis)&(!u->PortStatus.SrDriveDis)) << 6) & 0x00C0u) | (DCDC_Status[1u] & 0xFF3Fu));};
 {DCDC_Status[1u] = ( (uint16_t)(((uint16_t)(!u->PortStatus.FastTurnOff) << 4) & 0x0030u) | (DCDC_Status[1u] & 0xFFCFu));};
 {DCDC_Status[3u] = ( (uint16_t)(((uint16_t)(!u->PortStatus.PriDriveDis) << 0) & 0x0003u) | (DCDC_Status[3u] & 0xFFFCu));};
 {DCDC_Status[2u] = ( (uint16_t)(((uint16_t)(!u->PortStatus.SrDriveDis) << 6) & 0x00C0u) | (DCDC_Status[2u] & 0xFF3Fu));};

 if(!OpMode_flag)
 {
  {DCDC_Status[5u] = ( (uint16_t)((ConvertState(HsfbState_State) << 0) & 0x0007u) | (DCDC_Status[5u] & 0xFFF8u));};
    }
...
void ComServ_1msTask(void)
{
 ...
 if(CANDriver_mg_bError){
  ...
  else
    {
         ...
         if(1 == CanTxFlags[u16Index].ConfirmFlg)
   {
            u16TxIndex = ((127) - u16Index);
            CANDriver_TxDataToMbox(u16TxIndex, u16Index);
        ...
        else
  {
            ...
            if ((CanRxMsg[u16Index].Timeout / (1U)) <= *(CanRxMsg[u16Index].TimeoutCounter))
            {
                *(CanRxMsg[u16Index].TimeoutCounter) = 0U;
                CanRxFlags[u16Index].Timeout = 1;
            }
        }

  if(CanRxMsg[u16Index].Id == 0x100u)
     {
...
void ComServ_10msTask(void)
{
 if(!Main_InitFin)
 {
  ...
  ComServ_Status.ClrFault = (ConvertState(HsfbState_State) == 3);
  return;
 }
...
# 581 "../30_Bsw/ComStack/ComServ/Comserv.c"
}
...
void CANDriver_Diag(uint16* const pu16ErrCode)
{
  ...
  loc_NodeStatusReg = (Ifx_CAN_N_SR)(*(Ifx_CAN *)0xF0018000u).N[(1u)].SR;

  *pu16ErrCode = (uint16)loc_NodeStatusReg.B.LEC;

  CANDriver_mg_bError = 0;
  if( (((uint16)0) != loc_NodeStatusReg.B.LEC) && (loc_NodeStatusReg.B.BOFF))
  {
      CANDriver_mg_bError = 1;

      CANDriver_HwCfg();
  }

}
# 613 "../30_Bsw/ComStack/ComServ/Comserv.c"
void CANDriver_HwCfg(void)
{
  ...
  (*(Ifx_CAN *)0xF0018000u).CLC.U = (uint32)0x00u;
  while(0u != u32HelpVar){
    u32HelpVar = (*(Ifx_CAN *)0xF0018000u).CLC.U;
  }
  (*(Ifx_CAN *)0xF0018000u).FDR.U = (((uint32)1 << 14) | (uint32)0x3FF);

  IfxScuWdt_setCpuEndinit(IfxScuWdt_getCpuWatchdogPassword());

  (*(Ifx_CAN *)0xF0018000u).MCR.B.CLKSEL = 0u;
  (*(Ifx_CAN *)0xF0018000u).MCR.B.CLKSEL = 2u;


  (*(Ifx_CAN *)0xF0018000u).N[(1u)].CR.U = (((uint32)1 ) | ((uint32)1 << 6));
  (*(Ifx_CAN *)0xF0018000u).N[(1u)].PCR.U = (0u);
# 644 "../30_Bsw/ComStack/ComServ/Comserv.c"
  (*(Ifx_CAN *)0xF0018000u).N[(1u)].BTR.B.DIV8 = 0u;
  (*(Ifx_CAN *)0xF0018000u).N[(1u)].BTR.B.SJW = 2u;
  (*(Ifx_CAN *)0xF0018000u).N[(1u)].BTR.B.TSEG1 = 11u;
  (*(Ifx_CAN *)0xF0018000u).N[(1u)].BTR.B.TSEG2 = 6u;
  (*(Ifx_CAN *)0xF0018000u).N[(1u)].BTR.B.BRP = (((uint32)20000000U) / ((500000u ) * 20)) - 1u;

  CANDriver_MsgObjCfg();
# 661 "../30_Bsw/ComStack/ComServ/Comserv.c"
  (*(Ifx_CAN *)0xF0018000u).N[(1u)].CR.U = (((uint32)0 ) | ((uint32)0 << 6));
}
...
void CANDriver_MsgObjCfg(void)
{
  ...
  {
    while(0x0u != ((0x300u) & (*(Ifx_CAN *)0xF0018000u).PANCTR.U));
    (*(Ifx_CAN *)0xF0018000u).PANCTR.U = ((0x02u) | ((((u16Index)) & 0xFFu) << 16) | (((((1u) + 1u)) & 0xFFu) << 24));

    (*(Ifx_CAN *)0xF0018000u).MO[u16Index].CTR.U = ((uint32)0x00A00F5F);
    (*(Ifx_CAN *)0xF0018000u).MO[u16Index].FCR.U = ((uint32)0);
    (*(Ifx_CAN *)0xF0018000u).MO[u16Index].FCR.U |= ((uint32)(CanRxMsg[u16Index].Dlc) << 24);
    (*(Ifx_CAN *)0xF0018000u).MO[u16Index].AR.U = (((uint32)0x00000000) | ((uint32)0x80000000) );
    (*(Ifx_CAN *)0xF0018000u).MO[u16Index].AR.U |= ((uint32)(CanRxMsg[u16Index].Id) << 18);
    (*(Ifx_CAN *)0xF0018000u).MO[u16Index].DATAH.U = 0x00000000u;
    (*(Ifx_CAN *)0xF0018000u).MO[u16Index].DATAL.U = 0x00000000u;
  }
  ...
  for(u16Index = 0u; u16Index < (uint16)CAN_TX_MSG_SIZE; u16Index++)
  {
    ...
    (*(Ifx_CAN *)0xF0018000u).PANCTR.U = ((0x02u) | ((((u16TxIndex)) & 0xFFu) << 16) | (((((1u) + 1u)) & 0xFFu) << 24));

    (*(Ifx_CAN *)0xF0018000u).MO[u16TxIndex].CTR.U = ((uint32)0x0E200000);
    (*(Ifx_CAN *)0xF0018000u).MO[u16TxIndex].FCR.U = ((uint32)0);
    (*(Ifx_CAN *)0xF0018000u).MO[u16TxIndex].FCR.U |= ((uint32)(CanTxMsg[u16Index].Dlc) << 24);
    (*(Ifx_CAN *)0xF0018000u).MO[u16TxIndex].AR.U = (((uint32)0x00000000) | ((uint32)0x80000000));
    (*(Ifx_CAN *)0xF0018000u).MO[u16TxIndex].AR.U |= ((uint32)(CanTxMsg[u16Index].Id) << 18);

    (*(Ifx_CAN *)0xF0018000u).MO[u16TxIndex].DATAH.U = 0x88776655u;
    (*(Ifx_CAN *)0xF0018000u).MO[u16TxIndex].DATAL.U = 0x44332211u;

    while((((uint32)0xE00) & (*(Ifx_CAN *)0xF0018000u).MO[u16TxIndex].STAT.U) != ((uint32)0xE00))
    {
      ;
    }
  }
...
{
 s16 VoutRef_Data;
    if((CanRxFlags[CAN_RX_DCDC_CMD_IDX].IndFlg != 0u))
    {
        (CanRxFlags[CAN_RX_DCDC_CMD_IDX].IndFlg = 0u);
        ComServ_Status.ClrFault = ( (((uint16_t)(DCDC_CMD[6]&0x0020u))>>5) );
        ComServ_Status.AutoDiagEn = (( (((uint16_t)(DCDC_CMD[1]&0x00C0u))>>6) ) == 1) ? 1 : 0;
        ComServ_Status.OtpAutoDiagEn = (( (((uint16_t)(HTB_CMD[3]&0x00E0u))>>5) ) == 5) ? 1 : 0;
        ComServ_Status.Enable = (( (((uint16_t)(DCDC_CMD[1]&0x0030u))>>4) ) == 1) ? 1 : 0;
        ComServ_Status.DisHSK = (( (((uint16_t)(DCDC_CMD[6]&0x00C0u))>>6) | (((uint16_t)(DCDC_CMD[7]&0x00FFu))<<2) ) == 1) ? 1 : 0;
        ...
        VoutRef_Data = ( (uint16_t)(DCDC_CMD[2]) ) * 10u;
        ...
        RangeCheck(( ((uint16_t)DCDC_CMD[3]) | (((uint16_t)(DCDC_CMD[4]&0x000Fu))<<8) ), (u16 *)&ComServ_Status.IoutRef, 3200,0,3200);
        RangeCheck(( ((uint16_t)DCDC_CMD[5]) | (((uint16_t)(DCDC_CMD[6]&0x0003u))<<8) ) * 10u, (u16 *)&ComServ_Status.VinRef, 8250,2300,7900);
        ComServ_Status.Operation = ( (((uint16_t)(DCDC_CMD[4]&0x0030u))>>4) );
        ComServ_Status.Topology = ( (((uint16_t)(DCDC_CMD[4]&0x0080u))>>7) );
    }
    else
    {
     ComServ_Status.ClrFault =0;
    }
    if((CanRxFlags[CAN_RX_DCDC_DEV_CMD_IDX].IndFlg != 0u))
    {
     (CanRxFlags[CAN_RX_DCDC_DEV_CMD_IDX].IndFlg = 0u);
     ComServ_Status.Debug = ( (uint16_t)(DCDC_DEV_CMD[5]) );
     ComServ_Status.Debug1 = ( (((uint16_t)(DCDC_DEV_CMD[3]&0x0030u))>>4) );
     ComServ_Status.Debug2 = ( (((uint16_t)(DCDC_DEV_CMD[1]&0x00C0u))>>6) );
     ComServ_Status.HsfbFreq = ( ((uint16_t)DCDC_DEV_CMD[0]) | (((uint16_t)(DCDC_DEV_CMD[1]&0x003Fu))<<8) );
     ComServ_Status.HsfbSweep = ( (uint16_t)(DCDC_DEV_CMD[4]) );
     ComServ_Status.Sr1En = ( (((uint16_t)(DCDC_DEV_CMD[3]&0x0040u))>>6) );
     ComServ_Status.Sr2En = ( (((uint16_t)(DCDC_DEV_CMD[3]&0x0080u))>>7) );
     ComServ_Status.SrCtrl = ( ((uint16_t)DCDC_DEV_CMD[2]) | (((uint16_t)(DCDC_DEV_CMD[3]&0x000Fu))<<8) );
    }

    if((CanRxFlags[CAN_RX_COM_WAKEUPSLEEPMANAGEMENT_IDX].IndFlg != 0u))
 {
  (CanRxFlags[CAN_RX_COM_WAKEUPSLEEPMANAGEMENT_IDX].IndFlg = 0u);
  ComServ_Status.WakeUpSleepCmd = ( (((uint16_t)(COM_WakeUpSleepManagement[0]&0x0003u))>>0) );
 }
}
inline void RangeCheck(u16 x,u16 *y,u16 max,u16 min,u16 def)
{
...
#pragma section
# 848 "../30_Bsw/ComStack/ComServ/Comserv.c" 2
...
# 294 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_QM_CODE" ax 8
# 853 "../30_Bsw/ComStack/ComServ/Comserv.c" 2
# 862 "../30_Bsw/ComStack/ComServ/Comserv.c"
static void UdsData_Param(u16 ReadWrite, u8* Buffer, u16* DataPtr, u16 DataSize)
{
 u16 i;
...
# 883 "../30_Bsw/ComStack/ComServ/Comserv.c"
static void UdsData_Calib(u16 ReadWrite, u8* Buffer, u16* DataPtr, u16 DataSize)
{
 u16 i;
...
# 903 "../30_Bsw/ComStack/ComServ/Comserv.c"
uint8 UdsData_Parameter(uint8 ReadWrite, uint8 *RxTxBuf, uint16 LenOfMsg)
{
 ...
 {
  UdsData_Param(ReadWrite, RxTxBuf, (u16*)&ParameterData, ((200)/2));
    Param_recieved = 1;
  MsgSts = (0x00U);
 }
 else
...
# 939 "../30_Bsw/ComStack/ComServ/Comserv.c"
 ...
 if(ComCrcAct == ComCrcRef)
  {
    if(1 == IsCalibrated)
    {
      ...
      {
        UdsData_Calib(ReadWrite, RxTxBuf, (u16*)&CalibrationData, ((150)/2));
        Calib_recieved = 1;
        MsgSts = (0x00U);
      }
      else
  ...
  return MsgSts;
# 1005 "../30_Bsw/ComStack/ComServ/Comserv.c"
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 307 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 1008 "../30_Bsw/ComStack/ComServ/Comserv.c" 2
...
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 1012 "../30_Bsw/ComStack/ComServ/Comserv.c" 2
# 1022 "../30_Bsw/ComStack/ComServ/Comserv.c"
static u8 TrustedCall_CopyParam(ParameterData_t *Data)
...
# 1051 "../30_Bsw/ComStack/ComServ/Comserv.c"
static u8 TrustedCall_CopyCalib(CalibrationData_t *Data)
...
# 1088 "../30_Bsw/ComStack/ComServ/Comserv.c"
...
# 1142 "../30_Bsw/ComStack/ComServ/Comserv.c"
...
{
 if((CanTxMsg[u16Index].Id == 0x460u) ||
    (CanTxMsg[u16Index].Id == 0x164u) ||
    (CanTxMsg[u16Index].Id == 0x163u) ||
    (CanTxMsg[u16Index].Id == 0x162u)
...
static void CANDriver_RxDataE2E(uint16 u16Index)
{
 ...
 if((CanRxMsg[u16Index].Id == 0x100u)||(CanRxMsg[u16Index].Id == 0x101u))
 {
  ...
  {
   if(CanE2E.RxErrCnt[u16Index] < 10)
   {
...
void HsfbMeas_GetCalibData(HSFBMEAS_S_CALIB *y)
{
  if(1 == Calib_recieved)
  {
    ...
    if ((0x01) == TrustedCall_CopyCalib(&CalibrationData))
    {
      y->Vout.Gain = 0.00003 *Trusted_AsilCalibData.LVDC_Output_VSense_gain;
      y->Vout.Offset = 0.0006 *Trusted_AsilCalibData.LVDC_Output_VSense_offset;

      y->Vkl30.Gain = 0.00003 *Trusted_AsilCalibData.LVDC_KL30F_VM_gain;
      y->Vkl30.Offset = 0.0006 *Trusted_AsilCalibData.LVDC_KL30F_VM_offset;

      y->Iout.Gain = 0.00003 *Trusted_AsilCalibData.LVDC_InOut_ISense_gain;
      y->Iout.Offset = 0.01 *Trusted_AsilCalibData.LVDC_InOut_ISense_offset;

      y->Vin_P1.Gain = 0.00003 *Trusted_AsilCalibData.LVDC_Input_1_VSense_gain;
      y->Vin_P1.Offset = 0.03 *Trusted_AsilCalibData.LVDC_Input_1_VSense_offset;

      y->Vin_P2.Gain = 0.00003 *Trusted_AsilCalibData.LVDC_Input_2_VSense_gain;
      y->Vin_P2.Offset = 0.03 *Trusted_AsilCalibData.LVDC_Input_2_VSense_offset;

      y->Vin_P3.Gain = 0.00003 *Trusted_AsilCalibData.LVDC_Input_3_VSense_gain;
      y->Vin_P3.Offset = 0.03 *Trusted_AsilCalibData.LVDC_Input_3_VSense_offset;

      y->Vin_OP1 = 0.03 *Trusted_AsilCalibData.LVDC_Input_1to2_VSense_OP;
      y->Vin_OP2 = 0.03 *Trusted_AsilCalibData.LVDC_Input_2to3_VSense_OP;
    }
    Calib_recieved = 0;
  }
}
...
void HsfbCtrl_GetParamData(HSFBCTRL_S_PARAM *y)
{
  if(1 == Param_recieved)
    ...
    if ((0x01) == TrustedCall_CopyParam(&ParameterData))
    {
      if((Trusted_AsilParamData.LVDC_ParameterEnable & (0x0004)) != 0)
      {
        Trusted_AsilParamData.LVDC_ParameterEnable &= (~(0x0004));
      }
      else
      {
     Param_recieved = 0;
    ...
    if((Trusted_AsilParamData.RecordVersion_Hi == 0) && (Trusted_AsilParamData.RecordVersion_Lo == 1))
    {
      ...
      y->PreVinSrRise = 0.010000 * (f32)Trusted_AsilParamData.LVDC_Ctrl_PreVinSrRise;
      y->PreVlimMin = 0.100000 * (f32)Trusted_AsilParamData.LVDC_Ctrl_PreVlimMin;

      if(y->IoutBoostMax > 320 || y->IoutBoostMax < 0) y->IoutBoostMax = 160.0F;;
      if(y->PreVinTarget > 400 || y->PreVinTarget < 0) y->PreVinTarget = 25.0F;;
      if(y->PreVinSrRise > 10 || y->PreVinSrRise < 0) y->PreVinSrRise = 0.25F;;
      if(y->PreVlimMin > 16 || y->PreVlimMin < 0) y->PreVlimMin = 9.0F;;
    }
    else
    {
      y->IoutBoostMax = 160.0F;
      y->PreVinTarget = 25.0F;
      y->PreVinSrRise = 0.25F;
      y->PreVlimMin = 9.0F;
    }
    }
    Param_recieved = 0;
...
# 255 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 1322 "../30_Bsw/ComStack/ComServ/Comserv.c" 2
