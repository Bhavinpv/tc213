...
# 8 "../40_Appl/HsfbApp/HsfbApp.c" 2
# 1 "../40_Appl/HsfbApp/HsfbApp_private.h" 1
# 13 "../40_Appl/HsfbApp/HsfbApp_private.h"
...
# 14 "../40_Appl/HsfbApp/HsfbApp_private.h" 2
# 24 "../40_Appl/HsfbApp/HsfbApp_private.h"
extern void HsfbApp_Read100us(void);
extern void HsfbApp_Read15us(void);
extern void HsfbApp_Read1ms(void);
extern void HsfbApp_Write1ms(void);
# 9 "../40_Appl/HsfbApp/HsfbApp.c" 2
# 20 "../40_Appl/HsfbApp/HsfbApp.c"
# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 36 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".bss.MPU_ASIL_VAR_NOINIT" awB 8
# 21 "../40_Appl/HsfbApp/HsfbApp.c" 2

HSFBAPP_S_TX HsfbApp_Tx10ms;
HSFBMEAS_S_STATUS1MS MeasStatus1ms;
HSFBNTC_S_STATUS NtcStatus;
HSFBMEAS_S_STATUS100US MeasStatus100us;
HSFBSAFETY_S_STATUS1MS SafetyStatus1ms;
HSFBAPP_S_AI AdcStatus1ms;
HSFBAPP_S_AI AdcStatus15us;
HSFBAPP_S_AI AdcStatus100us;
HSFBMEAS_S_STATUS15US MeasStatus15us;
HSFBAPP_S_RX HsfbApp_Rx10ms;
HSFBSTATE_S_STATUS StateStatus;
HSFBPWM_S_STATUS15US PwmStatus15us;
HSFBDIAG_S_STATUS1MS DiagStatus1ms;
HSFBCTRL_S_STATUS15US CtrlStatus15us;
HSFBAPP_S_PORTSTATUS PortStatus1ms;
...
#pragma section
# 41 "../40_Appl/HsfbApp/HsfbApp.c" 2


# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 36 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".bss.MPU_ASIL_VAR_NOINIT" awB 8
# 44 "../40_Appl/HsfbApp/HsfbApp.c" 2

DW_HsfbApp_T HsfbApp_DW;

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 49 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 48 "../40_Appl/HsfbApp/HsfbApp.c" 2
# 58 "../40_Appl/HsfbApp/HsfbApp.c"
# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 268 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".code_ram" ax 8
# 59 "../40_Appl/HsfbApp/HsfbApp.c" 2
void HsfbApp_Read100us(void)
{
  ...
  s16 Switch_l;
  for (i = 0; i < 6; i++) {
    adc100us[(i)] = (*(AdcResPt[i]));
  }

  for (i = 0; i < 6; i++) {
    if ((((s32)adc100us[(i)]) >= 0) && (((s32)adc100us[(i)]) <= 4095)) {
      Switch_l = adc100us[(i)];
    } else {
      Switch_l = HsfbApp_DW.Delay_DSTATE_p[i];
    }

    HsfbApp_DW.Delay_DSTATE_p[i] = Switch_l;
    Switch[i] = Switch_l;
  }

  AdcStatus100us.Ipri = Switch[0];
  AdcStatus100us.Vin = Switch[1];
  AdcStatus100us.Iout = Switch[2];
  AdcStatus100us.Vout = Switch[3];
  AdcStatus100us.VoutDiag = Switch[4];
  AdcStatus100us.IproFet = Switch[5];
  AdcStatus100us.Vaux = 0;
  AdcStatus100us.Vkl30 = 0;
  AdcStatus100us.Vkl30C = 0;
  AdcStatus100us.Vcomp = 0;
  AdcStatus100us.VrefDiag = 0;
  AdcStatus100us.Vhw16V = 0;
  AdcStatus100us.Vhw19V = 0;
  AdcStatus100us.NtcPri = 0;
  AdcStatus100us.NtcSrA = 0;
  AdcStatus100us.NtcSrB = 0;
  AdcStatus100us.NtcWaterIn = 0;
  AdcStatus100us.NtcWaterOut = 0;
  AdcStatus100us.NtcWaterOutDiag = 0;
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 281 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 103 "../40_Appl/HsfbApp/HsfbApp.c" 2
...
# 268 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".code_ram" ax 8
# 110 "../40_Appl/HsfbApp/HsfbApp.c" 2
void HsfbApp_Read15us(void)
{

  s16 adc15us[4];
  s16 Switch;
  adc15us[0] = (*(AdcResPt[0]));
  adc15us[1] = (*(AdcResPt[1]));
  adc15us[2] = (*(AdcResPt[2]));
  adc15us[3] = (*(AdcResPt[3]));
  if ((((s32)adc15us[0]) >= 0) && (((s32)adc15us[0]) <= 4095)) {
    Switch = adc15us[0];
  } else {
    Switch = HsfbApp_DW.Delay_DSTATE_l[0];
  }

  HsfbApp_DW.Delay_DSTATE_l[0] = Switch;
  AdcStatus15us.Ipri = Switch;
  if ((((s32)adc15us[1]) >= 0) && (((s32)adc15us[1]) <= 4095)) {
    Switch = adc15us[1];
  } else {
    Switch = HsfbApp_DW.Delay_DSTATE_l[1];
  }

  HsfbApp_DW.Delay_DSTATE_l[1] = Switch;
  AdcStatus15us.Vin = Switch;
  if ((((s32)adc15us[2]) >= 0) && (((s32)adc15us[2]) <= 4095)) {
    Switch = adc15us[2];
  } else {
    Switch = HsfbApp_DW.Delay_DSTATE_l[2];
  }

  HsfbApp_DW.Delay_DSTATE_l[2] = Switch;
  AdcStatus15us.Iout = Switch;
  if ((((s32)adc15us[3]) >= 0) && (((s32)adc15us[3]) <= 4095)) {
    Switch = adc15us[3];
  } else {
    Switch = HsfbApp_DW.Delay_DSTATE_l[3];
  }

  HsfbApp_DW.Delay_DSTATE_l[3] = Switch;
  AdcStatus15us.Vout = Switch;
  AdcStatus15us.VoutDiag = 0;
  AdcStatus15us.IproFet = 0;
  AdcStatus15us.Vaux = 0;
  AdcStatus15us.Vkl30 = 0;
  AdcStatus15us.Vkl30C = 0;
  AdcStatus15us.Vcomp = 0;
  AdcStatus15us.VrefDiag = 0;
  AdcStatus15us.Vhw16V = 0;
  AdcStatus15us.Vhw19V = 0;
  AdcStatus15us.NtcPri = 0;
  AdcStatus15us.NtcSrA = 0;
  AdcStatus15us.NtcSrB = 0;
  AdcStatus15us.NtcWaterIn = 0;
  AdcStatus15us.NtcWaterOut = 0;
  AdcStatus15us.NtcWaterOutDiag = 0;
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 281 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 169 "../40_Appl/HsfbApp/HsfbApp.c" 2
...
# 176 "../40_Appl/HsfbApp/HsfbApp.c" 2
void HsfbApp_Read1ms(void)
{
  ...
  AdcStatus1ms.Iout = 0;
  AdcStatus1ms.Vout = 0;
  AdcStatus1ms.VoutDiag = 0;
  AdcStatus1ms.IproFet = 0;
  for (i = 0; i < 13; i++) {
    if ((((s32)adc1ms[(i)]) >= 0) && (((s32)adc1ms[(i)]) <= 4095)) {
      Switch_j = adc1ms[(i)];
    } else {
      Switch_j = HsfbApp_DW.Delay_DSTATE[i];
    }

    HsfbApp_DW.Delay_DSTATE[i] = Switch_j;
    Switch[i] = Switch_j;
  }

  AdcStatus1ms.Vaux = Switch[0];
  AdcStatus1ms.Vkl30 = Switch[1];
  AdcStatus1ms.Vkl30C = Switch[2];
  AdcStatus1ms.Vcomp = Switch[3];
  AdcStatus1ms.VrefDiag = Switch[4];
  AdcStatus1ms.Vhw16V = Switch[5];
  AdcStatus1ms.Vhw19V = Switch[6];
  AdcStatus1ms.NtcPri = Switch[7];
  AdcStatus1ms.NtcSrA = Switch[8];
  AdcStatus1ms.NtcSrB = Switch[9];
  AdcStatus1ms.NtcWaterIn = Switch[10];
  AdcStatus1ms.NtcWaterOut = Switch[11];
  AdcStatus1ms.NtcWaterOutDiag = Switch[12];
  PortStatus1ms.FastTurnOff = !((*(PortInPt[0].Port) & ((u16)0x1 << PortInPt[0].Pin)) != 0);
  PortStatus1ms.PriDriveDis = ((*(PortInPt[1].Port) & ((u16)0x1 << PortInPt[1].Pin)) != 0);
  PortStatus1ms.SrDriveDis = !((*(PortInPt[2].Port) & ((u16)0x1 << PortInPt[2].Pin)) != 0);
  PortStatus1ms.IpriCbc = (0U);
  PortStatus1ms.IpriOcp = !((*(PortInPt[4].Port) & ((u16)0x1 << PortInPt[4].Pin)) != 0);
  PortStatus1ms.VinOvp = !((*(PortInPt[5].Port) & ((u16)0x1 << PortInPt[5].Pin)) != 0);
  PortStatus1ms.IoutPOcp = !((*(PortInPt[6].Port) & ((u16)0x1 << PortInPt[6].Pin)) != 0);
  PortStatus1ms.IoutNOcp = !((*(PortInPt[7].Port) & ((u16)0x1 << PortInPt[7].Pin)) != 0);
  PortStatus1ms.Vout16VOvp = !((*(PortInPt[8].Port) & ((u16)0x1 << PortInPt[8].Pin)) != 0);
  PortStatus1ms.Vout19VOvp = !((*(PortInPt[9].Port) & ((u16)0x1 << PortInPt[9].Pin)) != 0);
  PortStatus1ms.WaterOutOtp = !((*(PortInPt[10].Port) & ((u16)0x1 << PortInPt[10].Pin)) != 0);
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 255 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 231 "../40_Appl/HsfbApp/HsfbApp.c" 2
...
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 238 "../40_Appl/HsfbApp/HsfbApp.c" 2
void HsfbApp_Write1ms(void)
{
  HsfbApp_ErrReset((!SafetyStatus1ms.AutoDiagStatus.EachRun[0]) &&
                   (!SafetyStatus1ms.AutoDiagStatus.EachRun[1]),
                   StateStatus.ErrReset);
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 255 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 246 "../40_Appl/HsfbApp/HsfbApp.c" 2
...
# 268 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".code_ram" ax 8
# 253 "../40_Appl/HsfbApp/HsfbApp.c" 2
void HsfbApp_Call15us(void)
{
  HsfbApp_Read15us();
  HsfbMeas_Call15us(&AdcStatus15us, &MeasStatus15us);
  HsfbCtrl_Call15us(&MeasStatus15us, &PwmStatus15us, &HsfbApp_Rx10ms,
                    &CtrlStatus15us);
}
...
# 281 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 262 "../40_Appl/HsfbApp/HsfbApp.c" 2
...
# 268 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".code_ram" ax 8
# 269 "../40_Appl/HsfbApp/HsfbApp.c" 2
void HsfbApp_Call15us1(void)
{
  HsfbPwm_Call15us(&CtrlStatus15us, &MeasStatus100us, &PwmStatus15us);
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 281 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 275 "../40_Appl/HsfbApp/HsfbApp.c" 2
...
# 268 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".code_ram" ax 8
# 282 "../40_Appl/HsfbApp/HsfbApp.c" 2
void HsfbApp_Call100us(void)
{
  HsfbApp_Read100us();
  HsfbMeas_Call100us(&AdcStatus100us, &MeasStatus100us);
  HsfbCtrl_Call100us(&MeasStatus100us, &PwmStatus15us, &HsfbApp_Rx10ms,
                     &CtrlStatus100us);
  HsfbPwm_Call100us(&MeasStatus100us, &CtrlStatus100us, &StateStatus,
                    &HsfbApp_Rx10ms, &SafetyStatus100us);
  HsfbSafety_Call100us(&MeasStatus100us, &PwmStatus15us, &StateStatus,
                       &SafetyStatus100us);
}
...
# 281 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 295 "../40_Appl/HsfbApp/HsfbApp.c" 2
...
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 302 "../40_Appl/HsfbApp/HsfbApp.c" 2
void HsfbApp_Call1ms(void)
{
  HsfbApp_Read1ms();
  HsfbMeas_Call1ms(&AdcStatus1ms, &PwmStatus15us, &MeasStatus1ms);
  HsfbDiag_Call1ms(&PortStatus1ms, &MeasStatus1ms, &CtrlStatus15us, &NtcStatus,
                   &StateStatus, &SafetyStatus1ms, &DiagStatus1ms);
  HsfbState_Call1ms(&DiagStatus1ms, &SafetyStatus1ms, &HsfbApp_Rx10ms,
                    &StateStatus);
  HsfbSafety_Call1ms(&MeasStatus1ms, &PortStatus1ms, &HsfbApp_Rx10ms,
                     &SafetyStatus1ms);
  HsfbApp_Write1ms();
}
...
# 255 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 316 "../40_Appl/HsfbApp/HsfbApp.c" 2
...
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 323 "../40_Appl/HsfbApp/HsfbApp.c" 2
void HsfbApp_Call10ms(void)
{
  HsfbApp_GetRx10ms(&HsfbApp_Rx10ms);
  HsfbNtc_Call10ms(&AdcStatus1ms, &NtcStatus);
  HsfbApp_Tx10ms.AppStatus = Isr_AppStatus;
  HsfbApp_Tx10ms.PortStatus = PortStatus1ms;
  HsfbApp_Tx10ms.MeasStatus = MeasStatus1ms;
  HsfbApp_Tx10ms.DiagStatus = DiagStatus1ms;
  HsfbApp_Tx10ms.StateStatus = StateStatus;
  HsfbApp_Tx10ms.NtcStatus = NtcStatus;
  HsfbApp_Tx10ms.SafetyStatus = SafetyStatus1ms;
  HsfbApp_SetTx10ms(&HsfbApp_Tx10ms);
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 255 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 338 "../40_Appl/HsfbApp/HsfbApp.c" 2
...
# 345 "../40_Appl/HsfbApp/HsfbApp.c" 2
void HsfbApp_CallInit(void)
{
  HsfbMeas_CallInit();
  HsfbCtrl_CallInit();
  HsfbPwm_CallInit();
...
#pragma section
# 357 "../40_Appl/HsfbApp/HsfbApp.c" 2
...
# 294 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_QM_CODE" ax 8
# 364 "../40_Appl/HsfbApp/HsfbApp.c" 2
void HsfbApp_initialize(void)
{
  HsfbPwm_Init();
  HsfbSafety_Init();
  HsfbState_p_Init();
...
# 307 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 372 "../40_Appl/HsfbApp/HsfbApp.c" 2
...
# 294 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_QM_CODE" ax 8
# 379 "../40_Appl/HsfbApp/HsfbApp.c" 2
void HsfbApp_terminate(void)
{
...
# 307 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 385 "../40_Appl/HsfbApp/HsfbApp.c" 2
