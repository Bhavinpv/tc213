...
# 11 "../40_Appl/HsfbDiag/HsfbDiag.h"
...
# 12 "../40_Appl/HsfbDiag/HsfbDiag.h" 2
...
# 11 "../40_Appl/HsfbDiag/HsfbDiag_types.h" 2
...
# 13 "../40_Appl/HsfbDiag/HsfbDiag_types.h" 2
...
# 8 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
# 1 "../40_Appl/HsfbDiag/HsfbDiag_private.h" 1
# 12 "../40_Appl/HsfbDiag/HsfbDiag_private.h"
...
# 13 "../40_Appl/HsfbDiag/HsfbDiag_private.h" 2
# 9 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
# 18 "../40_Appl/HsfbDiag/HsfbDiag.c"
# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 36 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".bss.MPU_ASIL_VAR_NOINIT" awB 8
# 19 "../40_Appl/HsfbDiag/HsfbDiag.c" 2

HSFBDIAG_S_ERRCODE0 HsfbDiag_ErrCode0;
HSFBDIAG_S_ERRCODE1 HsfbDiag_ErrCode1;
HSFBDIAG_S_ERRCODE2 HsfbDiag_ErrCode2;
HSFBDIAG_S_ERRCODE3 HsfbDiag_ErrCode3;
HSFBDIAG_S_ENDIS HsfbDiag_EnDis;
HSFBDIAG_S_ERRMASK HsfbDiag_ErrMask;
bit HsfbDiag_LatchReset;
bit HsfbDiag_ErrCode0En;

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 49 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 30 "../40_Appl/HsfbDiag/HsfbDiag.c" 2


# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 36 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".bss.MPU_ASIL_VAR_NOINIT" awB 8
# 33 "../40_Appl/HsfbDiag/HsfbDiag.c" 2

DW_HsfbDiag_f_T HsfbDiag_DW;

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 49 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 37 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
...
# 36 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".bss.MPU_ASIL_VAR_NOINIT" awB 8
# 42 "../40_Appl/HsfbDiag/HsfbDiag.c" 2

const HSFBAPP_S_PORTSTATUS *HsfbDiag_PortStatus1ms;
const HSFBMEAS_S_STATUS1MS *HsfbDiag_MeasStatus1ms;
const HSFBCTRL_S_STATUS15US *HsfbDiag_CtrlStatus15us;
const HSFBNTC_S_STATUS *HsfbDiag_NtcStatus10ms;
const HSFBSAFETY_S_STATUS1MS *HsfbDiag_SafetyStatus1ms;
HSFBDIAG_S_STATUS1MS *HsfbDiag_DiagStatus1ms;

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 49 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 51 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
# 59 "../40_Appl/HsfbDiag/HsfbDiag.c"
# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 60 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
void HsfbDiag_ErrCode0_Calc(void)
{
  HsfbDiag_ErrCode0.HwVerError = (((Main_HwVer.Ver == MAIN_E_HW_Reserved)));
  HsfbDiag_ErrCode0.AutoDiagOvp16V =
    HsfbDiag_SafetyStatus1ms->SafetyStatus.DCDC01_LFD2;
  HsfbDiag_ErrCode0.AutoDiagOvp19V =
    HsfbDiag_SafetyStatus1ms->SafetyStatus.DCDC02_LFD2;
  HsfbDiag_ErrCode0.AutoDiagOtp =
    HsfbDiag_SafetyStatus1ms->SafetyStatus.Batt02_LFD5;
  HsfbDiag_ErrCode0.AutoDiagKL30 =
    HsfbDiag_SafetyStatus1ms->SafetyStatus.DCDC05_LFD2;
  HsfbDiag_ErrCode0.FastTurnOff = HsfbDiag_PortStatus1ms->FastTurnOff;
  HsfbDiag_ErrCode0.DrvPriOff = HsfbDiag_PortStatus1ms->PriDriveDis;
  HsfbDiag_ErrCode0.DrvSrOff = HsfbDiag_PortStatus1ms->SrDriveDis;
  HsfbDiag_ErrCode0.Reserved10 = (0U);
  HsfbDiag_ErrCode0.OvpVout16V = HsfbDiag_PortStatus1ms->Vout16VOvp;
  HsfbDiag_ErrCode0.OvpVout19V = HsfbDiag_PortStatus1ms->Vout19VOvp;
  HsfbDiag_ErrCode0.OcpIoutP = HsfbDiag_PortStatus1ms->IoutPOcp;
  HsfbDiag_ErrCode0.OcpIoutN = HsfbDiag_PortStatus1ms->IoutNOcp;
  HsfbDiag_ErrCode0.OvpVin = HsfbDiag_PortStatus1ms->VinOvp;
  HsfbDiag_ErrCode0.OcpCt = HsfbDiag_PortStatus1ms->IpriOcp;
  HsfbDiag_ErrCode0.Reserved15 = (0U);
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 255 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 85 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
...
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 92 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
void HsfbDiag_ErrCode1_Calc(void)
{
  HsfbDiag_ErrCode1.AutoDiagNotFin =
    !HsfbDiag_SafetyStatus1ms->AutoDiagStatus.AutoDiagFin;
  HsfbDiag_ErrCode1.Reserved13 = DebugError[3];
  HsfbDiag_ErrCode1.Reserved14 = DebugError[2];
  HsfbDiag_ErrCode1.Reserved15 = DebugError[1];
  HsfbDiag_ErrCode1.Reserved16 = DebugError[0];
  HsfbDiag_ErrCode1.BoostRampFin =
    HsfbDiag_CtrlStatus15us->CtrlError.BoostRampFin;
  HsfbDiag_ErrCode1.AutoDiagWait =
    HsfbDiag_SafetyStatus1ms->AutoDiagStatus.AutoDiagWait;
  HsfbDiag_ErrCode1.BoostRampFail =
    HsfbDiag_CtrlStatus15us->CtrlError.BoostRampFail;
  HsfbDiag_ErrCode1.Reserved5 = (0U);
  HsfbDiag_ErrCode1.Reserved6 = (0U);
  HsfbDiag_ErrCode1.Reserved7 = (0U);
  HsfbDiag_ErrCode1.Reserved8 = (0U);
  HsfbDiag_ErrCode1.Reserved9 = (0U);
  HsfbDiag_ErrCode1.Reserved10 = (0U);
  HsfbDiag_ErrCode1.Reserved11 = (0U);
  HsfbDiag_ErrCode1.Reserved12 = (0U);
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 255 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 117 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
# 128 "../40_Appl/HsfbDiag/HsfbDiag.c"
# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 129 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
void HsfbDiag_MaxCheck(f32 val, f32 max, u16 max_cnt, bit *max_out,
  DW_HsfbDiag_MaxCheck_T *localDW)
{
  u16 Switch_cb;
  if (val > max) {
    Switch_cb = localDW->cnt_delay_DSTATE;
  } else {
    Switch_cb = 0U;
  }

  *max_out = (Switch_cb >= max_cnt);
  localDW->cnt_delay_DSTATE = (u16)((u32)(((u32)(!(*max_out))) + ((u32)Switch_cb)));
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 255 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 144 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
# 153 "../40_Appl/HsfbDiag/HsfbDiag.c"
# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 154 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
void HsfbDiag_MaxHysCheck(f32 val, f32 maxH, f32 maxL, u16 max_cnt, bit *max_out,
  DW_HsfbDiag_MaxHysCheck_T *localDW)
{
  u16 Switch_b;
  bit Merge_d;
  Merge_d = ((val > maxH) || ((val >= maxL) && (localDW->out_delay_DSTATE)));
  if (Merge_d) {
    Switch_b = localDW->cnt_delay_DSTATE;
  } else {
    Switch_b = 0U;
  }

  *max_out = (Switch_b >= max_cnt);
  localDW->cnt_delay_DSTATE = (u16)((u32)(((u32)(!(*max_out))) + ((u32)Switch_b)));
  localDW->out_delay_DSTATE = Merge_d;
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 255 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 172 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
...
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 179 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
void HsfbDiag_RangeCheck_IproFet(void)
{
  if (HsfbDiag_MeasStatus1ms->Vkl30.Real <= 6.0F) {
    HsfbDiag_DW.Merge_k = (HsfbDiag_MeasStatus1ms->IproFet.Real > 2.001F);
  } else if (HsfbDiag_MeasStatus1ms->Vkl30.Real <= 7.0F) {
    HsfbDiag_DW.Merge_k = (HsfbDiag_MeasStatus1ms->IproFet.Real > 1.757F);
  } else if (HsfbDiag_MeasStatus1ms->Vkl30.Real <= 8.0F) {
    HsfbDiag_DW.Merge_k = (HsfbDiag_MeasStatus1ms->IproFet.Real > 1.579F);
  } else if (HsfbDiag_MeasStatus1ms->Vkl30.Real <= 9.0F) {
    HsfbDiag_DW.Merge_k = (HsfbDiag_MeasStatus1ms->IproFet.Real > 1.44F);
  } else if (HsfbDiag_MeasStatus1ms->Vkl30.Real <= 10.0F) {
    HsfbDiag_DW.Merge_k = (HsfbDiag_MeasStatus1ms->IproFet.Real > 1.73F);
  } else if (HsfbDiag_MeasStatus1ms->Vkl30.Real <= 11.0F) {
    HsfbDiag_DW.Merge_k = (HsfbDiag_MeasStatus1ms->IproFet.Real > 1.609F);
  } else if (HsfbDiag_MeasStatus1ms->Vkl30.Real <= 12.0F) {
    HsfbDiag_DW.Merge_k = (HsfbDiag_MeasStatus1ms->IproFet.Real > 1.523F);
  } else if (HsfbDiag_MeasStatus1ms->Vkl30.Real <= 13.0F) {
    HsfbDiag_DW.Merge_k = (HsfbDiag_MeasStatus1ms->IproFet.Real > 1.447F);
  } else if (HsfbDiag_MeasStatus1ms->Vkl30.Real <= 14.0F) {
    HsfbDiag_DW.Merge_k = (HsfbDiag_MeasStatus1ms->IproFet.Real > 1.373F);
  } else if (HsfbDiag_MeasStatus1ms->Vkl30.Real <= 15.0F) {
    HsfbDiag_DW.Merge_k = (HsfbDiag_MeasStatus1ms->IproFet.Real > 1.223F);
  } else if (HsfbDiag_MeasStatus1ms->Vkl30.Real <= 16.0F) {
    HsfbDiag_DW.Merge_k = (HsfbDiag_MeasStatus1ms->IproFet.Real > 1.177F);
  } else if (HsfbDiag_MeasStatus1ms->Vkl30.Real <= 17.0F) {
    HsfbDiag_DW.Merge_k = (HsfbDiag_MeasStatus1ms->IproFet.Real > 0.721F);
  } else if (HsfbDiag_MeasStatus1ms->Vkl30.Real <= 18.0F) {
    HsfbDiag_DW.Merge_k = (HsfbDiag_MeasStatus1ms->IproFet.Real > 0.694F);
  } else if (HsfbDiag_MeasStatus1ms->Vkl30.Real <= 19.0F) {
    HsfbDiag_DW.Merge_k = (HsfbDiag_MeasStatus1ms->IproFet.Real > 0.671F);
  } else {
    HsfbDiag_DW.Merge_k = ((HsfbDiag_MeasStatus1ms->Vkl30.Real <= 20.0F) &&
      (HsfbDiag_MeasStatus1ms->IproFet.Real > 0.65F));
  }
}
...
# 255 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 216 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
...
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 223 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
void HsfbDiag_ErrCode2_Calc(void)
{
  s16 Sum_f;
  bit RelationalOperator_cu;
  bit Merge;
  bit RelationalOperator_jh;
  bit LogicalOperator1;
  bit LogicalOperator_p;
  u16 Switch_b;
  f32 Add;
  Add = (0.1F * ((f32)HsfbDiag_NtcStatus10ms->SrA.Temp)) -
    (0.1F * ((f32)HsfbDiag_NtcStatus10ms->SrB.Temp));
  HsfbDiag_ErrCode2.Vout16VHigh =
    ((HsfbDiag_SafetyStatus1ms->SafetyStatus.DCDC01_SM1) ||
     (HsfbDiag_SafetyStatus1ms->SafetyStatus.DCDC01_SM2));
  HsfbDiag_ErrCode2.Vout19VHigh =
    ((HsfbDiag_SafetyStatus1ms->SafetyStatus.DCDC02_SM1) ||
     (HsfbDiag_SafetyStatus1ms->SafetyStatus.DCDC02_SM2));
  HsfbDiag_MaxCheck(HsfbDiag_MeasStatus1ms->Iout.Real, 350.0F, ((u16)
    100U), &HsfbDiag_ErrCode2.IoutHigh, &HsfbDiag_DW.MaxCheck3);
  HsfbDiag_MaxCheck(-250.0F, HsfbDiag_MeasStatus1ms->Iout.Real, ((u16)
    100U), &HsfbDiag_ErrCode2.IoutLow, &HsfbDiag_DW.MaxCheck4);
  HsfbDiag_MaxCheck(HsfbDiag_MeasStatus1ms->Vin.Real, 850.0F, ((u16)
    100U), &HsfbDiag_ErrCode2.VinHigh, &HsfbDiag_DW.MaxCheck5);
  HsfbDiag_MaxHysCheck(0.1F * ((f32)
    HsfbDiag_NtcStatus10ms->Pri.Temp), 145.0F, 120.0F,
                       ((u16)100U),
                       &HsfbDiag_ErrCode2.TempPriHigh, &HsfbDiag_DW.MaxHysCheck);
  HsfbDiag_MaxHysCheck(0.1F * ((f32)
    HsfbDiag_NtcStatus10ms->SrA.Temp), 135.0F, 110.0F,
                       ((u16)100U),
                       &HsfbDiag_ErrCode2.TempSrAHigh, &HsfbDiag_DW.MaxHysCheck1);
  HsfbDiag_MaxHysCheck(0.1F * ((f32)
    HsfbDiag_NtcStatus10ms->SrB.Temp), 135.0F, 110.0F,
                       ((u16)100U),
                       &HsfbDiag_ErrCode2.TempSrBHigh, &HsfbDiag_DW.MaxHysCheck2);
  HsfbDiag_MaxCheck(HsfbDiag_MeasStatus1ms->Vaux.Real, 16.0F, ((u16)
    100U), &HsfbDiag_ErrCode2.VauxHigh, &HsfbDiag_DW.MaxCheck1);
  HsfbDiag_MaxCheck(9.0F, HsfbDiag_MeasStatus1ms->Vaux.Real, ((u16)
    100U), &HsfbDiag_ErrCode2.VauxLow, &HsfbDiag_DW.MaxCheck2);
  LogicalOperator1 = ((((f64)HsfbDiag_MeasStatus1ms->Vkl30.Real) > 5.7) ||
                      (!HsfbDiag_SafetyStatus1ms->AutoDiagStatus.AutoDiagFin));
  LogicalOperator_p = ((HsfbDiag_SafetyStatus1ms->AutoDiagStatus.AutoDiagFin) &&
                       (HsfbDiag_MeasStatus1ms->Vkl30.Real < 5.4F));
  if (LogicalOperator1) {
    HsfbDiag_DW.dis_cnt_DSTATE = 0U;
  }

  RelationalOperator_jh = (HsfbDiag_DW.dis_cnt_DSTATE >= ((u16)
    1U));
  if (LogicalOperator_p) {
    HsfbDiag_DW.en_cnt_DSTATE = 0U;
  }

  RelationalOperator_cu = (HsfbDiag_DW.en_cnt_DSTATE >= ((u16)
    1U));
  Merge = (RelationalOperator_jh || ((!RelationalOperator_cu) &&
            (HsfbDiag_DW.out_delay_DSTATE)));
  if (RelationalOperator_jh) {
    Switch_b = ((u16)1U);
  } else {
    Switch_b = HsfbDiag_DW.dis_cnt_DSTATE;
  }

  HsfbDiag_DW.dis_cnt_DSTATE = (u16)((u32)(((u32)LogicalOperator_p) + ((u32)
    Switch_b)));
  if (RelationalOperator_cu) {
    Switch_b = ((u16)1U);
  } else {
    Switch_b = HsfbDiag_DW.en_cnt_DSTATE;
  }

  HsfbDiag_DW.en_cnt_DSTATE = (u16)((u32)(((u32)LogicalOperator1) + ((u32)
    Switch_b)));
  HsfbDiag_DW.out_delay_DSTATE = Merge;
  if (Add <= 0.0F) {
    Add = -Add;
  }

  if (Add > 20.0F) {
    Switch_b = HsfbDiag_DW.cnt_delay_DSTATE_i;
  } else {
    Switch_b = 0U;
  }

  LogicalOperator1 = (Switch_b >= ((u16)1U));
  HsfbDiag_DW.cnt_delay_DSTATE_i = (u16)((u32)(((u32)(!LogicalOperator1)) +
    ((u32)Switch_b)));
  HsfbDiag_RangeCheck_IproFet();
  if (HsfbDiag_DW.Merge_k) {
    Sum_f = 1;
  } else {
    Sum_f = -1;
  }

  Sum_f = (s16)((s32)(((s32)Sum_f) + ((s32)HsfbDiag_DW.cnt_delay_DSTATE)));
  if (((s32)Sum_f) > 3000) {
    Sum_f = 3000;
  } else {
    if (((s32)Sum_f) < 0) {
  ...
  if (((s32)Sum_f) >= 3000) {
    HsfbDiag_DW.Merge_d = (1U);
  } else {
    HsfbDiag_DW.Merge_d = ((((s32)Sum_f) > 0) && (HsfbDiag_DW.Merge_d));
  }

  LogicalOperator_p = ((HsfbDiag_DW.Merge_d) || (HsfbDiag_DW.Delay_DSTATE_k));
  HsfbDiag_ErrCode2.VoutErr1High =
    HsfbDiag_SafetyStatus1ms->SafetyStatus.DCDC01_SM3;
  HsfbDiag_ErrCode2.VoutErr2High =
    HsfbDiag_SafetyStatus1ms->SafetyStatus.DCDC02_SM3;
  HsfbDiag_ErrCode2.VinLow = (0U);
  HsfbDiag_ErrCode2.Vkl30Low = Merge;
  HsfbDiag_ErrCode2.TempErrSrAB_High = LogicalOperator1;
  HsfbDiag_ErrCode2.IproFet_High = LogicalOperator_p;
  HsfbDiag_DW.cnt_delay_DSTATE = Sum_f;
  HsfbDiag_DW.Delay_DSTATE_k = LogicalOperator_p;
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 255 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 347 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
...
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 354 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
void HsfbDiag_ErrCode3_Calc(void)
{
  HsfbDiag_ErrCode3.FlybackShort = SafetyError[3];
  HsfbDiag_ErrCode3.E2EError = SafetyError[2];
  HsfbDiag_ErrCode3.SbcError = SafetyError[1];
  HsfbDiag_ErrCode3.DspError = SafetyError[0];
  HsfbDiag_ErrCode3.BuckVoltage = HsfbDiag_CtrlStatus15us->CtrlError.BuckVoltage;
  HsfbDiag_ErrCode3.BuckTopology =
    HsfbDiag_CtrlStatus15us->CtrlError.BuckTopology;
  HsfbDiag_ErrCode3.BuckPowerLow =
    HsfbDiag_CtrlStatus15us->CtrlError.BuckPowerLow;
  HsfbDiag_ErrCode3.BuckVinShort =
    HsfbDiag_CtrlStatus15us->CtrlError.BuckVinShort;
  HsfbDiag_ErrCode3.Reserved5 = (0U);
  HsfbDiag_ErrCode3.Reserved6 = (0U);
  HsfbDiag_ErrCode3.Reserved7 = (0U);
  HsfbDiag_ErrCode3.Reserved8 = (0U);
  HsfbDiag_ErrCode3.BoostVoutLimit =
    HsfbDiag_CtrlStatus15us->CtrlError.BoostVoutLimit;
  HsfbDiag_ErrCode3.BoostVinShort =
    HsfbDiag_CtrlStatus15us->CtrlError.BoostVinShort;
  HsfbDiag_ErrCode3.Reserved11 = (0U);
  HsfbDiag_ErrCode3.Reserved12 = (0U);
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 255 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 380 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
...
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 387 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
void HsfbDiag_ErrCode_Latch(void)
{
  u16 tmp;
  if (HsfbDiag_LatchReset) {
    HsfbDiag_DW.BitwiseOR_m = 0U;
  }

  if (HsfbDiag_ErrCode0En) {
    tmp = HsfbDiag_DW.BitwiseOR_my;
  } else {
    tmp = 0U;
  }

  HsfbDiag_DW.BitwiseOR_m = (u16)((s32)(((s32)((u16)((s32)(((s32)tmp) & ((s32)
    HsfbDiag_ErrMask.ErrMask0))))) | ((s32)HsfbDiag_DW.BitwiseOR_m)));
  HsfbDiag_DiagStatus1ms->WarnCode0 = (u16)((s32)(((s32)HsfbDiag_DW.BitwiseOR_m)
    | ((s32)HsfbDiag_DW.BitwiseOR_my)));
  if (HsfbDiag_LatchReset) {
    HsfbDiag_DW.Delay_DSTATE_j = 0U;
    HsfbDiag_DW.Delay_DSTATE_d = 0U;
  }

  HsfbDiag_DW.BitwiseOR_my = (u16)((s32)(((s32)((u16)((s32)(((s32)
    HsfbDiag_DW.BitwiseOR_g) & ((s32)HsfbDiag_ErrMask.ErrMask1))))) | ((s32)
    HsfbDiag_DW.Delay_DSTATE_j)));
  HsfbDiag_DiagStatus1ms->WarnCode1 = (u16)((s32)(((s32)HsfbDiag_DW.BitwiseOR_my)
    | ((s32)HsfbDiag_DW.BitwiseOR_g)));
  HsfbDiag_DW.BitwiseOR_g = (u16)((s32)(((s32)((u16)((s32)(((s32)
    HsfbDiag_DW.BitwiseOR_e) & ((s32)HsfbDiag_ErrMask.ErrMask2))))) | ((s32)
    HsfbDiag_DW.Delay_DSTATE_d)));
  HsfbDiag_DiagStatus1ms->WarnCode2 = (u16)((s32)(((s32)HsfbDiag_DW.BitwiseOR_g)
    | ((s32)HsfbDiag_DW.BitwiseOR_e)));
  if (HsfbDiag_LatchReset) {
    HsfbDiag_DW.Delay_DSTATE_o = 0U;
  }

  HsfbDiag_DW.BitwiseOR_e = (u16)((s32)(((s32)((u16)((s32)(((s32)
    HsfbDiag_DW.BitwiseOR_d) & ((s32)HsfbDiag_ErrMask.ErrMask3))))) | ((s32)
    HsfbDiag_DW.Delay_DSTATE_o)));
  HsfbDiag_DiagStatus1ms->WarnCode3 = (u16)((s32)(((s32)HsfbDiag_DW.BitwiseOR_e)
    | ((s32)HsfbDiag_DW.BitwiseOR_d)));
  HsfbDiag_DW.Delay_DSTATE_j = HsfbDiag_DW.BitwiseOR_my;
  HsfbDiag_DW.Delay_DSTATE_d = HsfbDiag_DW.BitwiseOR_g;
  HsfbDiag_DW.Delay_DSTATE_o = HsfbDiag_DW.BitwiseOR_e;
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 255 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 434 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
...
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 441 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
void HsfbDiag_ErrCode_Mux(void)
{
  HsfbDiag_DW.BitwiseOR_my = (u16)((s32)(((s32)(((s32)(((s32)(((s32)(((s32)
    (((s32)(((s32)(((s32)(((s32)(((s32)HsfbDiag_ErrCode0.OvpVout19V) << 1U)) |
    ((s32)HsfbDiag_ErrCode0.OvpVout16V))) | ((s32)(((s32)
    HsfbDiag_ErrCode0.OcpIoutP) << 2U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode0.OcpIoutN) << 3U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode0.OvpVin) << 4U)))) | ((s32)(((s32)HsfbDiag_ErrCode0.OcpCt) <<
    5U)))) | ((s32)(((s32)HsfbDiag_ErrCode0.Reserved15) << 6U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode0.HwVerError) << 7U)))) << 8)) | ((s32)(((s32)(((s32)(((s32)
    (((s32)(((s32)(((s32)(((s32)(((s32)HsfbDiag_ErrCode0.AutoDiagOvp19V) << 1U))
    | ((s32)HsfbDiag_ErrCode0.AutoDiagOvp16V))) | ((s32)(((s32)
    HsfbDiag_ErrCode0.AutoDiagOtp) << 2U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode0.AutoDiagKL30) << 3U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode0.FastTurnOff) << 4U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode0.DrvPriOff) << 5U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode0.DrvSrOff) << 6U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode0.Reserved10) << 7U))))));
  HsfbDiag_DW.BitwiseOR_g = (u16)((s32)(((s32)(((s32)(((s32)(((s32)(((s32)(((s32)
    (((s32)(((s32)(((s32)(((s32)HsfbDiag_ErrCode1.Reserved10) << 1U)) | ((s32)
    HsfbDiag_ErrCode1.Reserved9))) | ((s32)(((s32)HsfbDiag_ErrCode1.Reserved11) <<
    2U)))) | ((s32)(((s32)HsfbDiag_ErrCode1.Reserved12) << 3U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode1.Reserved13) << 4U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode1.Reserved14) << 5U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode1.Reserved15) << 6U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode1.Reserved16) << 7U)))) << 8)) | ((s32)(((s32)(((s32)(((s32)
    (((s32)(((s32)(((s32)(((s32)(((s32)HsfbDiag_ErrCode1.AutoDiagWait) << 1U)) |
    ((s32)HsfbDiag_ErrCode1.BoostRampFin))) | ((s32)(((s32)
    HsfbDiag_ErrCode1.AutoDiagNotFin) << 2U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode1.BoostRampFail) << 3U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode1.Reserved5) << 4U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode1.Reserved6) << 5U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode1.Reserved7) << 6U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode1.Reserved8) << 7U))))));
  HsfbDiag_DW.BitwiseOR_e = (u16)((s32)(((s32)(((s32)(((s32)(((s32)(((s32)(((s32)
    (((s32)(((s32)(((s32)(((s32)HsfbDiag_ErrCode2.TempSrAHigh) << 1U)) | ((s32)
    HsfbDiag_ErrCode2.TempPriHigh))) | ((s32)(((s32)
    HsfbDiag_ErrCode2.TempSrBHigh) << 2U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode2.VauxHigh) << 3U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode2.VauxLow) << 4U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode2.Vkl30Low) << 5U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode2.TempErrSrAB_High) << 6U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode2.IproFet_High) << 7U)))) << 8)) | ((s32)(((s32)(((s32)
    (((s32)(((s32)(((s32)(((s32)(((s32)(((s32)HsfbDiag_ErrCode2.VoutErr1High) <<
    1U)) | ((s32)HsfbDiag_ErrCode2.Vout16VHigh))) | ((s32)(((s32)
    HsfbDiag_ErrCode2.Vout19VHigh) << 2U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode2.VoutErr2High) << 3U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode2.IoutHigh) << 4U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode2.IoutLow) << 5U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode2.VinHigh) << 6U)))) | ((s32)(((s32)HsfbDiag_ErrCode2.VinLow)
    << 7U))))));
  HsfbDiag_DW.BitwiseOR_d = (u16)((s32)(((s32)(((s32)(((s32)(((s32)(((s32)(((s32)
    (((s32)(((s32)(((s32)(((s32)HsfbDiag_ErrCode3.BoostVinShort) << 1U)) | ((s32)
    HsfbDiag_ErrCode3.BoostVoutLimit))) | ((s32)(((s32)
    HsfbDiag_ErrCode3.Reserved11) << 2U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode3.Reserved12) << 3U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode3.FlybackShort) << 4U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode3.E2EError) << 5U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode3.SbcError) << 6U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode3.DspError) << 7U)))) << 8)) | ((s32)(((s32)(((s32)(((s32)
    (((s32)(((s32)(((s32)(((s32)(((s32)HsfbDiag_ErrCode3.BuckTopology) << 1U)) |
    ((s32)HsfbDiag_ErrCode3.BuckVoltage))) | ((s32)(((s32)
    HsfbDiag_ErrCode3.BuckPowerLow) << 2U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode3.BuckVinShort) << 3U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode3.Reserved5) << 4U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode3.Reserved6) << 5U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode3.Reserved7) << 6U)))) | ((s32)(((s32)
    HsfbDiag_ErrCode3.Reserved8) << 7U))))));
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 255 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 512 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
...
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 519 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
void HsfbDiag_Call1ms(const HSFBAPP_S_PORTSTATUS *PortStatus1ms, const
                      HSFBMEAS_S_STATUS1MS *MeasStatus1ms, const
                      HSFBCTRL_S_STATUS15US *CtrlStatus15us, const
                      HSFBNTC_S_STATUS *NtcStatus10ms, const HSFBSTATE_S_STATUS *
                      StateStatus, const HSFBSAFETY_S_STATUS1MS *SafetyStatus1ms,
                      HSFBDIAG_S_STATUS1MS *DiagStatus1ms)
{
  HsfbDiag_PortStatus1ms = PortStatus1ms;
  HsfbDiag_MeasStatus1ms = MeasStatus1ms;
  HsfbDiag_CtrlStatus15us = CtrlStatus15us;
  HsfbDiag_NtcStatus10ms = NtcStatus10ms;
  HsfbDiag_SafetyStatus1ms = SafetyStatus1ms;
  HsfbDiag_DiagStatus1ms = DiagStatus1ms;
  HsfbDiag_LatchReset = StateStatus->Reset;
  HsfbDiag_ErrCode0En = (((!SafetyStatus1ms->AutoDiagStatus.EachRun[0]) &&
    (!SafetyStatus1ms->AutoDiagStatus.EachRun[1])) &&
    (!SafetyStatus1ms->AutoDiagStatus.EachRun[2]));
  ...
  DiagStatus1ms->ErrCode0 = HsfbDiag_DW.BitwiseOR_m;
  DiagStatus1ms->ErrCode1 = HsfbDiag_DW.BitwiseOR_my;
  DiagStatus1ms->ErrCode2 = HsfbDiag_DW.BitwiseOR_g;
  DiagStatus1ms->ErrCode3 = HsfbDiag_DW.BitwiseOR_e;
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 255 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 549 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
...
# 556 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
void HsfbDiag_CallInit(void)
{
  HsfbDiag_ErrMask.ErrMask0 = ((u16)64912U);
  HsfbDiag_ErrMask.ErrMask1 = ((u16)0U);
  HsfbDiag_ErrMask.ErrMask2 = ((u16)65523U);
  HsfbDiag_ErrMask.ErrMask3 = ((u16)24571U);
  HsfbDiag_EnDis.PriDis = (0U);
  HsfbDiag_EnDis.SrDis = (0U);
  HsfbDiag_EnDis.ClampDis = (0U);
  HsfbDiag_ErrCode0En = (0U);
  HsfbDiag_LatchReset = (0U);
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 307 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 570 "../40_Appl/HsfbDiag/HsfbDiag.c" 2
