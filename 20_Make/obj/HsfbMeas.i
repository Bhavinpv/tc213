...
# 11 "../40_Appl/HsfbMeas/HsfbMeas.h"
...
# 12 "../40_Appl/HsfbMeas/HsfbMeas.h" 2
...
# 11 "../40_Appl/HsfbMeas/HsfbMeas_types.h" 2
...
# 12 "../40_Appl/HsfbMeas/HsfbMeas_types.h" 2
...
# 8 "../40_Appl/HsfbMeas/HsfbMeas.c" 2
# 1 "../40_Appl/HsfbMeas/HsfbMeas_private.h" 1
# 12 "../40_Appl/HsfbMeas/HsfbMeas_private.h"
...
# 13 "../40_Appl/HsfbMeas/HsfbMeas_private.h" 2
# 9 "../40_Appl/HsfbMeas/HsfbMeas.c" 2
# 18 "../40_Appl/HsfbMeas/HsfbMeas.c"
# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 36 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".bss.MPU_ASIL_VAR_NOINIT" awB 8
# 19 "../40_Appl/HsfbMeas/HsfbMeas.c" 2

HSFBMEAS_S_PARAM HsfbMeas_Param;
HSFBMEAS_S_FILTER HsfbMeas_Filter;
HSFBMEAS_S_CALIB HsfbMeas_Calib;
HSFBMEAS_S_INITOFFSET HsfbMeas_InitOffset;

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 49 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 26 "../40_Appl/HsfbMeas/HsfbMeas.c" 2


# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 36 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".bss.MPU_ASIL_VAR_NOINIT" awB 8
# 29 "../40_Appl/HsfbMeas/HsfbMeas.c" 2

DW_HsfbMeas_f_T HsfbMeas_DW;

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 49 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 33 "../40_Appl/HsfbMeas/HsfbMeas.c" 2
...
# 36 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".bss.MPU_ASIL_VAR_NOINIT" awB 8
# 38 "../40_Appl/HsfbMeas/HsfbMeas.c" 2

const HSFBPWM_S_STATUS15US *HsfbMeas_PwmStatus15us;

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 49 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 42 "../40_Appl/HsfbMeas/HsfbMeas.c" 2
# 50 "../40_Appl/HsfbMeas/HsfbMeas.c"
# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 51 "../40_Appl/HsfbMeas/HsfbMeas.c" 2
void HsfbMeas_Calibration(void)
{
  f32 Add;
  f32 Switch;
  HsfbMeas_GetCalibData(&HsfbMeas_Calib);
  HsfbMeas_Param.Iout.Gain = (s16)((HsfbMeas_Calib.Iout.Gain + 1.0F) *
    12153.0F);
  HsfbMeas_Param.Iout.Offset = (s16)(((4096.0F * HsfbMeas_Calib.Iout.Offset) /
    (12153.0F * 0.1F)) + ((f32)
    HsfbMeas_InitOffset.Iout));
  HsfbMeas_Param.Iout.Factor = 0.1F;
  HsfbMeas_Param.Vout.Gain = (s16)((HsfbMeas_Calib.Vout.Gain + 1.0F) *
    2558.0F);
  HsfbMeas_Param.Vout.Offset = (s16)(((4096.0F * HsfbMeas_Calib.Vout.Offset) /
    (2558.0F * 0.01F)) + 0.0F);
  HsfbMeas_Param.Vout.Factor = 0.01F;
  if (((s32)(Main_HwVer.App.Meas)) == 1) {
    Switch = 3240.0F;
  } else {
    Switch = 5500.0F;
  }

  HsfbMeas_Param.Vkl30.Gain = (s16)((HsfbMeas_Calib.Vkl30.Gain + 1.0F) * Switch);
  HsfbMeas_Param.Vkl30.Offset = (s16)(((4096.0F * HsfbMeas_Calib.Vkl30.Offset) /
    (Switch * 0.01F)) + 0.0F);
  HsfbMeas_Param.Vkl30.Factor = 0.01F;
  Switch = 0.1F * HsfbMeas_Filter.Vin;
  if (Switch < HsfbMeas_Calib.Vin_OP1) {
    Add = HsfbMeas_Calib.Vin_P1.Gain;
    Switch = HsfbMeas_Calib.Vin_P1.Offset;
  } else if (Switch < HsfbMeas_Calib.Vin_OP2) {
    Add = HsfbMeas_Calib.Vin_P2.Gain;
    Switch = HsfbMeas_Calib.Vin_P2.Offset;
  } else {
    Add = HsfbMeas_Calib.Vin_P3.Gain;
    Switch = HsfbMeas_Calib.Vin_P3.Offset;
  }

  Add = ((Add - HsfbMeas_DW.Delay_DSTATE_c) * 0.3F) +
    HsfbMeas_DW.Delay_DSTATE_c;
  Switch = ((Switch - HsfbMeas_DW.Delay_DSTATE_kp) * 0.3F) +
    HsfbMeas_DW.Delay_DSTATE_kp;
  HsfbMeas_Param.Vin.Gain = (s16)((Add + 1.0F) * 21111.0F);
  HsfbMeas_Param.Vin.Offset = (s16)(((4096.0F * Switch) / (21111.0F *
    0.1F)) + 0.0F);
  HsfbMeas_Param.Vin.Factor = 0.1F;
  if (((s32)(Main_HwVer.App.Meas)) == 1) {
    HsfbMeas_Param.Ipri.Gain = (s16)5338.0F;
  } else {
    HsfbMeas_Param.Ipri.Gain = (s16)(HsfbMeas_PwmStatus15us->IpriPwmGain *
      5338.0F);
  }

  HsfbMeas_DW.Delay_DSTATE_c = Add;
  HsfbMeas_DW.Delay_DSTATE_kp = Switch;
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 255 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 109 "../40_Appl/HsfbMeas/HsfbMeas.c" 2
...
# 116 "../40_Appl/HsfbMeas/HsfbMeas.c" 2
void HsfbMeas_InitOffsetCheck(void)
{
  s16 DataTypeConversion1;
  s16 Switch2;
  DataTypeConversion1 = (s16)((s32)(((s32)((s16)2048.0F)) - 200));
  Switch2 = (s16)((s32)(((s32)DataTypeConversion1) + 400));
  if (((s32)HsfbMeas_InitOffset.Iout) <= ((s32)Switch2)) {
    if (((s32)HsfbMeas_InitOffset.Iout) < ((s32)DataTypeConversion1)) {
      Switch2 = DataTypeConversion1;
    } else {
      Switch2 = HsfbMeas_InitOffset.Iout;
    }
  }

  HsfbMeas_InitOffset.Iout = Switch2;
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 307 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 134 "../40_Appl/HsfbMeas/HsfbMeas.c" 2
...
# 141 "../40_Appl/HsfbMeas/HsfbMeas.c" 2
void HsfbMeas_Call100us(const HSFBAPP_S_AI *AdcStatus100us,
  HSFBMEAS_S_STATUS100US *MeasStatus100us)
{
  s16 Data_c;
  Data_c = (s16)((s32)(((s32)(((s32)((s16)((s32)(((s32)AdcStatus100us->Ipri) -
    ((s32)HsfbMeas_Param.Ipri.Offset))))) * ((s32)HsfbMeas_Param.Ipri.Gain))) >>
                       12));
  MeasStatus100us->Ipri.Data = Data_c;
  MeasStatus100us->Ipri.Real = ((f32)Data_c) * HsfbMeas_Param.Ipri.Factor;
  Data_c = (s16)((s32)(((s32)(((s32)((s16)((s32)(((s32)AdcStatus100us->Vin) -
    ((s32)HsfbMeas_Param.Vin.Offset))))) * ((s32)HsfbMeas_Param.Vin.Gain))) >>
                       12));
  MeasStatus100us->Vin.Data = Data_c;
  MeasStatus100us->Vin.Real = ((f32)Data_c) * HsfbMeas_Param.Vin.Factor;
  Data_c = (s16)((s32)(((s32)(((s32)((s16)((s32)(((s32)AdcStatus100us->Iout) -
    ((s32)HsfbMeas_Param.Iout.Offset))))) * ((s32)HsfbMeas_Param.Iout.Gain))) >>
                       12));
  MeasStatus100us->Iout.Data = Data_c;
  MeasStatus100us->Iout.Real = ((f32)Data_c) * HsfbMeas_Param.Iout.Factor;
  Data_c = (s16)((s32)(((s32)(((s32)((s16)((s32)(((s32)AdcStatus100us->Vout) -
    ((s32)HsfbMeas_Param.Vout.Offset))))) * ((s32)HsfbMeas_Param.Vout.Gain))) >>
                       12));
  MeasStatus100us->Vout.Data = Data_c;
  MeasStatus100us->Vout.Real = ((f32)Data_c) * HsfbMeas_Param.Vout.Factor;
  Data_c = (s16)((s32)(((s32)(((s32)((s16)((s32)(((s32)AdcStatus100us->VoutDiag)
    - ((s32)HsfbMeas_Param.VoutDiag.Offset))))) * ((s32)
    HsfbMeas_Param.VoutDiag.Gain))) >> 12));
  MeasStatus100us->VoutDiag.Data = Data_c;
  MeasStatus100us->VoutDiag.Real = ((f32)Data_c) *
    HsfbMeas_Param.VoutDiag.Factor;
  Data_c = (s16)((s32)(((s32)(((s32)((s16)((s32)(((s32)AdcStatus100us->IproFet)
    - ((s32)HsfbMeas_Param.IproFet.Offset))))) * ((s32)
    HsfbMeas_Param.IproFet.Gain))) >> 12));
  MeasStatus100us->IproFet.Data = Data_c;
  MeasStatus100us->IproFet.Real = ((f32)Data_c) * HsfbMeas_Param.IproFet.Factor;
  HsfbMeas_Filter.IproFet += (((f32)MeasStatus100us->IproFet.Data) -
    HsfbMeas_Filter.IproFet) * 0.008F;
  HsfbMeas_Filter.Ipri += (((f32)MeasStatus100us->Ipri.Data) -
    HsfbMeas_Filter.Ipri) * 0.008F;
  HsfbMeas_Filter.Vin += (((f32)MeasStatus100us->Vin.Data) - HsfbMeas_Filter.Vin)
    * 0.008F;
  HsfbMeas_Filter.Iout += (((f32)MeasStatus100us->Iout.Data) -
    HsfbMeas_Filter.Iout) * 0.008F;
  HsfbMeas_Filter.Vout += (((f32)MeasStatus100us->Vout.Data) -
    HsfbMeas_Filter.Vout) * 0.008F;
  HsfbMeas_Filter.VoutDiag += (((f32)MeasStatus100us->VoutDiag.Data) -
    HsfbMeas_Filter.VoutDiag) * 0.008F;
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 281 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 191 "../40_Appl/HsfbMeas/HsfbMeas.c" 2
...
# 268 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".code_ram" ax 8
# 198 "../40_Appl/HsfbMeas/HsfbMeas.c" 2
void HsfbMeas_Call15us(const HSFBAPP_S_AI *AdcStatus15us, HSFBMEAS_S_STATUS15US *
  MeasStatus15us)
{
  s16 Data;
  Data = (s16)((s32)(((s32)(((s32)((s16)((s32)(((s32)AdcStatus15us->Ipri) -
    ((s32)HsfbMeas_Param.Ipri.Offset))))) * ((s32)HsfbMeas_Param.Ipri.Gain))) >>
                     12));
  MeasStatus15us->Ipri.Data = Data;
  MeasStatus15us->Ipri.Real = ((f32)Data) * HsfbMeas_Param.Ipri.Factor;
  Data = (s16)((s32)(((s32)(((s32)((s16)((s32)(((s32)AdcStatus15us->Vin) - ((s32)
    HsfbMeas_Param.Vin.Offset))))) * ((s32)HsfbMeas_Param.Vin.Gain))) >> 12));
  MeasStatus15us->Vin.Data = Data;
  MeasStatus15us->Vin.Real = ((f32)Data) * HsfbMeas_Param.Vin.Factor;
  Data = (s16)((s32)(((s32)(((s32)((s16)((s32)(((s32)AdcStatus15us->Iout) -
    ((s32)HsfbMeas_Param.Iout.Offset))))) * ((s32)HsfbMeas_Param.Iout.Gain))) >>
                     12));
  MeasStatus15us->Iout.Data = Data;
  MeasStatus15us->Iout.Real = ((f32)Data) * HsfbMeas_Param.Iout.Factor;
  Data = (s16)((s32)(((s32)(((s32)((s16)((s32)(((s32)AdcStatus15us->Vout) -
    ((s32)HsfbMeas_Param.Vout.Offset))))) * ((s32)HsfbMeas_Param.Vout.Gain))) >>
                     12));
  MeasStatus15us->Vout.Data = Data;
  MeasStatus15us->Vout.Real = ((f32)Data) * HsfbMeas_Param.Vout.Factor;
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 281 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 224 "../40_Appl/HsfbMeas/HsfbMeas.c" 2
...
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 231 "../40_Appl/HsfbMeas/HsfbMeas.c" 2
void HsfbMeas_Call1ms(const HSFBAPP_S_AI *AdcStatus1ms, const
                      HSFBPWM_S_STATUS15US *PwmStatus15us, HSFBMEAS_S_STATUS1MS *
                      MeasStatus1ms)
{
  s16 Data;
  f32 Add1_m0;
  ...
  f32 Add1_e;
  f32 Add1_k;
  HsfbMeas_PwmStatus15us = PwmStatus15us;
  Add1_m0 = ((((f32)((s16)((s32)(((s32)(((s32)((s16)((s32)(((s32)
    AdcStatus1ms->Vaux) - ((s32)HsfbMeas_Param.Vaux.Offset))))) * ((s32)
    HsfbMeas_Param.Vaux.Gain))) >> 12)))) - HsfbMeas_DW.Delay_DSTATE) *
             0.3F) + HsfbMeas_DW.Delay_DSTATE;
  Data = (s16)Add1_m0;
  MeasStatus1ms->Vaux.Data = Data;
  MeasStatus1ms->Vaux.Real = ((f32)Data) * HsfbMeas_Param.Vaux.Factor;
  Add1_lw = ((((f32)((s16)((s32)(((s32)(((s32)((s16)((s32)(((s32)
    AdcStatus1ms->Vkl30) - ((s32)HsfbMeas_Param.Vkl30.Offset))))) * ((s32)
    HsfbMeas_Param.Vkl30.Gain))) >> 12)))) - HsfbMeas_DW.Delay_DSTATE_e) *
             0.3F) + HsfbMeas_DW.Delay_DSTATE_e;
  Data = (s16)Add1_lw;
  MeasStatus1ms->Vkl30.Data = Data;
  MeasStatus1ms->Vkl30.Real = ((f32)Data) * HsfbMeas_Param.Vkl30.Factor;
  Add1_bz = ((((f32)((s16)((s32)(((s32)(((s32)((s16)((s32)(((s32)
    AdcStatus1ms->Vkl30C) - ((s32)HsfbMeas_Param.Vkl30C.Offset))))) * ((s32)
    HsfbMeas_Param.Vkl30C.Gain))) >> 12)))) - HsfbMeas_DW.Delay_DSTATE_k) *
             0.3F) + HsfbMeas_DW.Delay_DSTATE_k;
  Data = (s16)Add1_bz;
  MeasStatus1ms->Vkl30C.Data = Data;
  MeasStatus1ms->Vkl30C.Real = ((f32)Data) * HsfbMeas_Param.Vkl30C.Factor;
  Add1_fm = ((((f32)((s16)((s32)(((s32)(((s32)((s16)((s32)(((s32)
    AdcStatus1ms->Vcomp) - ((s32)HsfbMeas_Param.Vcomp.Offset))))) * ((s32)
    HsfbMeas_Param.Vcomp.Gain))) >> 12)))) - HsfbMeas_DW.Delay_DSTATE_n) *
             0.3F) + HsfbMeas_DW.Delay_DSTATE_n;
  Data = (s16)Add1_fm;
  MeasStatus1ms->Vcomp.Data = Data;
  MeasStatus1ms->Vcomp.Real = ((f32)Data) * HsfbMeas_Param.Vcomp.Factor;
  Add1_h = ((((f32)((s16)((s32)(((s32)(((s32)((s16)((s32)(((s32)
    AdcStatus1ms->VrefDiag) - ((s32)HsfbMeas_Param.VrefDiag.Offset))))) * ((s32)
    HsfbMeas_Param.VrefDiag.Gain))) >> 12)))) - HsfbMeas_DW.Delay_DSTATE_b) *
            0.3F) + HsfbMeas_DW.Delay_DSTATE_b;
  Data = (s16)Add1_h;
  MeasStatus1ms->VrefDiag.Data = Data;
  MeasStatus1ms->VrefDiag.Real = ((f32)Data) * HsfbMeas_Param.VrefDiag.Factor;
  Add1_e = ((((f32)((s16)((s32)(((s32)(((s32)((s16)((s32)(((s32)
    AdcStatus1ms->Vhw16V) - ((s32)HsfbMeas_Param.Vhw16V.Offset))))) * ((s32)
    HsfbMeas_Param.Vhw16V.Gain))) >> 12)))) - HsfbMeas_DW.Delay_DSTATE_k4) *
            0.3F) + HsfbMeas_DW.Delay_DSTATE_k4;
  Data = (s16)Add1_e;
  MeasStatus1ms->Vhw16V.Data = Data;
  MeasStatus1ms->Vhw16V.Real = ((f32)Data) * HsfbMeas_Param.Vhw16V.Factor;
  Add1_k = ((((f32)((s16)((s32)(((s32)(((s32)((s16)((s32)(((s32)
    AdcStatus1ms->Vhw19V) - ((s32)HsfbMeas_Param.Vhw19V.Offset))))) * ((s32)
    HsfbMeas_Param.Vhw19V.Gain))) >> 12)))) - HsfbMeas_DW.Delay_DSTATE_i) *
            0.3F) + HsfbMeas_DW.Delay_DSTATE_i;
  Data = (s16)Add1_k;
  MeasStatus1ms->Vhw19V.Data = Data;
  MeasStatus1ms->Vhw19V.Real = ((f32)Data) * HsfbMeas_Param.Vhw19V.Factor;
  Data = (s16)HsfbMeas_Filter.Ipri;
  MeasStatus1ms->Ipri.Data = Data;
  MeasStatus1ms->Ipri.Real = ((f32)Data) * HsfbMeas_Param.Ipri.Factor;
  Data = (s16)HsfbMeas_Filter.Vin;
  MeasStatus1ms->Vin.Data = Data;
  MeasStatus1ms->Vin.Real = ((f32)Data) * HsfbMeas_Param.Vin.Factor;
  Data = (s16)HsfbMeas_Filter.Iout;
  MeasStatus1ms->Iout.Data = Data;
  MeasStatus1ms->Iout.Real = ((f32)Data) * HsfbMeas_Param.Iout.Factor;
  Data = (s16)HsfbMeas_Filter.Vout;
  MeasStatus1ms->Vout.Data = Data;
  MeasStatus1ms->Vout.Real = ((f32)Data) * HsfbMeas_Param.Vout.Factor;
  Data = (s16)HsfbMeas_Filter.VoutDiag;
  MeasStatus1ms->VoutDiag.Data = Data;
  MeasStatus1ms->VoutDiag.Real = ((f32)Data) * HsfbMeas_Param.VoutDiag.Factor;
  Data = (s16)HsfbMeas_Filter.IproFet;
  MeasStatus1ms->IproFet.Data = Data;
  MeasStatus1ms->IproFet.Real = ((f32)Data) * HsfbMeas_Param.IproFet.Factor;
  HsfbMeas_Calibration();
  HsfbMeas_DW.Delay_DSTATE = Add1_m0;
  HsfbMeas_DW.Delay_DSTATE_e = Add1_lw;
  HsfbMeas_DW.Delay_DSTATE_k = Add1_bz;
  HsfbMeas_DW.Delay_DSTATE_n = Add1_fm;
  HsfbMeas_DW.Delay_DSTATE_b = Add1_h;
  HsfbMeas_DW.Delay_DSTATE_k4 = Add1_e;
  HsfbMeas_DW.Delay_DSTATE_i = Add1_k;
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 255 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 322 "../40_Appl/HsfbMeas/HsfbMeas.c" 2
...
# 294 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_QM_CODE" ax 8
# 329 "../40_Appl/HsfbMeas/HsfbMeas.c" 2
void HsfbMeas_CallInit(void)
{
  HsfbMeas_GetInitOffset(&HsfbMeas_InitOffset);
  HsfbMeas_InitOffsetCheck();
  if (((s32)(Main_HwVer.App.Meas)) == 1) {
    HsfbMeas_Param.Ipri.Gain = (s16)5338.0F;
    HsfbMeas_Param.Ipri.Offset = (s16)0.0F;
    HsfbMeas_Param.Ipri.Factor = 0.01F;
    HsfbMeas_Param.Vin.Gain = (s16)21111.0F;
    HsfbMeas_Param.Vin.Offset = (s16)0.0F;
    HsfbMeas_Param.Vin.Factor = 0.1F;
    HsfbMeas_Param.Iout.Gain = (s16)12153.0F;
    HsfbMeas_Param.Iout.Offset = (s16)2048.0F;
    HsfbMeas_Param.Iout.Factor = 0.1F;
    HsfbMeas_Param.Vout.Gain = (s16)2558.0F;
    HsfbMeas_Param.Vout.Offset = (s16)0.0F;
    HsfbMeas_Param.Vout.Factor = 0.01F;
    HsfbMeas_Param.VoutDiag.Gain = (s16)5284.0F;
    HsfbMeas_Param.VoutDiag.Offset = (s16)0.0F;
    HsfbMeas_Param.VoutDiag.Factor = 0.01F;
    HsfbMeas_Param.IproFet.Gain = (s16)8264.0F;
    HsfbMeas_Param.IproFet.Offset = (s16)0.0F;
    HsfbMeas_Param.IproFet.Factor = 0.001F;
    HsfbMeas_Param.Vaux.Gain = (s16)15747.0F;
    HsfbMeas_Param.Vaux.Offset = (s16)0.0F;
    HsfbMeas_Param.Vaux.Factor = 0.001F;
    HsfbMeas_Param.Vkl30.Gain = (s16)3240.0F;
    HsfbMeas_Param.Vkl30.Offset = (s16)0.0F;
    HsfbMeas_Param.Vkl30.Factor = 0.01F;
    HsfbMeas_Param.Vkl30C.Gain = (s16)3240.0F;
    HsfbMeas_Param.Vkl30C.Offset = (s16)0.0F;
    HsfbMeas_Param.Vkl30C.Factor = 0.01F;
    HsfbMeas_Param.Vcomp.Gain = (s16)15000.0F;
    HsfbMeas_Param.Vcomp.Offset = (s16)0.0F;
    HsfbMeas_Param.Vcomp.Factor = 0.001F;
    HsfbMeas_Param.VrefDiag.Gain = (s16)5500.0F;
    HsfbMeas_Param.VrefDiag.Offset = (s16)0.0F;
    HsfbMeas_Param.VrefDiag.Factor = 0.001F;
    HsfbMeas_Param.Vhw16V.Gain = (s16)5000.0F;
    HsfbMeas_Param.Vhw16V.Offset = (s16)0.0F;
    HsfbMeas_Param.Vhw16V.Factor = 0.001F;
    HsfbMeas_Param.Vhw19V.Gain = (s16)5000.0F;
    HsfbMeas_Param.Vhw19V.Offset = (s16)0.0F;
    HsfbMeas_Param.Vhw19V.Factor = 0.001F;
  } else {
    HsfbMeas_Param.Ipri.Gain = (s16)5338.0F;
    HsfbMeas_Param.Ipri.Offset = (s16)0.0F;
    HsfbMeas_Param.Ipri.Factor = 0.01F;
    ...
    HsfbMeas_Param.Vaux.Offset = (s16)0.0F;
    HsfbMeas_Param.Vaux.Factor = 0.001F;
    HsfbMeas_Param.Vkl30.Gain = (s16)5500.0F;
    HsfbMeas_Param.Vkl30.Offset = (s16)0.0F;
    HsfbMeas_Param.Vkl30.Factor = 0.01F;
    HsfbMeas_Param.Vkl30C.Gain = (s16)5500.0F;
    HsfbMeas_Param.Vkl30C.Offset = (s16)0.0F;
    HsfbMeas_Param.Vkl30C.Factor = 0.01F;
    HsfbMeas_Param.Vcomp.Gain = (s16)15000.0F;
    HsfbMeas_Param.Vcomp.Offset = (s16)0.0F;
...
# 307 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 417 "../40_Appl/HsfbMeas/HsfbMeas.c" 2
