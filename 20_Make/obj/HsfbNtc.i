...
# 12 "../40_Appl/HsfbNtc/HsfbNtc.h" 2
...
# 11 "../40_Appl/HsfbNtc/HsfbNtc_types.h" 2
...
# 8 "../40_Appl/HsfbNtc/HsfbNtc.c" 2
# 1 "../40_Appl/HsfbNtc/HsfbNtc_private.h" 1
# 12 "../40_Appl/HsfbNtc/HsfbNtc_private.h"
...
# 13 "../40_Appl/HsfbNtc/HsfbNtc_private.h" 2
# 9 "../40_Appl/HsfbNtc/HsfbNtc.c" 2
...
# 11 "../40_Appl/HsfbNtc/HsfbNtc.c" 2
# 21 "../40_Appl/HsfbNtc/HsfbNtc.c"
# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 36 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".bss.MPU_ASIL_VAR_NOINIT" awB 8
# 22 "../40_Appl/HsfbNtc/HsfbNtc.c" 2

static f32 HsfbNtcPT1[6];
static HSFBNTC_S_PARAM HsfbNtc_Param;

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 49 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 27 "../40_Appl/HsfbNtc/HsfbNtc.c" 2


# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 36 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".bss.MPU_ASIL_VAR_NOINIT" awB 8
# 30 "../40_Appl/HsfbNtc/HsfbNtc.c" 2

DW_HsfbNtc_f_T HsfbNtc_DW;

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 49 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 34 "../40_Appl/HsfbNtc/HsfbNtc.c" 2
# 44 "../40_Appl/HsfbNtc/HsfbNtc.c"
# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 45 "../40_Appl/HsfbNtc/HsfbNtc.c" 2
void HsfbNtc_CalcNtcR(const f32 Rser[6], const f32 Rpre[6], const f32 Kpre[6],
                      const f32 Kadc[6], s32 Ohms[6], s32 RtR25[6])
{
  f32 Kden;
  s32 ForEach_itr;
  for (ForEach_itr = 0; ForEach_itr < 6; ForEach_itr++) {
    Kden = 1.0F - ((Kpre[ForEach_itr] + 1.0F) * Kadc[ForEach_itr]);
    if (Kden < 1.0E-6F) {
      Kden = 1.0E-6F;
    }

    Kden = ((Rpre[ForEach_itr] * Kadc[ForEach_itr]) / Kden) - Rser[ForEach_itr];
    if (Kden < 0.0F) {
      Kden = 0.0F;
    }

    RtR25[ForEach_itr] = (s32)((Kden / 10000.0F) * 1.0E+6F);
    Ohms[ForEach_itr] = (s32)Kden;
  }
}
...
#pragma section
# 67 "../40_Appl/HsfbNtc/HsfbNtc.c" 2
...
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 74 "../40_Appl/HsfbNtc/HsfbNtc.c" 2
void HsfbNtc_Call10ms(const HSFBAPP_S_AI *Ai1ms, HSFBNTC_S_STATUS *NtcStatus)
{

  s32 ImpAsg_InsertedFor_RtR25_at_inp[6];
  s32 ImpAsg_InsertedFor_Ohms_at_inpo[6];
  f32 TmpSignalConversionAtCalcNtcRIn[6];
  f32 TmpSignalConversionAtCalcNtcR_j[6];
  f32 TmpSignalConversionAtCalcNtcR_a[6];
  s16 DataTypeConversion1[6];
  f32 Merge[6];
  s32 i;
  f32 TmpSignalConversionAtCalcNtcR_k;
  TmpSignalConversionAtCalcNtcRIn[0] = HsfbNtc_Param.Pri.Rser;
  TmpSignalConversionAtCalcNtcRIn[1] = HsfbNtc_Param.SrA.Rser;
  TmpSignalConversionAtCalcNtcRIn[2] = HsfbNtc_Param.SrB.Rser;
  TmpSignalConversionAtCalcNtcRIn[3] = HsfbNtc_Param.WaterIn.Rser;
  TmpSignalConversionAtCalcNtcRIn[4] = HsfbNtc_Param.WaterOut.Rser;
  TmpSignalConversionAtCalcNtcRIn[5] = HsfbNtc_Param.WaterOutDiag.Rser;
  TmpSignalConversionAtCalcNtcR_j[0] = HsfbNtc_Param.Pri.Rpre;
  TmpSignalConversionAtCalcNtcR_j[1] = HsfbNtc_Param.SrA.Rpre;
  TmpSignalConversionAtCalcNtcR_j[2] = HsfbNtc_Param.SrB.Rpre;
  TmpSignalConversionAtCalcNtcR_j[3] = HsfbNtc_Param.WaterIn.Rpre;
  TmpSignalConversionAtCalcNtcR_j[4] = HsfbNtc_Param.WaterOut.Rpre;
  TmpSignalConversionAtCalcNtcR_j[5] = HsfbNtc_Param.WaterOutDiag.Rpre;
  TmpSignalConversionAtCalcNtcR_a[0] = HsfbNtc_Param.Pri.Kpre;
  TmpSignalConversionAtCalcNtcR_a[1] = HsfbNtc_Param.SrA.Kpre;
  TmpSignalConversionAtCalcNtcR_a[2] = HsfbNtc_Param.SrB.Kpre;
  TmpSignalConversionAtCalcNtcR_a[3] = HsfbNtc_Param.WaterIn.Kpre;
  TmpSignalConversionAtCalcNtcR_a[4] = HsfbNtc_Param.WaterOut.Kpre;
  TmpSignalConversionAtCalcNtcR_a[5] = HsfbNtc_Param.WaterOutDiag.Kpre;
  if (((s32)(Main_HwVer.App.Ntc)) != 0) {
    Merge[0] = ((f32)((s16)((s32)(4095 - ((s32)Ai1ms->NtcPri))))) *
      0.000244140625F;
    Merge[1] = ((f32)((s16)((s32)(4095 - ((s32)Ai1ms->NtcSrA))))) *
      0.000244140625F;
    Merge[2] = ((f32)((s16)((s32)(4095 - ((s32)Ai1ms->NtcSrB))))) *
      0.000244140625F;
    Merge[3] = 0.000244140625F * ((f32)Ai1ms->NtcWaterIn);
    Merge[4] = 0.000244140625F * ((f32)Ai1ms->NtcWaterOut);
    Merge[5] = 0.000244140625F * ((f32)Ai1ms->NtcWaterOutDiag);
  } else {
    Merge[0] = 0.000244140625F * ((f32)Ai1ms->NtcPri);
    Merge[1] = 0.000244140625F * ((f32)Ai1ms->NtcSrA);
    Merge[2] = 0.000244140625F * ((f32)Ai1ms->NtcSrB);
    Merge[3] = 0.000244140625F * ((f32)Ai1ms->NtcWaterIn);
    Merge[4] = 0.000244140625F * ((f32)Ai1ms->NtcWaterOut);
    Merge[5] = 0.000244140625F * ((f32)Ai1ms->NtcWaterOutDiag);
  }

  HsfbNtc_CalcNtcR(TmpSignalConversionAtCalcNtcRIn,
                   TmpSignalConversionAtCalcNtcR_j,
                   TmpSignalConversionAtCalcNtcR_a, Merge,
                   ImpAsg_InsertedFor_Ohms_at_inpo,
                   ImpAsg_InsertedFor_RtR25_at_inp);
  if (((s32)(Main_HwVer.App.Ntc)) != 0) {
    HsfbNtc_DW.Merge_c[0] = look1_is32lfys16ts16Df_hV1slEhI
      (ImpAsg_InsertedFor_RtR25_at_inp[0], (&(HSFBNTC_TABLE_RTR25_MOS_C0[0])), (
        &(HSFBNTC_TABLE_TEMP_MOS_C0[0])), 190U);
    HsfbNtc_DW.Merge_c[1] = look1_is32lfys16ts16Df_hV1slEhI
      (ImpAsg_InsertedFor_RtR25_at_inp[1], (&(HSFBNTC_TABLE_RTR25_MOS_C0[0])), (
        &(HSFBNTC_TABLE_TEMP_MOS_C0[0])), 190U);
    HsfbNtc_DW.Merge_c[2] = look1_is32lfys16ts16Df_hV1slEhI
      (ImpAsg_InsertedFor_RtR25_at_inp[2], (&(HSFBNTC_TABLE_RTR25_MOS_C0[0])), (
        &(HSFBNTC_TABLE_TEMP_MOS_C0[0])), 190U);
    HsfbNtc_DW.Merge_c[3] = look1_is32lfys16ts16Df_hV1slEhI
      (ImpAsg_InsertedFor_RtR25_at_inp[3], (&(HSFBNTC_TABLE_RTR25_WATIN[0])),
       (&(HSFBNTC_TABLE_TEMP_WATIN[0])), 205U);
    HsfbNtc_DW.Merge_c[4] = look1_is32lfys16ts16Df_hV1slEhI
      (ImpAsg_InsertedFor_RtR25_at_inp[4], (&(HSFBNTC_TABLE_RTR25_WATOUT[0])), (
        &(HSFBNTC_TABLE_TEMP_WATOUT[0])), 41U);
    HsfbNtc_DW.Merge_c[5] = look1_is32lfys16ts16Df_hV1slEhI
      (ImpAsg_InsertedFor_RtR25_at_inp[5], (&(HSFBNTC_TABLE_RTR25_WATIN[0])),
       (&(HSFBNTC_TABLE_TEMP_WATIN[0])), 205U);
  } else {
    HsfbNtc_DW.Merge_c[0] = look1_is32lfys16ts16Df_hV1slEhI
      (ImpAsg_InsertedFor_RtR25_at_inp[0], (&(HSFBNTC_TABLE_RTR25_MOS_B02[0])),
       (&(HSFBNTC_TABLE_TEMP_MOS_B02[0])), 41U);
    HsfbNtc_DW.Merge_c[1] = look1_is32lfys16ts16Df_hV1slEhI
      (ImpAsg_InsertedFor_RtR25_at_inp[1], (&(HSFBNTC_TABLE_RTR25_MOS_B02[0])),
       (&(HSFBNTC_TABLE_TEMP_MOS_B02[0])), 41U);
    HsfbNtc_DW.Merge_c[2] = look1_is32lfys16ts16Df_hV1slEhI
      (ImpAsg_InsertedFor_RtR25_at_inp[2], (&(HSFBNTC_TABLE_RTR25_MOS_B02[0])),
       (&(HSFBNTC_TABLE_TEMP_MOS_B02[0])), 41U);
    HsfbNtc_DW.Merge_c[3] = look1_is32lfys16ts16Df_hV1slEhI
      (ImpAsg_InsertedFor_RtR25_at_inp[3], (&(HSFBNTC_TABLE_RTR25_WATIN[0])),
       (&(HSFBNTC_TABLE_TEMP_WATIN[0])), 205U);
  ...
  for (i = 0; i < 6; i++) {
    TmpSignalConversionAtCalcNtcR_k = ((((f32)HsfbNtc_DW.Merge_c[i]) -
      HsfbNtcPT1[(i)]) * 0.2F) + HsfbNtcPT1[(i)];
    DataTypeConversion1[i] = (s16)TmpSignalConversionAtCalcNtcR_k;
    HsfbNtcPT1[(i)] = TmpSignalConversionAtCalcNtcR_k;
  }

  NtcStatus->Pri.Temp = DataTypeConversion1[0];
  NtcStatus->Pri.Rntc = ImpAsg_InsertedFor_Ohms_at_inpo[0];
  NtcStatus->SrA.Temp = DataTypeConversion1[1];
  NtcStatus->SrA.Rntc = ImpAsg_InsertedFor_Ohms_at_inpo[1];
  NtcStatus->SrB.Temp = DataTypeConversion1[2];
  NtcStatus->SrB.Rntc = ImpAsg_InsertedFor_Ohms_at_inpo[2];
  NtcStatus->WaterIn.Temp = DataTypeConversion1[3];
  NtcStatus->WaterIn.Rntc = ImpAsg_InsertedFor_Ohms_at_inpo[3];
  NtcStatus->WaterOut.Temp = DataTypeConversion1[4];
  NtcStatus->WaterOut.Rntc = ImpAsg_InsertedFor_Ohms_at_inpo[4];
  NtcStatus->WaterOutDiag.Temp = DataTypeConversion1[5];
  NtcStatus->WaterOutDiag.Rntc = ImpAsg_InsertedFor_Ohms_at_inpo[5];
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 255 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 190 "../40_Appl/HsfbNtc/HsfbNtc.c" 2
...
# 197 "../40_Appl/HsfbNtc/HsfbNtc.c" 2
void HsfbNtc_CallInit(void)
{
  if (((s32)(Main_HwVer.App.Ntc)) == 0) {
    HsfbNtc_Param.Pri.Rser = 0.0F;
    HsfbNtc_Param.Pri.Rpre = 6810.0F;
    HsfbNtc_Param.Pri.Kpre = 6810.0F / 1.0E+9F;
    HsfbNtc_Param.SrA.Rser = 0.0F;
    HsfbNtc_Param.SrA.Rpre = 6810.0F;
    HsfbNtc_Param.SrA.Kpre = 6810.0F / 1.0E+9F;
    HsfbNtc_Param.SrB.Rser = 0.0F;
    HsfbNtc_Param.SrB.Rpre = 6810.0F;
    HsfbNtc_Param.SrB.Kpre = 6810.0F / 1.0E+9F;
    HsfbNtc_Param.WaterIn.Rser = 0.0F;
    HsfbNtc_Param.WaterIn.Rpre = 10000.0F;
    HsfbNtc_Param.WaterIn.Kpre = 10000.0F / 1.0E+9F;
    HsfbNtc_Param.WaterOut.Rser = 1000.0F;
    HsfbNtc_Param.WaterOut.Rpre = 6190.0F;
    HsfbNtc_Param.WaterOut.Kpre = 6190.0F / 100000.0F;
    HsfbNtc_Param.WaterOutDiag.Rser = 301.0F;
    HsfbNtc_Param.WaterOutDiag.Rpre = 10000.0F;
    HsfbNtc_Param.WaterOutDiag.Kpre = 10000.0F /
      51000.0F;
  } else if (((s32)(Main_HwVer.App.Ntc)) == 1) {
    HsfbNtc_Param.Pri.Rser = 0.0F;
    HsfbNtc_Param.Pri.Rpre = 10000.0F;
    HsfbNtc_Param.Pri.Kpre = 6810.0F / 1.0E+9F;
    HsfbNtc_Param.SrA.Rser = 0.0F;
    HsfbNtc_Param.SrA.Rpre = 10000.0F;
    HsfbNtc_Param.SrA.Kpre = 6810.0F / 1.0E+9F;
    HsfbNtc_Param.SrB.Rser = 0.0F;
    HsfbNtc_Param.SrB.Rpre = 10000.0F;
    HsfbNtc_Param.SrB.Kpre = 6810.0F / 1.0E+9F;
    HsfbNtc_Param.WaterIn.Rser = 0.0F;
    HsfbNtc_Param.WaterIn.Rpre = 10000.0F;
    HsfbNtc_Param.WaterIn.Kpre = 10000.0F / 1.0E+9F;
...
#pragma section
# 263 "../40_Appl/HsfbNtc/HsfbNtc.c" 2
