...
# 12 "../40_Appl/HsfbPwm/HsfbPwm.h" 2
...
# 11 "../40_Appl/HsfbPwm/HsfbPwm_types.h" 2
...
# 12 "../40_Appl/HsfbPwm/HsfbPwm_types.h" 2
...
# 13 "../40_Appl/HsfbPwm/HsfbPwm_types.h" 2
...
# 14 "../40_Appl/HsfbPwm/HsfbPwm_types.h" 2
...
# 8 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
# 1 "../40_Appl/HsfbPwm/HsfbPwm_private.h" 1
# 12 "../40_Appl/HsfbPwm/HsfbPwm_private.h"
...
# 13 "../40_Appl/HsfbPwm/HsfbPwm_private.h" 2
...
# 14 "../40_Appl/HsfbPwm/HsfbPwm_private.h" 2
# 9 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
# 19 "../40_Appl/HsfbPwm/HsfbPwm.c"
# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 36 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".bss.MPU_ASIL_VAR_NOINIT" awB 8
# 20 "../40_Appl/HsfbPwm/HsfbPwm.c" 2

HSFBPWM_S_STATUS HsfbPwm_Status;
HSFBPWM_S_JITTER HsfbPwm_Jitter;
HSFBPWM_S_TOMOR HsfbPwm_ToMor;
HSFBPWM_S_PERIOD HsfbPwm_Period;
HSFBPWM_S_STATECMD HsfbPwm_StateCmd;
f32 HsfbPwm_StartState;
f32 HsfbPwm_ChargeState;
f32 HsfbPwm_DischargeState;
HSFBPWM_E_STATE HsfbPwm_State;

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 49 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 32 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
...
# 36 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".bss.MPU_ASIL_VAR_NOINIT" awB 8
# 37 "../40_Appl/HsfbPwm/HsfbPwm.c" 2

static f32 JitterFrequency;
static f32 JitterStep;

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 49 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 42 "../40_Appl/HsfbPwm/HsfbPwm.c" 2


# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 36 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".bss.MPU_ASIL_VAR_NOINIT" awB 8
# 45 "../40_Appl/HsfbPwm/HsfbPwm.c" 2

DW_HsfbPwm_f_T HsfbPwm_DW;

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 49 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 49 "../40_Appl/HsfbPwm/HsfbPwm.c" 2




static bit HsfbPwm_EventRecharge(const u16 *DataStoreRead1_cr, const u16
  *DataStoreRead2_mi);
...
# 36 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".bss.MPU_ASIL_VAR_NOINIT" awB 8
# 58 "../40_Appl/HsfbPwm/HsfbPwm.c" 2

const HSFBCTRL_S_STATUS15US *HsfbPwm_CtrlStatus15us;
const HSFBMEAS_S_STATUS100US *HsfbPwm_MeasStatus100us;
const HSFBCTRL_S_STATUS100US *HsfbPwm_CtrlStatus100us;
const HSFBSTATE_S_STATUS *HsfbPwm_StateStatus;
const HSFBAPP_S_RX *HsfbPwm_AppRx10ms;
const HSFBSAFETY_S_STATUS100US *HsfbPwm_SafetyStatus100us;
HSFBPWM_S_STATUS15US *HsfbPwm_PwmStatus15us;

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 49 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 68 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
# 76 "../40_Appl/HsfbPwm/HsfbPwm.c"
# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 77 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
void HsfbPwm_GetData100us(void)
{
  HsfbPwm_ToMor.VinFil = HsfbPwm_MeasStatus100us->Vin.Real;
  HsfbPwm_Status.PriEn.Dis = ((HsfbPwm_CtrlStatus100us->CtrlEnDis.PriDis) ||
    (!HsfbPwm_SafetyStatus100us->PriEn));
  HsfbPwm_Status.SrEn.Dis = (((HsfbPwm_CtrlStatus100us->CtrlEnDis.SrDis) ||
    (!HsfbPwm_SafetyStatus100us->SrEn)) || (((s32)HsfbPwm_ToMor.MorphSign) != 0));
  HsfbPwm_Status.ClampEn.Dis = ((HsfbPwm_CtrlStatus100us->CtrlEnDis.ClampDis) ||
    (!HsfbPwm_SafetyStatus100us->ClampEn));
  HsfbPwm_StateCmd.Enable = HsfbPwm_StateStatus->HsfbEn;
  HsfbPwm_ToMor.Enable = HsfbPwm_StateStatus->HsfbEn;
  HsfbPwm_Status.Operation = HsfbPwm_AppRx10ms->Operation;
  HsfbPwm_ToMor.TopologyIn = HsfbPwm_AppRx10ms->Topology;
  HsfbPwm_Jitter.Enable = (((s32)HsfbPwm_AppRx10ms->JitterDis) == 0);
  HsfbPwm_ToMor.AutoSwitchDis = (((s32)HsfbPwm_AppRx10ms->AutoSwitchDis) != 0);
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 255 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 95 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
...
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 102 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
void HsfbPwm_Jitter100us(void)
{
  f32 Delay1_l;
  if (HsfbPwm_Jitter.FreqPeriod > 1000.0F) {
    Delay1_l = 1000.0F;
  } else if (HsfbPwm_Jitter.FreqPeriod < 1.0F) {
    Delay1_l = 1.0F;
  } else {
    Delay1_l = HsfbPwm_Jitter.FreqPeriod;
  }

  Delay1_l = (((0.2F * HsfbPwm_Jitter.FreqRange) * JitterStep) / Delay1_l) +
    JitterFrequency;
  if (Delay1_l > 90.0F) {
    HsfbPwm_Jitter.Freq = 90.0F;
  } else if (Delay1_l < 20.0F) {
    HsfbPwm_Jitter.Freq = 20.0F;
  } else {
    HsfbPwm_Jitter.Freq = Delay1_l;
  }

  HsfbPwm_Jitter.Period = (u16)(100000.0F / HsfbPwm_Jitter.Freq);
  if (HsfbPwm_Jitter.Enable) {
    Delay1_l = HsfbPwm_Jitter.FreqRange;
  } else {
    Delay1_l = 0.0F;
  }

  if (HsfbPwm_Jitter.Freq > (HsfbPwm_Jitter.FreqRate + Delay1_l)) {
    Delay1_l = -1.0F;
  } else if (HsfbPwm_Jitter.Freq < (HsfbPwm_Jitter.FreqRate - Delay1_l)) {
    Delay1_l = 1.0F;
  } else if ((HsfbPwm_DW.Delay1_DSTATE == -1.0F) || (HsfbPwm_DW.Delay1_DSTATE ==
              1.0F)) {
    Delay1_l = HsfbPwm_DW.Delay1_DSTATE;
  } else {
    Delay1_l = 1.0F;
  }
  ...
  if (HsfbPwm_Jitter.Enable) {
    ...
    JitterStep = (HsfbPwm_Jitter.FreqRate - JitterFrequency) * 0.1F;
  }

  JitterFrequency = HsfbPwm_Jitter.Freq;
  HsfbPwm_DW.Delay1_DSTATE = Delay1_l;
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 255 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 152 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
...
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 159 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
void HsfbPwm_MAF_Calc(void)
{
  u16 Switch_c;
  s16 DataTypeConversion3;
  if (((s32)HsfbPwm_DW.free_cnt_delay_DSTATE) >= 10) {
    Switch_c = 0U;
  } else {
    Switch_c = (u16)((u32)(((u32)HsfbPwm_DW.free_cnt_delay_DSTATE) + 1U));
  }

  DataTypeConversion3 = (s16)Switch_c;
  HsfbPwm_DW.Assignment_nw[(s32)DataTypeConversion3] = HsfbPwm_ToMor.VinFil;
  DataTypeConversion3 = (s16)((s32)(((s32)DataTypeConversion3) + 12));
  HsfbPwm_DW.Sum1_c += (HsfbPwm_ToMor.VinFil - HsfbPwm_DW.Assignment_nw[(s32)
                        ((s16)((s32)(((s32)DataTypeConversion3) - ((s32)((s16)
    ((s32)(((s32)((s16)((s32)(((s32)DataTypeConversion3) / 11)))) * 11)))))))]) *
    0.1F;
  HsfbPwm_DW.free_cnt_delay_DSTATE = Switch_c;
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 255 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 180 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
...
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 187 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
void HsfbPwm_ToMor100us(void)
{
  bit RelationalOperator_n;
  s16 DataTypeConversion1;
  f32 Switch1_j0;
  f32 Sum_ky;
  bit LogicalOperator1_c;
  bit Merge_g;
  u16 Switch1_j;
  s16 tmp;
  HsfbPwm_MAF_Calc();
  DataTypeConversion1 = (s16)1000.0F;
  if (HsfbPwm_DW.Sum1_c <= 390.0F) {
    tmp = 1;
  } else {
    tmp = -1;
  }

  Sum_ky = ((f32)tmp) + HsfbPwm_DW.limit_delay_DSTATE;
  if (Sum_ky > ((f32)DataTypeConversion1)) {
    Sum_ky = (f32)DataTypeConversion1;
  } else {
    if (Sum_ky < 0.0F) {
      Sum_ky = 0.0F;
    }
  ...
  Merge_g = ((HsfbPwm_DW.Sum1_c >= 405.0F) ||
             (((HsfbPwm_DW.Sum1_c > 375.0F) && (Sum_ky < ((f32)
    DataTypeConversion1))) && (HsfbPwm_DW.out_delay_DSTATE_i)));
  if (HsfbPwm_Status.Operation != ((u16)0U)) {
    Switch1_j = ((u16)1U);
    RelationalOperator_n = (0U);
  } else {
    if ((((s32)(Main_HwVer.App.Pwm)) != 0) && (!HsfbPwm_ToMor.AutoSwitchDis)) {
      if (Merge_g) {
        Switch1_j = ((u16)1U);
      } else {
        Switch1_j = ((u16)0U);
      ...
      Switch1_j = HsfbPwm_ToMor.TopologyIn;
    }

    RelationalOperator_n = ((((s32)(Main_HwVer.App.Pwm)) != 0) &&
      (HsfbPwm_ToMor.Enable));
  }

  LogicalOperator1_c = !HsfbPwm_DW.state_delay_DSTATE;
  if (LogicalOperator1_c && (HsfbPwm_DW.transfer_delay2_DSTATE)) {
    HsfbPwm_DW.In_o = Switch1_j;
  }

  if (LogicalOperator1_c) {
    HsfbPwm_DW.In_b = HsfbPwm_DW.transfer_delay_DSTATE;
    HsfbPwm_DW.In_n = RelationalOperator_n;
  }

  if ((HsfbPwm_DW.In_b != HsfbPwm_DW.In_o) && (HsfbPwm_DW.In_n)) {
    Switch1_j0 = 0.033F + HsfbPwm_DW.Memory_PreviousInput;
  } else {
    Switch1_j0 = 0.0F;
  }
  ...
  if (Switch1_j0 < 1.0F) {
    if (HsfbPwm_DW.In_b == ((u16)0U)) {
      HsfbPwm_DW.In = Switch1_j0;
    } else {
      HsfbPwm_DW.In = (-Switch1_j0) + 1.0F;
    }
  }

  HsfbPwm_ToMor.TopologyOut = HsfbPwm_DW.In_b;
  HsfbPwm_ToMor.MorphSign = (u16)HsfbPwm_DW.state_delay_DSTATE;
  HsfbPwm_ToMor.MorphState = Switch1_j0;
  HsfbPwm_ToMor.TopoState = HsfbPwm_DW.In;
  HsfbPwm_DW.limit_delay_DSTATE = Sum_ky;
  HsfbPwm_DW.out_delay_DSTATE_i = Merge_g;
  HsfbPwm_DW.state_delay_DSTATE = ((Switch1_j0 != 0.0F) && (Switch1_j0 < 1.0F));
  HsfbPwm_DW.transfer_delay2_DSTATE = LogicalOperator1_c;
  HsfbPwm_DW.transfer_delay_DSTATE = HsfbPwm_DW.In_o;
  HsfbPwm_DW.Memory_PreviousInput = Switch1_j0;
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 255 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 280 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
...
# 287 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
void HsfbPwm_GetData15us(void)
{
  f32 Sum1_e;
  HsfbPwm_Status.BuckDuty.Duty = HsfbPwm_CtrlStatus15us->BuckDuty;
  HsfbPwm_Status.BoostDuty.Duty = HsfbPwm_CtrlStatus15us->BoostDuty;
  Sum1_e = ((HsfbPwm_CtrlStatus15us->BuckDuty - HsfbPwm_DW.y_delay_DSTATE) *
            0.0001F) + HsfbPwm_DW.y_delay_DSTATE;
  HsfbPwm_Status.BuckDutyFil = Sum1_e;
  HsfbPwm_Status.Vout100us = HsfbPwm_MeasStatus100us->Vout.Real;
  HsfbPwm_Status.IpriPwmGain = (2.0F - HsfbPwm_ToMor.TopoState) *
    HsfbPwm_Status.BuckDutyFil;
  HsfbPwm_DW.y_delay_DSTATE = Sum1_e;
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 281 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 302 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
...
# 268 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".code_ram" ax 8
# 309 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
void HsfbPwm_SetData15us(void)
{
  HsfbPwm_PwmStatus15us->PwmState = HsfbPwm_State;
  HsfbPwm_PwmStatus15us->Topology = HsfbPwm_ToMor.TopologyOut;
  HsfbPwm_PwmStatus15us->TopoState = HsfbPwm_ToMor.TopoState;
  HsfbPwm_PwmStatus15us->IpriPwmGain = HsfbPwm_Status.IpriPwmGain;
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 281 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 318 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
...
# 268 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".code_ram" ax 8
# 325 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
void HsfbPwm_EnDis15us(void)
{
  bit LogicalOperator_fj;
  LogicalOperator_fj = ((HsfbPwm_Status.SrEn.En) && (!HsfbPwm_Status.SrEn.Dis));
  HsfbPwm_Status.SrEn.Out = LogicalOperator_fj;
  Pwm_PwmEn[1] = LogicalOperator_fj;;
  LogicalOperator_fj = ((HsfbPwm_Status.PriEn.En) && (!HsfbPwm_Status.PriEn.Dis));
  HsfbPwm_Status.PriEn.Out = LogicalOperator_fj;
  Pwm_PwmEn[0] = LogicalOperator_fj;;
  LogicalOperator_fj = ((HsfbPwm_Status.ClampEn.En) &&
                        (!HsfbPwm_Status.ClampEn.Dis));
  HsfbPwm_Status.ClampEn.Out = LogicalOperator_fj;
  Pwm_PwmEn[2] = LogicalOperator_fj;;
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 281 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 341 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
...
# 268 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".code_ram" ax 8
# 348 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
static bit HsfbPwm_EventRecharge(const u16 *DataStoreRead1_cr, const u16
  *DataStoreRead2_mi)
{
  bit y;
  if ((((*DataStoreRead1_cr) == ((u16)0U)) &&
       ((*DataStoreRead2_mi) == ((u16)1U))) &&
      (HsfbPwm_Status.BuckDuty.Duty < HsfbPwm_Status.BuckDuty.Min)) {
    if (((f32)HsfbPwm_DW.RechargeCnt) > 65000.0F) {
      y = (1U);
      HsfbPwm_DW.RechargeCnt = 0U;
    } else {
      HsfbPwm_DW.RechargeCnt++;
      y = (0U);
    }
  } else {
    HsfbPwm_DW.RechargeCnt = 0U;
...
# 281 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 371 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
...
# 378 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
void HsfbPwm_State15us_Init(void)
{
  HsfbPwm_DW.HsfbPwm_State_o = HSFBPWM_E_STATE_None;
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 307 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 384 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
...
# 268 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".code_ram" ax 8
# 391 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
void HsfbPwm_State15us(void)
{
  u16 DataStoreRead1_cr;
  u16 DataStoreRead2_mi;
  HsfbPwm_Period.Prd = HsfbPwm_Jitter.Period;
  HsfbPwm_Period.HPrd = (u16)((s32)((u32)(((u32)HsfbPwm_Period.Prd) >> 1)));
  HsfbPwm_Period.MPrd = (u16)((u32)(((u32)HsfbPwm_Period.Prd) + ((u32)((u16)
    1U))));
  if (HsfbPwm_Status.BuckDuty.Duty > HsfbPwm_Status.BuckDuty.Max) {
    HsfbPwm_Status.BuckDuty.Duty = HsfbPwm_Status.BuckDuty.Max;
  }

  if (HsfbPwm_Status.BoostDuty.Duty > HsfbPwm_Status.BoostDuty.Max) {
    HsfbPwm_Status.BoostDuty.Duty = HsfbPwm_Status.BoostDuty.Max;
  }

  HsfbPwm_Sync();
  DataStoreRead1_cr = HsfbPwm_Status.Operation;
  DataStoreRead2_mi = HsfbPwm_ToMor.TopologyOut;
  if (((u32)HsfbPwm_DW.is_active_c9_HsfbPwm) == 0U) {
    HsfbPwm_DW.is_active_c9_HsfbPwm = 1U;
    HsfbPwm_DW.HsfbPwm_State_o = HSFBPWM_E_STATE_Reset;
  } else {
    switch (HsfbPwm_DW.HsfbPwm_State_o) {
     case HSFBPWM_E_STATE_Reset:
      if (HsfbPwm_StateCmd.Enable) {
        HsfbPwm_Reset();
        HsfbPwm_StartState = 0.0F;
        HsfbPwm_ChargeState = 0.0F;
        HsfbPwm_DischargeState = 0.0F;
        HsfbPwm_DW.HsfbPwm_State_o = HSFBPWM_E_STATE_Discharge;
      } else {
        HsfbPwm_Reset();
        HsfbPwm_StartState = 0.0F;
        HsfbPwm_ChargeState = 0.0F;
     ...
     case HSFBPWM_E_STATE_Discharge:
      if (HsfbPwm_DischargeState >= (1.0F - 0.00076923F)) {
        if ((HsfbPwm_Status.Operation == ((u16)0U)) &&
            (HsfbPwm_ToMor.TopologyOut == ((u16)1U))) {
          HsfbPwm_Discharge();
          HsfbPwm_DischargeState += 0.00076923F;
          HsfbPwm_DW.HsfbPwm_State_o = HSFBPWM_E_STATE_Charge;
        } else {
          HsfbPwm_Discharge();
          HsfbPwm_DischargeState += 0.00076923F;
          HsfbPwm_DW.HsfbPwm_State_o = HSFBPWM_E_STATE_SteadyRun;
        }
      } else {
        HsfbPwm_Discharge();
        HsfbPwm_DischargeState += 0.00076923F;
     ...
     case HSFBPWM_E_STATE_Charge:
      if (HsfbPwm_ChargeState >= (1.0F - 0.00076923F)) {
        HsfbPwm_Charge();
        HsfbPwm_ChargeState += 0.00076923F;
        HsfbPwm_DW.HsfbPwm_State_o = HSFBPWM_E_STATE_SteadyRun;
      } else {
        HsfbPwm_Charge();
        HsfbPwm_ChargeState += 0.00076923F;
     ...
     default:
      ...
      if (!HsfbPwm_StateCmd.Enable) {
        ...
        HsfbPwm_DischargeState = 0.0F;
        HsfbPwm_DW.HsfbPwm_State_o = HSFBPWM_E_STATE_Reset;
      } else if (HsfbPwm_EventRecharge(&DataStoreRead1_cr, &DataStoreRead2_mi))
      {
        HsfbPwm_SteadyRun();
        HsfbPwm_ChargeState = 0.0F;
        HsfbPwm_DischargeState = 0.0F;
  ...
  HsfbPwm_State = HsfbPwm_DW.HsfbPwm_State_o;
  HsfbPwm_Status.PriEn.En = (HsfbPwm_State != HSFBPWM_E_STATE_Reset);
  HsfbPwm_Status.SrEn.En = HsfbPwm_Status.PriEn.En;
  HsfbPwm_Status.ClampEn.En = HsfbPwm_Status.PriEn.En;
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 281 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 488 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
...
# 294 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_QM_CODE" ax 8
# 495 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
void HsfbPwm_Init(void)
{
...
# 307 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 501 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
...
# 268 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".code_ram" ax 8
# 508 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
void HsfbPwm_Call100us(const HSFBMEAS_S_STATUS100US *MeasStatus100us, const
  HSFBCTRL_S_STATUS100US *CtrlStatus100us, const HSFBSTATE_S_STATUS *StateStatus,
  const HSFBAPP_S_RX *AppRx10ms, const HSFBSAFETY_S_STATUS100US
  *SafetyStatus100us)
{
  HsfbPwm_MeasStatus100us = MeasStatus100us;
  HsfbPwm_CtrlStatus100us = CtrlStatus100us;
  HsfbPwm_StateStatus = StateStatus;
  HsfbPwm_AppRx10ms = AppRx10ms;
  HsfbPwm_SafetyStatus100us = SafetyStatus100us;
...
# 281 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 524 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
...
# 268 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".code_ram" ax 8
# 531 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
void HsfbPwm_Call15us(const HSFBCTRL_S_STATUS15US *CtrlStatus15us, const
                      HSFBMEAS_S_STATUS100US *MeasStatus100us,
                      HSFBPWM_S_STATUS15US *PwmStatus15us)
{
  HsfbPwm_CtrlStatus15us = CtrlStatus15us;
  HsfbPwm_MeasStatus100us = MeasStatus100us;
  HsfbPwm_PwmStatus15us = PwmStatus15us;
  HsfbPwm_GetData15us();
  HsfbPwm_State15us();
  HsfbPwm_EnDis15us();
  HsfbPwm_SetData15us();
...
# 281 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 545 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
...
# 294 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_QM_CODE" ax 8
# 552 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
void HsfbPwm_CallInit(void)
{
  u16 HsfbPwm_Jitter_tmp;
  HsfbPwm_Jitter_tmp = (u16)(100000.0F / 65.0F);
  HsfbPwm_Jitter.Period = HsfbPwm_Jitter_tmp;
  HsfbPwm_Jitter.FreqRange = 3.0F;
  HsfbPwm_Jitter.FreqRate = 65.0F;
  HsfbPwm_Jitter.FreqPeriod = 2.5F;
  HsfbPwm_Period.Prd = HsfbPwm_Jitter_tmp;
  HsfbPwm_Period.HPrd = (u16)((100000.0F / 65.0F) * 0.5F);
  HsfbPwm_Period.MPrd = (u16)((100000.0F / 65.0F) + ((f32)((u16)
    1U)));
  HsfbPwm_Status.BuckDuty.Duty = 0.0F;
  HsfbPwm_Status.BuckDuty.Max = 0.48F;
  HsfbPwm_Status.BuckDuty.Min = 0.02F;
  HsfbPwm_Status.BoostDuty.Duty = 0.0F;
  HsfbPwm_Status.BoostDuty.Max = 0.96F;
  HsfbPwm_Status.BoostDuty.Min = 0.04F;
  JitterFrequency = 65.0F;
  JitterStep = 1.0F;
}
...
# 307 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 575 "../40_Appl/HsfbPwm/HsfbPwm.c" 2
