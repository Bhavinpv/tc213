# 1 "../40_Appl/HsfbPwm/HsfbPwm_driver.c"
...
# 11 "../40_Appl/HsfbPwm/HsfbPwm_driver.h"
...
# 12 "../40_Appl/HsfbPwm/HsfbPwm_driver.h" 2
...
# 16 "../40_Appl/HsfbPwm/HsfbPwm_driver.h" 2
...
# 8 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2


# 1 "../40_Appl/HsfbPwm/HsfbPwm.h" 1
# 23 "../40_Appl/HsfbPwm/HsfbPwm.h"
...
# 11 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2
...
# 12 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2
# 23 "../40_Appl/HsfbPwm/HsfbPwm_driver.c"
# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 36 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".bss.MPU_ASIL_VAR_NOINIT" awB 8
# 24 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2

extern const HSFBCTRL_S_STATUS15US *HsfbPwm_CtrlStatus15us;
extern const HSFBMEAS_S_STATUS100US *HsfbPwm_MeasStatus100us;
extern const HSFBCTRL_S_STATUS100US *HsfbPwm_CtrlStatus100us;
extern const HSFBSTATE_S_STATUS *HsfbPwm_StateStatus;
extern const HSFBAPP_S_RX *HsfbPwm_AppRx10ms;
extern const HSFBSAFETY_S_STATUS100US *HsfbPwm_SafetyStatus100us;
extern HSFBPWM_S_STATUS15US *HsfbPwm_PwmStatus15us;

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 49 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 34 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2


static void HsfbPwm_enter_internal_Pri(void);
static void HsfbPwm_enter_internal_Sr(void);
static void HsfbPwm_enter_internal_Clamp(void);
static void HsfbPwm_enter_internal_Saux(void);
static void HsfbPwm_enter_internal_Run(void);
# 49 "../40_Appl/HsfbPwm/HsfbPwm_driver.c"
# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 268 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".code_ram" ax 8
# 50 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2
void HsfbPwm_Sync(void)
{
  HsfbPwm_Status.DriverSR0[8] = HsfbPwm_Period.Prd;
  (*(PwmSr0Pt[8])) = HsfbPwm_Status.DriverSR0[8];;
  HsfbPwm_Status.DriverSR1[8] = (u16)(((f32)HsfbPwm_Period.Prd) +
    -5.0F);
  (*(PwmSr1Pt[8])) = HsfbPwm_Status.DriverSR1[8];;
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 281 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 60 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2
...
# 268 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".code_ram" ax 8
# 67 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2
void HsfbPwm_Discharge(void)
{
  f32 Add1_jj;
  u16 tmp;
  u16 tmp_0;
  Add1_jj = ((1.0F - HsfbPwm_DischargeState) * 0.005F) +
    (0.5F * HsfbPwm_DischargeState);
  HsfbPwm_Period.DPrd = (u16)(((f32)HsfbPwm_Period.Prd) * Add1_jj);
  HsfbPwm_Period.DHPrd = (u16)(Add1_jj * ((f32)HsfbPwm_Period.HPrd));
  HsfbPwm_Status.DriverSR0[0] = HsfbPwm_Period.MPrd;
  (*(PwmSr0Pt[0])) = HsfbPwm_Status.DriverSR0[0];;
  HsfbPwm_Status.DriverSR1[0] = 0U;
  (*(PwmSr1Pt[0])) = HsfbPwm_Status.DriverSR1[0];;
  tmp = (u16)((s32)(((s32)HsfbPwm_Period.HPrd) - ((s32)HsfbPwm_Period.DHPrd)));
  HsfbPwm_Status.DriverSR0[1] = tmp;
  (*(PwmSr0Pt[1])) = HsfbPwm_Status.DriverSR0[1];;
  tmp_0 = (u16)((u32)(((u32)HsfbPwm_Period.HPrd) + ((u32)HsfbPwm_Period.DHPrd)));
  HsfbPwm_Status.DriverSR1[1] = tmp_0;
  (*(PwmSr1Pt[1])) = HsfbPwm_Status.DriverSR1[1];;
  HsfbPwm_Status.DriverSR0[2] = HsfbPwm_Period.MPrd;
  (*(PwmSr0Pt[2])) = HsfbPwm_Status.DriverSR0[2];;
  HsfbPwm_Status.DriverSR1[2] = 0U;
  (*(PwmSr1Pt[2])) = HsfbPwm_Status.DriverSR1[2];;
  HsfbPwm_Status.DriverSR0[3] = HsfbPwm_Period.MPrd;
  (*(PwmSr0Pt[3])) = HsfbPwm_Status.DriverSR0[3];;
  HsfbPwm_Status.DriverSR1[3] = 0U;
  (*(PwmSr1Pt[3])) = HsfbPwm_Status.DriverSR1[3];;
  HsfbPwm_Status.DriverSR0[4] = HsfbPwm_Period.MPrd;
  (*(PwmSr0Pt[4])) = HsfbPwm_Status.DriverSR0[4];;
  HsfbPwm_Status.DriverSR1[4] = 0U;
  (*(PwmSr1Pt[4])) = HsfbPwm_Status.DriverSR1[4];;
  HsfbPwm_Status.DriverSR0[5] = HsfbPwm_Period.MPrd;
  (*(PwmSr0Pt[5])) = HsfbPwm_Status.DriverSR0[5];;
  HsfbPwm_Status.DriverSR1[5] = 0U;
  (*(PwmSr1Pt[5])) = HsfbPwm_Status.DriverSR1[5];;
  HsfbPwm_Status.DriverSR0[6] = tmp;
  (*(PwmSr0Pt[6])) = HsfbPwm_Status.DriverSR0[6];;
  HsfbPwm_Status.DriverSR1[6] = tmp_0;
  (*(PwmSr1Pt[6])) = HsfbPwm_Status.DriverSR1[6];;
  HsfbPwm_Status.DriverSR0[7] = (u16)((s32)(((s32)HsfbPwm_Period.Prd) - ((s32)
    HsfbPwm_Period.DHPrd)));
  (*(PwmSr0Pt[7])) = HsfbPwm_Status.DriverSR0[7];;
  HsfbPwm_Status.DriverSR1[7] = HsfbPwm_Period.DHPrd;
  (*(PwmSr1Pt[7])) = HsfbPwm_Status.DriverSR1[7];;
  HsfbPwm_Status.DriverSR0[9] = HsfbPwm_Period.MPrd;
  (*(PwmSr0Pt[9])) = HsfbPwm_Status.DriverSR0[9];;
  HsfbPwm_Status.DriverSR1[9] = 0U;
  (*(PwmSr1Pt[9])) = HsfbPwm_Status.DriverSR1[9];;
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 281 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 118 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2
...
# 268 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".code_ram" ax 8
# 125 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2
void HsfbPwm_Reset(void)
{
  HsfbPwm_Status.DriverSR0[0] = HsfbPwm_Period.MPrd;
  (*(PwmSr0Pt[0])) = HsfbPwm_Status.DriverSR0[0];;
  HsfbPwm_Status.DriverSR1[0] = 0U;
  (*(PwmSr1Pt[0])) = HsfbPwm_Status.DriverSR1[0];;
  HsfbPwm_Status.DriverSR0[1] = HsfbPwm_Period.MPrd;
  (*(PwmSr0Pt[1])) = HsfbPwm_Status.DriverSR0[1];;
  HsfbPwm_Status.DriverSR1[1] = 0U;
  (*(PwmSr1Pt[1])) = HsfbPwm_Status.DriverSR1[1];;
  HsfbPwm_Status.DriverSR0[2] = HsfbPwm_Period.MPrd;
  (*(PwmSr0Pt[2])) = HsfbPwm_Status.DriverSR0[2];;
  HsfbPwm_Status.DriverSR1[2] = 0U;
  ...
  HsfbPwm_Status.DriverSR1[5] = 0U;
  (*(PwmSr1Pt[5])) = HsfbPwm_Status.DriverSR1[5];;
  HsfbPwm_Status.DriverSR0[6] = HsfbPwm_Period.MPrd;
  (*(PwmSr0Pt[6])) = HsfbPwm_Status.DriverSR0[6];;
  HsfbPwm_Status.DriverSR1[6] = 0U;
  (*(PwmSr1Pt[6])) = HsfbPwm_Status.DriverSR1[6];;
  HsfbPwm_Status.DriverSR0[7] = HsfbPwm_Period.MPrd;
  (*(PwmSr0Pt[7])) = HsfbPwm_Status.DriverSR0[7];;
  HsfbPwm_Status.DriverSR1[7] = 0U;
  (*(PwmSr1Pt[7])) = HsfbPwm_Status.DriverSR1[7];;
  HsfbPwm_Status.DriverSR0[9] = HsfbPwm_Period.MPrd;
  (*(PwmSr0Pt[9])) = HsfbPwm_Status.DriverSR0[9];;
  HsfbPwm_Status.DriverSR1[9] = 0U;
...
# 281 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 166 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2
...
# 268 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".code_ram" ax 8
# 173 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2
void HsfbPwm_Charge(void)
{
  f32 Bias1_o;
  HsfbPwm_Period.DPrd = (u16)(((f32)HsfbPwm_Period.Prd) * 0.005F);
  HsfbPwm_Period.DHPrd = (u16)(((f32)HsfbPwm_Period.HPrd) * 0.005F);
  HsfbPwm_Status.DriverSR0[0] = (u16)((s32)(((s32)HsfbPwm_Period.Prd) - ((s32)
    HsfbPwm_Period.DHPrd)));
  (*(PwmSr0Pt[0])) = HsfbPwm_Status.DriverSR0[0];;
  HsfbPwm_Status.DriverSR1[0] = HsfbPwm_Period.DHPrd;
  (*(PwmSr1Pt[0])) = HsfbPwm_Status.DriverSR1[0];;
  HsfbPwm_Status.DriverSR0[1] = (u16)((s32)(((s32)HsfbPwm_Period.HPrd) - ((s32)
    HsfbPwm_Period.DHPrd)));
  (*(PwmSr0Pt[1])) = HsfbPwm_Status.DriverSR0[1];;
  HsfbPwm_Status.DriverSR1[1] = (u16)((u32)(((u32)HsfbPwm_Period.HPrd) + ((u32)
    HsfbPwm_Period.DHPrd)));
  (*(PwmSr1Pt[1])) = HsfbPwm_Status.DriverSR1[1];;
  HsfbPwm_Status.DriverSR0[2] = HsfbPwm_Period.MPrd;
  (*(PwmSr0Pt[2])) = HsfbPwm_Status.DriverSR0[2];;
  HsfbPwm_Status.DriverSR1[2] = 0U;
  (*(PwmSr1Pt[2])) = HsfbPwm_Status.DriverSR1[2];;
  HsfbPwm_Status.DriverSR0[3] = 0U;
  (*(PwmSr0Pt[3])) = HsfbPwm_Status.DriverSR0[3];;
  HsfbPwm_Status.DriverSR1[3] = HsfbPwm_Period.MPrd;
  (*(PwmSr1Pt[3])) = HsfbPwm_Status.DriverSR1[3];;
  HsfbPwm_Status.DriverSR0[4] = (u16)(((f32)HsfbPwm_Status.DriverSR0[1]) +
    -5.0F);
  (*(PwmSr0Pt[4])) = HsfbPwm_Status.DriverSR0[4];;
  HsfbPwm_Status.DriverSR1[4] = (u16)(((f32)HsfbPwm_Status.DriverSR1[1]) +
    5.0F);
  (*(PwmSr1Pt[4])) = HsfbPwm_Status.DriverSR1[4];;
  HsfbPwm_Status.DriverSR0[5] = (u16)(((f32)HsfbPwm_Status.DriverSR0[0]) +
    -5.0F);
  (*(PwmSr0Pt[5])) = HsfbPwm_Status.DriverSR0[5];;
  HsfbPwm_Status.DriverSR1[5] = (u16)(((f32)HsfbPwm_Status.DriverSR1[0]) +
    5.0F);
  (*(PwmSr1Pt[5])) = HsfbPwm_Status.DriverSR1[5];;
  Bias1_o = ((f32)HsfbPwm_Status.DriverSR1[1]) + 10.0F;
  HsfbPwm_Status.DriverSR0[6] = (u16)Bias1_o;
  (*(PwmSr0Pt[6])) = HsfbPwm_Status.DriverSR0[6];;
  Bias1_o += 200.0F;
  HsfbPwm_Status.DriverSR1[6] = (u16)Bias1_o;
  (*(PwmSr1Pt[6])) = HsfbPwm_Status.DriverSR1[6];;
  Bias1_o = ((f32)HsfbPwm_Status.DriverSR1[0]) + 10.0F;
  HsfbPwm_Status.DriverSR0[7] = (u16)Bias1_o;
  (*(PwmSr0Pt[7])) = HsfbPwm_Status.DriverSR0[7];;
  Bias1_o += 200.0F;
  HsfbPwm_Status.DriverSR1[7] = (u16)Bias1_o;
  (*(PwmSr1Pt[7])) = HsfbPwm_Status.DriverSR1[7];;
  HsfbPwm_Status.DriverSR0[9] = HsfbPwm_Period.MPrd;
  (*(PwmSr0Pt[9])) = HsfbPwm_Status.DriverSR0[9];;
  HsfbPwm_Status.DriverSR1[9] = 0U;
...
# 281 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 228 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2
...
# 268 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".code_ram" ax 8
# 235 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2
static void HsfbPwm_enter_internal_Pri(void)
{
  f32 Switch1_k;
  f32 Product_em;
  bit guard1 = (0U);
  guard1 = (0U);
  if (HsfbPwm_DW.oper_buck) {
    if (HsfbPwm_DW.dmin_buck) {
      HsfbPwm_Status.DriverSR0[0] = HsfbPwm_Period.MPrd;
      (*(PwmSr0Pt[0])) = HsfbPwm_Status.DriverSR0[0];;
      HsfbPwm_Status.DriverSR1[0] = 0U;
      (*(PwmSr1Pt[0])) = HsfbPwm_Status.DriverSR1[0];;
      ...
      HsfbPwm_Status.DriverSR1[3] = 0U;
      (*(PwmSr1Pt[3])) = HsfbPwm_Status.DriverSR1[3];;
    } else if (HsfbPwm_DW.topo_fb) {
      HsfbPwm_Status.DriverSR0[0] = (u16)((s32)(((s32)HsfbPwm_Period.Prd) -
        ((s32)HsfbPwm_Period.DHPrd)));
      (*(PwmSr0Pt[0])) = HsfbPwm_Status.DriverSR0[0];;
      HsfbPwm_Status.DriverSR1[0] = HsfbPwm_Period.DHPrd;
      (*(PwmSr1Pt[0])) = HsfbPwm_Status.DriverSR1[0];;
      HsfbPwm_Status.DriverSR0[1] = (u16)((s32)(((s32)HsfbPwm_Period.HPrd) -
        ((s32)HsfbPwm_Period.DHPrd)));
      (*(PwmSr0Pt[1])) = HsfbPwm_Status.DriverSR0[1];;
      HsfbPwm_Status.DriverSR1[1] = (u16)((u32)(((u32)HsfbPwm_Period.HPrd) +
        ((u32)HsfbPwm_Period.DHPrd)));
      (*(PwmSr1Pt[1])) = HsfbPwm_Status.DriverSR1[1];;
      Product_em = ((1.0F - HsfbPwm_ToMor.TopoState) / (HsfbPwm_ToMor.TopoState
        + 1.0F)) * ((f32)HsfbPwm_Period.DHPrd);
      if (((s32)HsfbPwm_ToMor.MorphSign) > 0) {
        Switch1_k = (((f32)HsfbPwm_Period.HPrd) - Product_em) + -1.0F;
      } else {
        Switch1_k = (f32)HsfbPwm_Status.DriverSR0[1];
      }

      HsfbPwm_Status.DriverSR0[2] = (u16)Switch1_k;
      (*(PwmSr0Pt[2])) = HsfbPwm_Status.DriverSR0[2];;
      if (((s32)HsfbPwm_ToMor.MorphSign) > 0) {
        Switch1_k = ((f32)HsfbPwm_Period.HPrd) + Product_em;
      } else {
        Switch1_k = (f32)HsfbPwm_Status.DriverSR1[1];
      }

      HsfbPwm_Status.DriverSR1[2] = (u16)Switch1_k;
      (*(PwmSr1Pt[2])) = HsfbPwm_Status.DriverSR1[2];;
      if (((s32)HsfbPwm_ToMor.MorphSign) > 0) {
        Switch1_k = ((f32)HsfbPwm_Status.DriverSR1[2]) + 10.0F;
      } else {
        Switch1_k = (f32)HsfbPwm_Status.DriverSR0[0];
      }

      HsfbPwm_Status.DriverSR0[3] = (u16)Switch1_k;
      (*(PwmSr0Pt[3])) = HsfbPwm_Status.DriverSR0[3];;
      if (((s32)HsfbPwm_ToMor.MorphSign) > 0) {
        Switch1_k = ((f32)HsfbPwm_Status.DriverSR0[2]) + -10.0F;
      } else {
        Switch1_k = (f32)HsfbPwm_Status.DriverSR1[0];
      }

      HsfbPwm_Status.DriverSR1[3] = (u16)Switch1_k;
      (*(PwmSr1Pt[3])) = HsfbPwm_Status.DriverSR1[3];;
    } else if (HsfbPwm_DW.topo_hb) {
      HsfbPwm_Status.DriverSR0[0] = (u16)((s32)(((s32)HsfbPwm_Period.Prd) -
        ((s32)HsfbPwm_Period.DHPrd)));
      (*(PwmSr0Pt[0])) = HsfbPwm_Status.DriverSR0[0];;
      HsfbPwm_Status.DriverSR1[0] = HsfbPwm_Period.DHPrd;
      ...
      if (((s32)HsfbPwm_ToMor.MorphSign) > 0) {
        ...
        Switch1_k = (f32)HsfbPwm_Period.MPrd;
      }

      HsfbPwm_Status.DriverSR0[2] = (u16)Switch1_k;
      (*(PwmSr0Pt[2])) = HsfbPwm_Status.DriverSR0[2];;
      if (((s32)HsfbPwm_ToMor.MorphSign) > 0) {
        HsfbPwm_Status.DriverSR1[2] = (u16)(((f32)HsfbPwm_Period.HPrd) +
          Product_em);
      } else {
        HsfbPwm_Status.DriverSR1[2] = 0U;
      }
      ...
      (*(PwmSr1Pt[2])) = HsfbPwm_Status.DriverSR1[2];;
      if (((s32)HsfbPwm_ToMor.MorphSign) > 0) {
        Switch1_k = (f32)HsfbPwm_Status.DriverSR1[2];
      } else {
        Switch1_k = 0.0F;
      }
  ...
  if (guard1) {
    if (HsfbPwm_DW.oper_boost) {
      if (HsfbPwm_DW.topo_fb) {
        HsfbPwm_Status.DriverSR0[0] = HsfbPwm_Period.MPrd;
        (*(PwmSr0Pt[0])) = HsfbPwm_Status.DriverSR0[0];;
        HsfbPwm_Status.DriverSR1[0] = 0U;
        (*(PwmSr1Pt[0])) = HsfbPwm_Status.DriverSR1[0];;
...
# 281 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 402 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2
...
# 268 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".code_ram" ax 8
# 409 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2
static void HsfbPwm_enter_internal_Sr(void)
{
  if (HsfbPwm_DW.oper_buck) {
    if (HsfbPwm_DW.dmin_buck) {
      ...
      HsfbPwm_Status.DriverSR0[4] = (u16)(((((f32)HsfbPwm_Period.Prd) +
        -15.0F) * (1.0F - HsfbPwm_StartState)) + ((((f32)
        HsfbPwm_Status.DriverSR1[1]) + 15.0F) *
        HsfbPwm_StartState));
      (*(PwmSr0Pt[4])) = HsfbPwm_Status.DriverSR0[4];;
      HsfbPwm_Status.DriverSR1[4] = (u16)(((1.0F - HsfbPwm_StartState) *
        15.0F) + ((((f32)HsfbPwm_Status.DriverSR0[1]) +
        -20.0F) * HsfbPwm_StartState));
      (*(PwmSr1Pt[4])) = HsfbPwm_Status.DriverSR1[4];;
      HsfbPwm_Status.DriverSR0[5] = (u16)(((((f32)HsfbPwm_Period.HPrd) +
        -15.0F) * (1.0F - HsfbPwm_StartState)) + ((((f32)
        HsfbPwm_Status.DriverSR1[0]) + 15.0F) *
        HsfbPwm_StartState));
      (*(PwmSr0Pt[5])) = HsfbPwm_Status.DriverSR0[5];;
      HsfbPwm_Status.DriverSR1[5] = (u16)(((((f32)HsfbPwm_Period.HPrd) +
        15.0F) * (1.0F - HsfbPwm_StartState)) + ((((f32)
        HsfbPwm_Status.DriverSR0[0]) + -20.0F) *
        HsfbPwm_StartState));
      (*(PwmSr1Pt[5])) = HsfbPwm_Status.DriverSR1[5];;
    }
  } else {
    if (HsfbPwm_DW.oper_boost) {
      if (HsfbPwm_DW.dmin_boost) {
        HsfbPwm_Status.DriverSR0[4] = HsfbPwm_Period.MPrd;
        (*(PwmSr0Pt[4])) = HsfbPwm_Status.DriverSR0[4];;
        HsfbPwm_Status.DriverSR1[4] = 0U;
        (*(PwmSr1Pt[4])) = HsfbPwm_Status.DriverSR1[4];;
        ...
        HsfbPwm_Status.DriverSR0[4] = (u16)((s32)(((s32)HsfbPwm_Period.HPrd) -
          ((s32)HsfbPwm_Period.DHPrd)));
        (*(PwmSr0Pt[4])) = HsfbPwm_Status.DriverSR0[4];;
        HsfbPwm_Status.DriverSR1[4] = (u16)((u32)(((u32)HsfbPwm_Period.HPrd) +
          ((u32)HsfbPwm_Period.DHPrd)));
        (*(PwmSr1Pt[4])) = HsfbPwm_Status.DriverSR1[4];;
        HsfbPwm_Status.DriverSR0[5] = (u16)((s32)(((s32)HsfbPwm_Period.Prd) -
          ((s32)HsfbPwm_Period.DHPrd)));
        (*(PwmSr0Pt[5])) = HsfbPwm_Status.DriverSR0[5];;
        HsfbPwm_Status.DriverSR1[5] = HsfbPwm_Period.DHPrd;
        (*(PwmSr1Pt[5])) = HsfbPwm_Status.DriverSR1[5];;
      }
    }
  }
...
# 281 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 471 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2
...
# 268 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".code_ram" ax 8
# 478 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2
static void HsfbPwm_enter_internal_Clamp(void)
{
  f32 Add1_p;
  if (HsfbPwm_DW.oper_buck) {
    if (HsfbPwm_DW.dmin_buck) {
      ...
      if (((s32)HsfbPwm_ToMor.MorphSign) > 0) {
        HsfbPwm_Status.DriverSR0[6] = HsfbPwm_Status.DriverSR0[1];
      } else {
        HsfbPwm_Status.DriverSR0[6] = (u16)(((((f32)HsfbPwm_Status.DriverSR0[1])
          + -10.0F) * (1.0F - HsfbPwm_StartState)) + ((((f32)
          HsfbPwm_Status.DriverSR0[1]) + 20.0F) *
          HsfbPwm_StartState));
      }

      (*(PwmSr0Pt[6])) = HsfbPwm_Status.DriverSR0[6];;
      if (((s32)HsfbPwm_ToMor.MorphSign) > 0) {
        Add1_p = ((f32)HsfbPwm_Status.DriverSR1[2]) + -20.0F;
      } else {
        Add1_p = ((((f32)HsfbPwm_Status.DriverSR1[1]) + -15.0F)
                  * (1.0F - HsfbPwm_StartState)) + ((((f32)
          HsfbPwm_Status.DriverSR1[1]) + -15.0F) *
          HsfbPwm_StartState);
      }

      HsfbPwm_Status.DriverSR1[6] = (u16)Add1_p;
      (*(PwmSr1Pt[6])) = HsfbPwm_Status.DriverSR1[6];;
      HsfbPwm_Status.DriverSR0[7] = (u16)(((((f32)HsfbPwm_Status.DriverSR0[0]) +
        -10.0F) * (1.0F - HsfbPwm_StartState)) + ((((f32)
        HsfbPwm_Status.DriverSR0[0]) + 20.0F) *
        HsfbPwm_StartState));
      (*(PwmSr0Pt[7])) = HsfbPwm_Status.DriverSR0[7];;
      HsfbPwm_Status.DriverSR1[7] = (u16)(((((f32)HsfbPwm_Status.DriverSR1[0]) +
        -15.0F) * (1.0F - HsfbPwm_StartState)) + ((((f32)
        HsfbPwm_Status.DriverSR1[0]) + -15.0F) *
        HsfbPwm_StartState));
      (*(PwmSr1Pt[7])) = HsfbPwm_Status.DriverSR1[7];;
    ...
    if (HsfbPwm_DW.oper_boost) {
      if (HsfbPwm_DW.dmin_boost) {
        ...
        HsfbPwm_Status.DriverSR0[6] = (u16)(((f32)HsfbPwm_Status.DriverSR1[4]) +
          20.0F);
        (*(PwmSr0Pt[6])) = HsfbPwm_Status.DriverSR0[6];;
        HsfbPwm_Status.DriverSR1[6] = (u16)(((f32)HsfbPwm_Status.DriverSR0[4]) +
          -20.0F);
        (*(PwmSr1Pt[6])) = HsfbPwm_Status.DriverSR1[6];;
        HsfbPwm_Status.DriverSR0[7] = (u16)(((f32)HsfbPwm_Status.DriverSR1[5]) +
          20.0F);
        (*(PwmSr0Pt[7])) = HsfbPwm_Status.DriverSR0[7];;
        HsfbPwm_Status.DriverSR1[7] = (u16)(((f32)HsfbPwm_Status.DriverSR0[5]) +
          -20.0F);
        (*(PwmSr1Pt[7])) = HsfbPwm_Status.DriverSR1[7];;
      }
    }
...
# 281 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 554 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2
...
# 268 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".code_ram" ax 8
# 561 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2
static void HsfbPwm_enter_internal_Saux(void)
{
  if (HsfbPwm_DW.oper_buck) {
    if (((s32)HsfbPwm_ToMor.MorphSign) > 0) {
      HsfbPwm_Status.DriverSR0[9] = HsfbPwm_Status.DriverSR0[6];
    } else {
      HsfbPwm_Status.DriverSR0[9] = HsfbPwm_Period.MPrd;
    }
    ...
    (*(PwmSr0Pt[9])) = HsfbPwm_Status.DriverSR0[9];;
    if (((s32)HsfbPwm_ToMor.MorphSign) > 0) {
      HsfbPwm_Status.DriverSR1[9] = HsfbPwm_Period.MPrd;
    } else {
      HsfbPwm_Status.DriverSR1[9] = 0U;
    }
...
# 281 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 589 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2
...
# 268 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".code_ram" ax 8
# 596 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2
static void HsfbPwm_enter_internal_Run(void)
{
  if ((HsfbPwm_DW.dmin_buck) || (!HsfbPwm_Status.SrEn.Out)) {
    HsfbPwm_StartState = 0.0F;
  } else {
    if (HsfbPwm_StartState < (1.0F - 0.00030769F)) {
      HsfbPwm_StartState += 0.00030769F;
    }
  }

  HsfbPwm_DW.is_active_Pri = 1U;
  HsfbPwm_enter_internal_Pri();
  HsfbPwm_DW.is_active_Sr = 1U;
  HsfbPwm_enter_internal_Sr();
  HsfbPwm_DW.is_active_Clamp = 1U;
  HsfbPwm_enter_internal_Clamp();
  HsfbPwm_DW.is_active_Saux = 1U;
  HsfbPwm_enter_internal_Saux();
}

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 281 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 617 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2
...
# 268 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".code_ram" ax 8
# 624 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2
void HsfbPwm_SteadyRun(void)
{
  if (HsfbPwm_Status.Operation == ((u16)0U)) {
    HsfbPwm_Period.DPrd = (u16)(((f32)HsfbPwm_Period.Prd) *
      HsfbPwm_Status.BuckDuty.Duty);
    HsfbPwm_Period.DHPrd = (u16)(((f32)HsfbPwm_Period.HPrd) *
      HsfbPwm_Status.BuckDuty.Duty);
  } else {
    if (HsfbPwm_Status.Operation == ((u16)1U)) {
      HsfbPwm_Period.DPrd = (u16)(((f32)HsfbPwm_Period.Prd) *
        HsfbPwm_Status.BoostDuty.Duty);
      HsfbPwm_Period.DHPrd = (u16)(((f32)HsfbPwm_Period.HPrd) *
        HsfbPwm_Status.BoostDuty.Duty);
    }
  }

  if (((u32)HsfbPwm_DW.is_active_c11_HsfbPwm) == 0U) {
    HsfbPwm_DW.is_active_c11_HsfbPwm = 1U;
    HsfbPwm_DW.oper_buck = (HsfbPwm_Status.Operation == ((u16)0U));
    HsfbPwm_DW.oper_boost = (HsfbPwm_Status.Operation == ((u16)
      1U));
    HsfbPwm_DW.topo_fb = (HsfbPwm_ToMor.TopologyOut == ((u16)0U));
    HsfbPwm_DW.topo_hb = (HsfbPwm_ToMor.TopologyOut == ((u16)1U));
    HsfbPwm_DW.dmin_buck = (HsfbPwm_Status.BuckDuty.Duty <
      HsfbPwm_Status.BuckDuty.Min);
    HsfbPwm_DW.dmin_boost = (HsfbPwm_Status.BoostDuty.Duty <
      HsfbPwm_Status.BoostDuty.Min);
...
# 281 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 667 "../40_Appl/HsfbPwm/HsfbPwm_driver.c" 2
