# 1 "../30_Bsw/MicroTestLib/Static/IRTst.c"
# 1 "S:\\20_Make//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../30_Bsw/MicroTestLib/Static/IRTst.c"
# 44 "../30_Bsw/MicroTestLib/Static/IRTst.c"
# 1 "../30_Bsw/STL_common/ChipId.h" 1
# 45 "../30_Bsw/MicroTestLib/Static/IRTst.c" 2
# 1 "../30_Bsw/Common/TC21x/IfxSrc_bf.h" 1
# 46 "../30_Bsw/MicroTestLib/Static/IRTst.c" 2
# 1 "../30_Bsw/Common/TC21x/IfxCpu_bf.h" 1
# 47 "../30_Bsw/MicroTestLib/Static/IRTst.c" 2
# 1 "../30_Bsw/Common/TC21x/IfxInt_bf.h" 1
# 48 "../30_Bsw/MicroTestLib/Static/IRTst.c" 2
# 1 "../30_Bsw/Common/TC21x/IfxSmu_bf.h" 1
# 49 "../30_Bsw/MicroTestLib/Static/IRTst.c" 2
...
# 50 "../30_Bsw/MicroTestLib/Static/IRTst.c" 2
...
# 51 "../30_Bsw/MicroTestLib/Static/IRTst.c" 2
...
# 52 "../30_Bsw/MicroTestLib/Static/IRTst.c" 2
...
# 53 "../30_Bsw/MicroTestLib/Static/IRTst.c" 2
...
# 54 "../30_Bsw/MicroTestLib/Static/IRTst.c" 2
...
# 55 "../30_Bsw/MicroTestLib/Static/IRTst.c" 2
...
# 56 "../30_Bsw/MicroTestLib/Static/IRTst.c" 2
# 1 "../30_Bsw/MicroTestLib/Static/IRTst.h" 1
# 46 "../30_Bsw/MicroTestLib/Static/IRTst.h"
# 1 "../30_Bsw/STL_common/Mcal.h" 1
# 47 "../30_Bsw/MicroTestLib/Static/IRTst.h" 2
# 1 "../30_Bsw/Common/Platform_Types.h" 1
# 48 "../30_Bsw/MicroTestLib/Static/IRTst.h" 2
# 1 "../30_Bsw/STL_common/Sl_Timeout.h" 1
# 49 "../30_Bsw/MicroTestLib/Static/IRTst.h" 2
...
# 50 "../30_Bsw/MicroTestLib/Static/IRTst.h" 2
...
# 57 "../30_Bsw/MicroTestLib/Static/IRTst.c" 2
# 184 "../30_Bsw/MicroTestLib/Static/IRTst.c"
# 1 "../30_Bsw/STL_common/Ifx_MemMap.h" 1
# 2642 "../30_Bsw/STL_common/Ifx_MemMap.h"
#pragma section ".text.STL_ASIL_CODE" ax 4
# 185 "../30_Bsw/MicroTestLib/Static/IRTst.c" 2
...
# 247 "../30_Bsw/MicroTestLib/Static/IRTst.c"
static void IRTst_lInit
(
  uint32* const IRTst_lBivBackup, uint32* const IRTst_lIcrBackup
)
{
  uint32 CpuBivVal = (0x00U);


  *IRTst_lBivBackup = (uint32)((__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "(0xFE20)" : "=d" (__res) :: "memory"); __res; })));


  *IRTst_lIcrBackup = (uint32)((__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "(0xFE2C)" : "=d" (__res) :: "memory"); __res; })));


  Mcal_ResetENDINIT();


  CpuBivVal = ((uint32)((uint32)&IRTst_inttab) |(uint32)((0x1u)));
  _dsync(); do { unsigned __newval = (unsigned) ((CpuBivVal)); __asm__ volatile ("mtcr LO:" "(0xFE20)" ", %0" :: "d" (__newval) : "memory"); } while (0); _isync();
...
# 300 "../30_Bsw/MicroTestLib/Static/IRTst.c"
static void IRTst_lRestore
(
    const uint32 IRTst_lBivBackup, const uint32 IRTst_lIcrBackup
)
{
  ...
  Mcal_ResetENDINIT();
  _dsync(); do { unsigned __newval = (unsigned) ((IRTst_lBivBackup)); __asm__ volatile ("mtcr LO:" "(0xFE20)" ", %0" :: "d" (__newval) : "memory"); } while (0); _isync();
  Mcal_SetENDINIT();


  _dsync(); do { unsigned __newval = (unsigned) ((IRTst_lIcrBackup)); __asm__ volatile ("mtcr LO:" "(0xFE2C)" ", %0" :: "d" (__newval) : "memory"); } while (0); _isync();
}
# 361 "../30_Bsw/MicroTestLib/Static/IRTst.c"
static Sl_TstRsltType IRTst_lExecuteTest
(
  uint32* const TstSignature,
  const uint8 ServiceRequestPriority,
...
{
  Sl_TstRsltType Result = (0x17010aU);
  uint32 AlarmStatus = (0x00U);
  Smu_AlarmActionType SmuAlmActBak_Ag2Alm25;
  uint32 SrcRegisterBackup = (0x00U);
  uint32 SetSrcTosSrpn = (0x00U);
  uint32 SetSrcSre = (0x00U);


  Smu_FSPActionType FspDummy = (0x00U);
  ...
  {
    if( (AlarmStatus & (((uint32)(0x1u)) << ((uint32)(25u)))) == (((uint32)(0x1u)) << ((uint32)(25u))) )
    {
      Result = (0x17020dU);
    }
    else
    {
      ...
      if( 0U != (Smu_GetAlarmAction( (2U), (25U),
      ...
      {
        if( 0U != (Smu_SetAlarmAction((2U), (25U),
        ...
        else
        {
          ...
          SrcRegisterBackup = (uint32)(((*(volatile Ifx_SRC_SRCR *)0xF0038000u)).U &
                                          ( (uint32)0x7FFFFFFFU ));

          SetSrcTosSrpn = (uint32)( (uint32)(TypeOfService <<
                        (11u)) | (uint32)ServiceRequestPriority);


          SetSrcSre = (uint32)( SetSrcTosSrpn | ((uint32)(((uint32)(0x1u)) << ((uint32)(10u)))));


          ((*(volatile Ifx_SRC_SRCR *)0xF0038000u)).U = SetSrcSre;
          ...
          ((*(volatile Ifx_SRC_SRCR *)0xF0038000u)).U = SrcRegisterBackup;
        }
      }
    }
  }
...
# 505 "../30_Bsw/MicroTestLib/Static/IRTst.c"
static Sl_TstRsltType IRTst_lExecuteFaultInjTest
(
  uint32* const TstSignature,
  const uint32 TypeOfService,
...
{
  Sl_TstRsltType Result = (0x17010aU);
  uint16 CorruptEcc = (uint16)(0x00U);
  uint32 AlarmStatus = (0x00U);
  uint32 Timeout = ((uint32)2000U);
  uint32 SrcPnId = (0x00U);
  uint32 LasrPnId = (0x00U);
  volatile uint16* const SrcCpu0Sbsrc = (volatile uint16*)(volatile void*)
                                (&((*(volatile Ifx_SRC_SRCR *)0xF0038000u)).U);
  uint32 Read_SrcValue = (0x00U);


  volatile Ifx_INT_ICU_ECR* IRTst_INT_ICU_ECRGrp[] =
  {

    (&((*(volatile Ifx_INT_ICU_ECR *)0xF0037108u))),





    (&((*(volatile Ifx_INT_ICU_ECR *)0xF0037118u))),
  ...
  {
    (&((*(volatile Ifx_INT_ICU_LASR *)0xF0037104u))),





    (&((*(volatile Ifx_INT_ICU_LASR *)0xF0037114u))),
  ...
  CorruptEcc = (SrcCpu0Sbsrc[1] ^ ( (uint16)(0x1fu) ));
# 578 "../30_Bsw/MicroTestLib/Static/IRTst.c"
  SrcCpu0Sbsrc[1] = (uint16)(CorruptEcc & ( (uint16)0x7FFFU ));


  SrcCpu0Sbsrc[1] = (uint16)((SrcCpu0Sbsrc[1] & ( (uint16)0x7FFFU )) |
                                                   ((uint16)((((uint32)(0x1u)) << ((uint32)(26u))) >> (uint32)16)));



  while ((Timeout > (0x00U)) &&
                       ((0x00U) == (AlarmStatus & (((uint32)(0x1u)) << ((uint32)(25u))))))
  {
    Timeout--;
  ...
  *TstSignature = (uint32)(__crc32((unsigned_int)(*TstSignature),(unsigned_int)((AlarmStatus & (((uint32)(0x1u)) << ((uint32)(25u)))))))
                                                                       ;
  ...
  if( Result == (0x17010aU) )
  {
    ...
    if( (AlarmStatus & (((uint32)(0x1u)) << ((uint32)(25u)))) == (((uint32)(0x1u)) << ((uint32)(25u))) )
    {
      ...
      else
      {
       ...
       SrcPnId = ((uint32)(0x00U) << (uint32)(16u)) |
               ((uint32)ServiceRequestPriority <<
                 (uint32)(0u));
        LasrPnId = IRTst_INT_LASRGrp[TypeOfService]->U &
                                                 ( (((uint32)(0x3ffu) << (uint32)(16u)) | ((uint32)(0xffu) << (uint32)(0u))) );

        if(SrcPnId == LasrPnId)
        {

          if(((*(volatile Ifx_SRC_SRCR *)0xF0038000u)).B.SWS == (0x01U))
          {

            Read_SrcValue = (uint32)((((*(volatile Ifx_SRC_SRCR *)0xF0038000u)).U
                      & ( (uint32)0x7FFFFFFFU )) | ( (uint32)0x40000000U ));
            ((*(volatile Ifx_SRC_SRCR *)0xF0038000u)).U = Read_SrcValue;
        ...
        IRTst_INT_ICU_ECRGrp[TypeOfService]->U = ( 0x80000000U );
      }
    }
    else
    {
...
# 714 "../30_Bsw/MicroTestLib/Static/IRTst.c"
...
{
  Sl_TstRsltType Result = (0x17010aU);
  uint32 IRTst_lBivBackup = (0x00U);
  uint32 IRTst_lIcrBackup = (0x00U);
  uint8 CoreId = (uint8)(0x04U);


  uint8 ServiceRequestPriority = (uint8)(0x01U);


  uint32 TypeOfService = (0x04U);


  CoreId = Mcal_GetCoreId();


  *TstSignature = (uint32)(__crc32((unsigned_int)((uint32)TEST_ID_IR_TST),(unsigned_int)((uint32)TstSeed)));


  if(ParamSetIndex > (( 1U )-(0x01U)))
  {
    Result = (0x170102U);
  }
  else
    ...
    if (((Smu_StateType)1) == Smu_GetSmuState())
    {
                               ...
                               ((uint32)1U))
      {
        if((0x1701ffU) == Result)
        {
          ...
          TypeOfService = (uint32)((uint8)(((uint8)(3U)) & ((uint8)(0x1u))));
...
# 2654 "../30_Bsw/STL_common/Ifx_MemMap.h"
#pragma section
# 793 "../30_Bsw/MicroTestLib/Static/IRTst.c" 2
