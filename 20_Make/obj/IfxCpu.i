# 1 "../30_Bsw/Mcal/Cpu/IfxCpu.c"
# 1 "S:\\20_Make//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../30_Bsw/Mcal/Cpu/IfxCpu.c"
# 30 "../30_Bsw/Mcal/Cpu/IfxCpu.c"
...
IfxCpu_CoreMode IfxCpu_getCoreMode(Ifx_CPU *cpu)
{
    ...
    else
    {
        if (dbgsr.B.HALT == (uint32)IfxCpu_DBGST_HALT_run)
        {
            ...
            pmcsr_val = (Ifx_SCU_PMCSR *)&(*(Ifx_SCU *)0xF0036000u).PMCSR[index];
...
#pragma section
# 365 "../30_Bsw/Mcal/Cpu/IfxCpu.c" 2
