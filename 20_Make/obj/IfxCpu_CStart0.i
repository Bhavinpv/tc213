# 1 "../30_Bsw/Mcal/Cpu/IfxCpu_CStart0.c"
# 1 "S:\\20_Make//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../30_Bsw/Mcal/Cpu/IfxCpu_CStart0.c"
# 27 "../30_Bsw/Mcal/Cpu/IfxCpu_CStart0.c"
# 1 "../30_Bsw/Common/TC21x/Ifx_Cfg.h" 1
# 28 "../30_Bsw/Mcal/Cpu/IfxCpu_CStart0.c" 2
...
# 31 "../30_Bsw/Mcal/Cpu/IfxCpu_CStart0.c" 2
# 1 "../30_Bsw/Mcal/Scu/IfxScuCcu.h" 1
# 107 "../30_Bsw/Mcal/Scu/IfxScuCcu.h"
# 1 "../30_Bsw/Mcal/Scu/IfxScuWdt.h" 1
# 108 "../30_Bsw/Mcal/Scu/IfxScuCcu.h" 2
...
# 109 "../30_Bsw/Mcal/Scu/IfxScuCcu.h" 2
...
# 110 "../30_Bsw/Mcal/Scu/IfxScuCcu.h" 2
...
# 112 "../30_Bsw/Mcal/Scu/IfxScuCcu.h" 2
# 129 "../30_Bsw/Mcal/Scu/IfxScuCcu.h"
typedef void (*IfxScuCcu_PllStepsFunctionHook)(void);
# 143 "../30_Bsw/Mcal/Scu/IfxScuCcu.h"
typedef enum
{
...
# 709 "../30_Bsw/Mcal/Scu/IfxScuCcu.h"
typedef struct
{
    uint32 value;
    uint32 mask;
...
# 795 "../30_Bsw/Mcal/Scu/IfxScuCcu.h"
...
# 822 "../30_Bsw/Mcal/Scu/IfxScuCcu.h"
...
# 32 "../30_Bsw/Mcal/Cpu/IfxCpu_CStart0.c" 2
# 1 "../30_Bsw/Mcal/Cpu/IfxCpu.h" 1
# 33 "../30_Bsw/Mcal/Cpu/IfxCpu_CStart0.c" 2
# 1 "../30_Bsw/Mcal/Cpu/IfxCpu_CStart.h" 1
# 61 "../30_Bsw/Mcal/Cpu/IfxCpu_CStart.h"
void _Core1_start(void);
void _Core2_start(void);
# 34 "../30_Bsw/Mcal/Cpu/IfxCpu_CStart0.c" 2

# 1 "../30_Bsw/Common/TC21x/IfxCpu_reg.h" 1
# 36 "../30_Bsw/Mcal/Cpu/IfxCpu_CStart0.c" 2
# 57 "../30_Bsw/Mcal/Cpu/IfxCpu_CStart0.c"
...
void _Core0_start(void)
{
    ...
    pu32Ptr = (uint32*)(0x70000000U);
    while(pu32Ptr != ((uint32*)(0x70016000U)))
    {
        *pu32Ptr = 0;
        pu32Ptr ++;
    }
    ...
    { uint32 reg_val= (uint32)__USTACK0; asm volatile (" mov.a\t %%""sp"",%0"::"d"(reg_val)); };
    __dsync();
...
# 117 "../30_Bsw/Mcal/Cpu/IfxCpu_CStart0.c"
    ...
    { uint32 reg_val= (uint32)__A0_MEM; asm volatile (" mov.a\t %%""a0"",%0"::"d"(reg_val)); };
    { uint32 reg_val= (uint32)__A1_MEM; asm volatile (" mov.a\t %%""a1"",%0"::"d"(reg_val)); };


    { uint32 reg_val= (uint32)__A8_MEM; asm volatile (" mov.a\t %%""a8"",%0"::"d"(reg_val)); };
    { uint32 reg_val= (uint32)__A9_MEM; asm volatile (" mov.a\t %%""a9"",%0"::"d"(reg_val)); };
...
#pragma section
# 168 "../30_Bsw/Mcal/Cpu/IfxCpu_CStart0.c" 2
...
# 184 "../30_Bsw/Mcal/Cpu/IfxCpu_CStart0.c"
void _START(void)
{
    __asm__ volatile ("j ""_Core0_start");
}
...
#pragma section
# 207 "../30_Bsw/Mcal/Cpu/IfxCpu_CStart0.c"
#pragma section
#pragma section ".bmhd_0" a
# 220 "../30_Bsw/Mcal/Cpu/IfxCpu_CStart0.c"
...
#pragma section
# 246 "../30_Bsw/Mcal/Cpu/IfxCpu_CStart0.c"
#pragma section
#pragma section ".bmhd_1" a
# 260 "../30_Bsw/Mcal/Cpu/IfxCpu_CStart0.c"
...
#pragma section
# 284 "../30_Bsw/Mcal/Cpu/IfxCpu_CStart0.c"
#pragma section
#pragma section ".startaddrtable" a
uint32 const ApplStartAddrTable[(2U)] = {(uint32)_START, (0xC33C0000U)};
