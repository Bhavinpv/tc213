# 1 "../30_Bsw/Mcal/Scu/IfxScuWdt.c"
# 1 "S:\\20_Make//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../30_Bsw/Mcal/Scu/IfxScuWdt.c"
# 30 "../30_Bsw/Mcal/Scu/IfxScuWdt.c"
...
# 31 "../30_Bsw/Mcal/Scu/IfxScuWdt.c" 2
...
# 32 "../30_Bsw/Mcal/Scu/IfxScuWdt.c" 2
# 46 "../30_Bsw/Mcal/Scu/IfxScuWdt.c"
# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 294 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_QM_CODE" ax 8
# 47 "../30_Bsw/Mcal/Scu/IfxScuWdt.c" 2
...
void IfxScuWdt_initConfig(IfxScuWdt_Config *config)
{
    ...
    config->inputFrequency = IfxScu_WDTCON1_IR_divBy256;
...
#pragma section
# 408 "../30_Bsw/Mcal/Scu/IfxScuWdt.c" 2
