# 1 "../30_Bsw/MicroTestLib/Static/LockStepTst.c"
# 1 "S:\\20_Make//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../30_Bsw/MicroTestLib/Static/LockStepTst.c"
# 38 "../30_Bsw/MicroTestLib/Static/LockStepTst.c"
# 1 "../30_Bsw/MicroTestLib/Static/LockStepTst.h" 1
# 42 "../30_Bsw/MicroTestLib/Static/LockStepTst.h"
# 1 "../30_Bsw/STL_common/ChipId.h" 1
# 43 "../30_Bsw/MicroTestLib/Static/LockStepTst.h" 2
...
# 46 "../30_Bsw/MicroTestLib/Static/LockStepTst.h" 2
...
# 47 "../30_Bsw/MicroTestLib/Static/LockStepTst.h" 2
...
# 39 "../30_Bsw/MicroTestLib/Static/LockStepTst.c" 2
...
# 40 "../30_Bsw/MicroTestLib/Static/LockStepTst.c" 2
# 90 "../30_Bsw/MicroTestLib/Static/LockStepTst.c"
# 1 "../30_Bsw/STL_common/Ifx_MemMap.h" 1
# 4042 "../30_Bsw/STL_common/Ifx_MemMap.h"
#pragma section ".rodata.STL_CONST_FAR_UNSPECIFIED" a
# 91 "../30_Bsw/MicroTestLib/Static/LockStepTst.c" 2

static const LockStepTst_RegMapType *
                           const LockStepTst_kLockStepEnable[(1U)] =
{


  ((volatile LockStepTst_RegMapType *) (volatile void *)(&(*(volatile Ifx_SCU_LCLCON0 *)0xF0036134u))),
# 112 "../30_Bsw/MicroTestLib/Static/LockStepTst.c"
};
...
#pragma section
# 116 "../30_Bsw/MicroTestLib/Static/LockStepTst.c" 2
...
# 120 "../30_Bsw/MicroTestLib/Static/LockStepTst.c" 2

static const uint32 LockStepTst_kFaultInjectionEnable[(1U)] =
{
  ( (uint32)0x00000001U ),
# 134 "../30_Bsw/MicroTestLib/Static/LockStepTst.c"
};
...
#pragma section
# 138 "../30_Bsw/MicroTestLib/Static/LockStepTst.c" 2
...
# 142 "../30_Bsw/MicroTestLib/Static/LockStepTst.c" 2

static const uint8 LockStepTst_kSmuAlarmGrp[(1U)] =
{
  ((uint8)(0U) ),
# 155 "../30_Bsw/MicroTestLib/Static/LockStepTst.c"
};

static const uint8 LockStepTst_LockStepCoreStatus[(1U)] =
{
  0U,
# 168 "../30_Bsw/MicroTestLib/Static/LockStepTst.c"
};
...
#pragma section
# 172 "../30_Bsw/MicroTestLib/Static/LockStepTst.c" 2
...
# 2642 "../30_Bsw/STL_common/Ifx_MemMap.h"
#pragma section ".text.STL_ASIL_CODE" ax 4
# 178 "../30_Bsw/MicroTestLib/Static/LockStepTst.c" 2
...
# 230 "../30_Bsw/MicroTestLib/Static/LockStepTst.c"
...
{
  Sl_TstRsltType Result = (0x18010aU);
  Sl_TstRsltType ResultInitExecute = (0x18010aU);
  Sl_TstRsltType ResultRestore = (0x18010aU);
  ...
  *TstSignature = (uint32)(__crc32((unsigned_int)((uint32)TEST_ID_LOCK_STEP_TST),(unsigned_int)((uint32)TstSeed)));
  ...
  else if( CoreId == LockStepTst_LockStepCoreStatus[CoreId] )
  {
    if(((Smu_StateType)1) == Smu_GetSmuState())
    {
      ...
      if(ResultInitExecute == (Sl_TstRsltType)(0x1801ffU))
      {
      ...
      if((0x1801ffU) == ResultInitExecute)
      {
        if((0x1801ffU) == ResultRestore)
        {
          Result = (0x1801ffU);
        }
        else
    ...
    {
      Result = (Sl_TstRsltType)(0x18020cU);
    }
  }
  else
  {
...
# 328 "../30_Bsw/MicroTestLib/Static/LockStepTst.c"
static Sl_TstRsltType LockStepTst_lInit
(
  Smu_AlarmActionType* const AlmActionBackupLockStep
)
{
  ...
  if(0U != (Smu_GetAlarmAction(LockStepTst_kSmuAlarmGrp[CoreId], (0U),
  AlmActionBackupLockStep, &FspActionDummy)))
  {

    *AlmActionBackupLockStep = ((Smu_AlarmActionType)0xFFU);
  ...
  else
  {
    ...
    if(((uint32)(LockStepTst_kLockStepEnable[CoreId]->SCULCLCON.B.LS)) == ( 1U ))
    {
      ...
      else
      {
        ...
        {
          if(0U !=
          Smu_SetAlarmAction(LockStepTst_kSmuAlarmGrp[CoreId], (0U),
...
# 418 "../30_Bsw/MicroTestLib/Static/LockStepTst.c"
static Sl_TstRsltType LockStepTst_lRestore
(
  const Smu_AlarmActionType* const AlmActionBackupLockStep
)
{
  ...
  if(0U != Smu_SetAlarmAction(LockStepTst_kSmuAlarmGrp[CoreId], (0U),
...
# 467 "../30_Bsw/MicroTestLib/Static/LockStepTst.c"
static Sl_TstRsltType LockStepTst_lExecuteTst
(
  uint32* const TstSignature
)
{
  ...
  (*(volatile Ifx_SCU_LCLTEST *)0xF003613Cu).U = LockStepTst_kFaultInjectionEnable[CoreId];


  while((0U == (AlmStatus & ((uint32)( 1U )))) &&
                                                               ((Timeout) > 0U))
  {
    Timeout--;


    if(0U != Smu_GetAlarmStatus(LockStepTst_kSmuAlarmGrp[CoreId], &AlmStatus))
    {
      AlmStatus = 0U;
      Timeout = 0U;
      Result = (0x18020eU);
  ...
  if(0U != (AlmStatus & ((uint32)( 1U ))))
  {
    ...
    if(0U != Smu_ClearAlarmStatus(LockStepTst_kSmuAlarmGrp[CoreId],
                                                    ((uint8)(0U) )))
    {
      Result = (0x18020fU);
    }
  ...
  *TstSignature = (uint32)(__crc32((unsigned_int)(*TstSignature),(unsigned_int)((AlmStatus & ( 1U )))))
                                                                               ;
...
# 2654 "../30_Bsw/STL_common/Ifx_MemMap.h"
#pragma section
# 529 "../30_Bsw/MicroTestLib/Static/LockStepTst.c" 2
