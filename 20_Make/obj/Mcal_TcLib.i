# 1 "../30_Bsw/STL_common/Mcal_TcLib.c"
# 1 "S:\\20_Make//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../30_Bsw/STL_common/Mcal_TcLib.c"
# 39 "../30_Bsw/STL_common/Mcal_TcLib.c"
...
# 40 "../30_Bsw/STL_common/Mcal_TcLib.c" 2
...
# 41 "../30_Bsw/STL_common/Mcal_TcLib.c" 2
# 1 "../30_Bsw/Common/TC21x/IfxCpu_bf.h" 1
# 42 "../30_Bsw/STL_common/Mcal_TcLib.c" 2
...
# 43 "../30_Bsw/STL_common/Mcal_TcLib.c" 2
...
# 44 "../30_Bsw/STL_common/Mcal_TcLib.c" 2
...
# 46 "../30_Bsw/STL_common/Mcal_TcLib.c" 2
# 105 "../30_Bsw/STL_common/Mcal_TcLib.c"
# 1 "../30_Bsw/STL_common/Ifx_MemMap.h" 1
# 3510 "../30_Bsw/STL_common/Ifx_MemMap.h"
#pragma section ".data.STL_RAM_32BIT_NONZERO_INIT" aw 4
# 106 "../30_Bsw/STL_common/Mcal_TcLib.c" 2
# 131 "../30_Bsw/STL_common/Mcal_TcLib.c"
static uint32 Mcal_SavedIntState[(1U)] = {0U};
static uint32 Mcal_IntDisableCounter[(1U)] = {0U};
static uint32 Mcal_SavedIntStateRedn[(1U)] = {0xFFFFFFFFU};
static uint32 Mcal_IntDisableCounterRedn[(1U)] = {0xFFFFFFFFU};
# 172 "../30_Bsw/STL_common/Mcal_TcLib.c"
# 1 "../30_Bsw/STL_common/Ifx_MemMap.h" 1
# 3525 "../30_Bsw/STL_common/Ifx_MemMap.h"
#pragma section
# 173 "../30_Bsw/STL_common/Mcal_TcLib.c" 2
# 187 "../30_Bsw/STL_common/Mcal_TcLib.c"
# 1 "../30_Bsw/STL_common/Ifx_MemMap.h" 1
# 4016 "../30_Bsw/STL_common/Ifx_MemMap.h"
#pragma section ".rodata.STL_CONST_32BIT" a 4
# 188 "../30_Bsw/STL_common/Mcal_TcLib.c" 2
# 218 "../30_Bsw/STL_common/Mcal_TcLib.c"
# 1 "../30_Bsw/STL_common/Ifx_MemMap.h" 1
# 4029 "../30_Bsw/STL_common/Ifx_MemMap.h"
#pragma section
# 219 "../30_Bsw/STL_common/Mcal_TcLib.c" 2
# 236 "../30_Bsw/STL_common/Mcal_TcLib.c"
# 1 "../30_Bsw/STL_common/Ifx_MemMap.h" 1
# 2642 "../30_Bsw/STL_common/Ifx_MemMap.h"
#pragma section ".text.STL_ASIL_CODE" ax 4
# 237 "../30_Bsw/STL_common/Mcal_TcLib.c" 2
# 270 "../30_Bsw/STL_common/Mcal_TcLib.c"
uint8 Mcal_GetCoreId(void)
{
  uint8 RetVal;

  RetVal = (uint8)((__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "(0xFE1C)" : "=d" (__res) :: "memory"); __res; })));
  return RetVal;
}
# 298 "../30_Bsw/STL_common/Mcal_TcLib.c"
...
# 320 "../30_Bsw/STL_common/Mcal_TcLib.c"
    switch(CoreId)
    {
      case 0:
       if( (Address & (~(0xF0000000U))) < (0x0000C000U))
       {
         RetAddress = ((Address & (0x0003FFFFU)) |
                        (0x70000000U));
       }
       break;

      case 1:
# 339 "../30_Bsw/STL_common/Mcal_TcLib.c"
        break;

      default:
# 350 "../30_Bsw/STL_common/Mcal_TcLib.c"
        break;
    }
  }
  return RetAddress;
}
# 498 "../30_Bsw/STL_common/Mcal_TcLib.c"
uint32 Mcal_LockResource(uint32 *ResourcePtr)
{
  ...
  if( ResourcePtr != ((void *)0) )
  {
    RetVal = (uint32)cmpswap_w(((unsigned_int*)(void*)(unsigned_int*)(void*)ResourcePtr), ((unsigned_int)RetVal), ((unsigned_int)(0U)) )
                                                                               ;
...
# 542 "../30_Bsw/STL_common/Mcal_TcLib.c"
void Mcal_UnlockResource(uint32* ResourcePtr)
{
  if( ResourcePtr != ((void *)0) )
  {
    ...
    *ResourcePtr = (uint32)(0U);
  }
}
# 581 "../30_Bsw/STL_common/Mcal_TcLib.c"
Std_ReturnType Mcal_GetSpinLock(uint32* SpinLckPtr,uint32 Timeout)
{
  ...
  if( SpinLckPtr != ((void *)0) )
  {
    do
    {
      ...
      SpinLockVal = 1UL;
      SpinLockVal = (uint32)
      cmpswap_w(((unsigned_int*)(void*)(unsigned_int*)(void*)SpinLckPtr), ((unsigned_int)SpinLockVal), ((unsigned_int)0U) );
    ...
    } while((RetVal == 1U) && (Timeout > 0U));
  }

  return(RetVal);
}
# 640 "../30_Bsw/STL_common/Mcal_TcLib.c"
...
# 675 "../30_Bsw/STL_common/Mcal_TcLib.c"
void Mcal_SuspendAllInterrupts(void)
{
  ...
  CoreID = (uint32)((__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "(0xFE1C)" : "=d" (__res) :: "memory"); __res; })));

  if(Mcal_IntDisableCounter[CoreID] == 0U)
  {
    ICRState = (uint32)((__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "(0xFE2C)" : "=d" (__res) :: "memory"); __res; })));
...
# 739 "../30_Bsw/STL_common/Mcal_TcLib.c"
...
# 805 "../30_Bsw/STL_common/Mcal_TcLib.c"
# 1 "../30_Bsw/STL_common/Ifx_MemMap.h" 1
# 2654 "../30_Bsw/STL_common/Ifx_MemMap.h"
#pragma section
# 806 "../30_Bsw/STL_common/Mcal_TcLib.c" 2
