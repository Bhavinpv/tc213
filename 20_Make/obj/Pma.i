...
# 18 "../30_Bsw/Mcal/Can/can_driver.h"
...
# 19 "../30_Bsw/Mcal/Can/can_driver.h" 2
...
# 21 "../30_Bsw/Pma/Pma.c" 2

# 1 "../30_Bsw/Pma/Pma_scb.h" 1
# 23 "../30_Bsw/Pma/Pma.c" 2
...
# 1 "../30_Bsw/Pma/PMA_MemMap.h" 1
# 10 "../30_Bsw/Pma/PMA_MemMap.h"
#pragma section ".data.PMA_QM_VAR_INIT" aw 4
# 31 "../30_Bsw/Pma/Pma.c" 2
PMA_S_ABORTTYPE Pma_AbortData;
PMA_S_RUN* Pma_RunTime;
Ifx_CPU_PSW PSWReg_Rd2;
# 42 "../30_Bsw/Pma/Pma.c"
# 1 "../30_Bsw/Pma/PMA_MemMap.h" 1
# 23 "../30_Bsw/Pma/PMA_MemMap.h"
#pragma section
# 43 "../30_Bsw/Pma/Pma.c" 2
...
# 1 "../30_Bsw/Pma/PMA_MemMap.h" 1
# 35 "../30_Bsw/Pma/PMA_MemMap.h"
#pragma section ".text.PMA_QM_CODE" ax 4
# 63 "../30_Bsw/Pma/Pma.c" 2
# 72 "../30_Bsw/Pma/Pma.c"
void Pma_vInit(void)
{
  ...
  if (Pma_AbortData.InitPattern != (0x1234DE00u | 1u))
  {
    Pma_AbortData.InitPattern = (0x1234DE00u | 1u);
  }
  Pma_vReadResetSts();
}
# 106 "../30_Bsw/Pma/Pma.c"
void Pma_vTask10ms(void)
{
...
# 172 "../30_Bsw/Pma/Pma.c"
static void PMA_vCheckImproperShutdown(void)
{
  if(1u == (*(volatile Ifx_SCU_RSTSTAT *)0xF0036050u).B.PORST)
  {
    Pma_AbortData.ResetInfo.ShutdownSts |= 1u;
  }
  if((1u == (*(volatile Ifx_SCU_RSTSTAT *)0xF0036050u).B.STM0)
  || (1u == (*(volatile Ifx_SCU_RSTSTAT *)0xF0036050u).B.STM0)
  || (1u == (*(volatile Ifx_SCU_RSTSTAT *)0xF0036050u).B.STM0))
  {
    Pma_AbortData.ResetInfo.ShutdownSts |= 2u;
  }
  if(1u == (*(volatile Ifx_SCU_RSTSTAT *)0xF0036050u).B.EVR13)
  {
    Pma_AbortData.ResetInfo.ShutdownSts |= 4u;
  }
  if(1u == (*(volatile Ifx_SCU_RSTSTAT *)0xF0036050u).B.EVR33)
  {
    Pma_AbortData.ResetInfo.ShutdownSts |= 8u;
  }
  if(1u == (*(volatile Ifx_SCU_RSTSTAT *)0xF0036050u).B.SMU)
  {
    Pma_AbortData.ResetInfo.ShutdownSts |= 10u;
  }
  if(1u == (*(volatile Ifx_SCU_RSTSTAT *)0xF0036050u).B.SWD)
  {
    Pma_AbortData.ResetInfo.ShutdownSts |= 20u;
  }
  if(1u == (*(volatile Ifx_SCU_RSTSTAT *)0xF0036050u).B.STBYR)
  {
    Pma_AbortData.ResetInfo.ShutdownSts |= 40u;
  }
}
# 216 "../30_Bsw/Pma/Pma.c"
static void Pma_vReadResetSts(void)
{
  ...
  Pma_AbortData.ResetInfo.ResetSts_reg = (uint32)(*(volatile Ifx_SCU_RSTSTAT *)0xF0036050u).U;
...
void Pma_vGetPfmSts(PFM_S_CAPTURE* Pfm_RdData)
{
  ...
  Pma_AbortData.ErrSrc |= 0x04;
  Pma_AbortData.ModuleInfo.Pfm_ErrCnt++;
# 321 "../30_Bsw/Pma/Pma.c"
  Pma_vKeepErrcnt();
}
# 335 "../30_Bsw/Pma/Pma.c"
void Pma_vGetE2eSts(CAN_S_E2E* E2e_RdData)
{
  u8 idx = 0u;
  ...
  Pma_AbortData.ErrSrc |= 0x08;
  Pma_AbortData.ModuleInfo.E2e_ErrCnt++;
  Pma_vKeepErrcnt();
}
# 363 "../30_Bsw/Pma/Pma.c"
void Pma_vGetQspiSts(QSPI_S_ERROR_BIT* Qspi_RdData)
{
  ...
  Pma_AbortData.ErrSrc |= 0x10;
  Pma_AbortData.ModuleInfo.Qspi_ErrCnt++;
  Pma_vKeepErrcnt();
}
# 561 "../30_Bsw/Pma/Pma.c"
# 1 "../30_Bsw/Pma/PMA_MemMap.h" 1
# 48 "../30_Bsw/Pma/PMA_MemMap.h"
#pragma section
# 562 "../30_Bsw/Pma/Pma.c" 2
