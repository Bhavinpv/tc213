# 1 "../30_Bsw/Mcal/Qspi/Qspi.c"
# 1 "D:\\SVN\\IPB-11Kw\\LvDc-C01R0P0-Ceramicheater\\20_Make//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../30_Bsw/Mcal/Qspi/Qspi.c"
# 19 "../30_Bsw/Mcal/Qspi/Qspi.c"
...
# 22 "../30_Bsw/Mcal/Qspi/Qspi.c" 2
# 1 "../30_Bsw/Common/TC21x/IfxCbs_reg.h" 1
# 36 "../30_Bsw/Common/TC21x/IfxCbs_reg.h"
# 1 "../30_Bsw/Common/TC21x/IfxCbs_regdef.h" 1
# 45 "../30_Bsw/Common/TC21x/IfxCbs_regdef.h"
...
# 1013 "../30_Bsw/Common/TC21x/IfxCbs_regdef.h"
typedef volatile struct _Ifx_CBS_TRTGB
{
    Ifx_CBS_TRTGB_L L;
    Ifx_CBS_TRTGB_H H;
} Ifx_CBS_TRTGB;
# 1030 "../30_Bsw/Common/TC21x/IfxCbs_regdef.h"
typedef volatile struct _Ifx_CBS
{
    ...
    Ifx_CBS_TCM TCM;
    Ifx_CBS_TREC TREC[1];
    unsigned char reserved_C4[24];
    Ifx_CBS_TRMT TRMT;
    Ifx_CBS_TRTGB TRTGB[2];
    unsigned char reserved_F0[16];
    Ifx_CBS_TRIG TRIG[6];
    unsigned char reserved_118[232];
} Ifx_CBS;
# 37 "../30_Bsw/Common/TC21x/IfxCbs_reg.h" 2
# 23 "../30_Bsw/Mcal/Qspi/Qspi.c" 2
...
# 63 "../30_Bsw/Mcal/Qspi/Qspi.c" 2
void Qspi_Init(void)
{
  Qspi_cfg();
  Qspi_SBCError.all = 0u;
  Qspi_StrtUpTst_Sts = QSPI_TEST_INIT;

  Qspi_WWDTest_Ctr = 0u;
  Qspi_SbcStateChng_WaitCtr = 0xFF;
  Qspi_WWDT_Status = QSPI_WWDT_INIT;
  Qspi_WWDTest_RetryCtr = 0u;
  Qspi_ABISTSS_RetryFlag = 0u;
  Qspi_ABISTSS_RetryCtr = 0u;
  Qspi_ABISTInt_RetryFlag = 0u;
  Qspi_ABISTInt_RetryCtr = 0u;
...
void Qspi_StartUp(void)
{
  switch (Qspi_StrtUpTst_Sts)
  {
    ...
    {
      if(200u == Qspi_SbcStateChng_WaitCtr)
      {
        Qspi_SBC_GotoNormal();
...
void Qspi_SBC_Unlock(void)
{
  ...
  Qspi_SBC_TxRxData(0x5000,&RxData[0]);
  if((RxData[0] != 0x81E1)||(Qspi_SBCError.bit.ParityCheck == 1))
  {
...
void Qspi_SBC_Lockup(void)
{
  ...
  if((RxData[0] != 0x81E2)||(Qspi_SBCError.bit.ParityCheck == 1))
  {
...
{
  u16 TxDataWrite[7] =
  {0x8800,0x8A10,0x8DD1,0x8E12,0x9017,0x9201,0x9401};
  u16 TxDataRead[7] =
  {0x0801,0x0A00,0x0C00,0x0E01,0x1001,0x1200,0x1400};
  u16 RxData[7];
...
{
  u16 TxDataWrite[7] =
  {0x8A10,0x8A10,0x8DD1,0x8E12,0x9017,0x9201,0x9401};
  u16 TxDataRead[7] =
  {0x1800,0x1800,0x1A01,0x1C01,0x1E00,0x2001,0x2200};
  u16 RxData[7];
  ...
  Qspi_SBC_TxRxData(0x1601,&RxData[0]);
  ...
  Qspi_SBC_TxRxData(0x6201,&RxData[0]);
  if((((RxData[0] >> 1) & 0xFF) != 0)||(Qspi_SBCError.bit.ParityCheck == 1))
  {
    Qspi_SBCError.bit.ReadStatus = 1;
  }

  Qspi_SBC_TxRxData(0x6401,&RxData[0]);
  if((((RxData[0] >> 1) & 0xFF) != 0)||(Qspi_SBCError.bit.ParityCheck == 1))
  {
    Qspi_SBCError.bit.ReadStatus = 1;
  }
  ...
  Qspi_SBC_TxRxData(0xF801,&RxData[0]);
  Qspi_SBC_TxRxData(0x7800,&RxData[0]);
  if((((RxData[0] >> 1) & 0x80) != 0)||(Qspi_SBCError.bit.ParityCheck == 1))
  {
    if (1u != ((*(Ifx_CBS *)0xF0000400u)).OSTATE.B.OEN)
    {
...
void Qspi_SBC_GotoNormal(void)
{
  ...
  Qspi_SBC_TxRxData(0x4E00,&RxData[0]);
  if((RxData[0] != 0x8054)||(Qspi_SBCError.bit.ParityCheck == 1))
  {
    if (1u != ((*(Ifx_CBS *)0xF0000400u)).OSTATE.B.OEN)
    {
...
void Qspi_SBC_ABIST(void)
{
  ...
  u16 TxDataSS[4] =
  {0xDC46,0xDE05,0xE182,0xD806};




  u16 TxDataInt[4] =
  {0xDC20,0xDE63,0xE061,0xD817};

  u16 TxDataClr[3] =
  {0xC1FE,0xC3FF,0xC5FF};
  u16 RxData[4];
  u16 i;
  ...
  switch(Qspi_ABIST_Status)
  {
    ...
    case QSPI_ABIST_SST_CHK_RETRY:
    {
      ...
      if(3u > Qspi_ABISTSS_RetryCtr)
      {
        if(1u == Qspi_ABISTSS_RetryFlag)
        {
          Qspi_ABISTSS_RetryCtr++;
        }
        Qspi_ABIST_WaitCtr = 0u;
        Qspi_ABIST_Status = QSPI_ABIST_SST_CHK_STATUS;
      }
      else if (3u <= Qspi_ABISTSS_RetryCtr)
      {
    ...
    case QSPI_ABIST_SST_CHK_STATUS:
    {
      ...
      if(10u > Qspi_ABIST_WaitCtr)
      {
        Qspi_ABIST_WaitCtr++;
      }
      else
      {
        Qspi_SBC_TxRxData(0x5801,&RxData[0]);
        ...
        if((((RxData[0] >> 1) & 0x01) == 0)||(Qspi_SBCError.bit.ParityCheck == 1))
        {
          ...
          if(((((RxData[0] >> 1) & 0xF0) >> 4) != 5)||(Qspi_SBCError.bit.ParityCheck == 1))
          {
            ...
            Qspi_SBCError.bit.ABISTSS = 1u;
            Qspi_ABISTSS_RetryFlag = 1u;
            Qspi_ABIST_Status = QSPI_ABIST_START;
          }
          else
          {

            Qspi_SBCError.bit.ABISTSS = 0u;
            Qspi_ABISTSS_RetryFlag = 0u;
            Qspi_ABISTSS_RetryCtr = 0u;
    ...
    {
      Qspi_SBC_TxRxData(0x5C00,&Qspi_Log[0]);
      Qspi_SBC_TxRxData(0x5E01,&Qspi_Log[1]);
      Qspi_SBC_TxRxData(0x6000,&Qspi_Log[2]);
      Qspi_SBC_TxRxData(0x3801,&Qspi_Log[3]);
      Qspi_SBC_TxRxData(0x3401,&Qspi_Log[4]);
      Qspi_SBC_TxRxData(0x3600,&Qspi_Log[5]);
      Qspi_SBC_TxRxData(0x4001,&Qspi_Log[6]);
      Qspi_SBC_TxRxData(0x4200,&Qspi_Log[7]);
      Qspi_SBC_TxRxData(0x4400,&Qspi_Log[8]);
      Qspi_SBC_TxRxData(0x4601,&Qspi_Log[9]);
    ...
    case QSPI_ABIST_INTT_CHK_RETRY:
    {
      ...
      if(3u > Qspi_ABISTInt_RetryCtr)
      {
        if(1u == Qspi_ABISTInt_RetryFlag)
        {
      ...
      else if (3u <= Qspi_ABISTInt_RetryCtr)
      {
      ...
      else
      {
        ...
        if((((RxData[0] >> 1) & 0x01) == 0)||(Qspi_SBCError.bit.ParityCheck == 1))
        {
          ...
          if(((((RxData[0] >> 1) & 0xF0) >> 4) != 5)||(Qspi_SBCError.bit.ParityCheck == 1))
          {
            ...
            Qspi_SBCError.bit.ABISTInt = 1u;
            Qspi_ABISTInt_RetryFlag = 1u;
            Qspi_ABIST_Status = QSPI_ABIST_INTT_START;
          }
          else
          {

            Qspi_SBCError.bit.ABISTInt = 0u;
            Qspi_ABISTInt_RetryFlag = 0u;
            Qspi_ABISTInt_RetryCtr = 0u;
...
void Qspi_SBC_WWDTest(void)
{
  ...
  switch(Qspi_WWDT_Status)
  {
    case QSPI_WWDT_INIT:
    {
      ...
      Qspi_WWDT_WdgErrCnt[0] = 0u;
      Qspi_WWDT_WdgErrCnt[1] = 0u;
      Qspi_WWDT_WdgErrCnt[2] = 0u;
    ...
    case QSPI_WWDT_RD_ERRCTR:
    {
      ...
      if(2*70u == Qspi_WWDTest_Ctr)
      {
        Qspi_SBC_TxRxData(0x5201,&RxData);
        Qspi_WWDT_WdgErrCnt[0] = ((RxData >> 1) & 0x0F);


        if((0u == Qspi_WWDT_WdgErrCnt[0])
    ...
    case QSPI_WWDT_DIS_WDGTRIG:
    {
      ...
      if((*(volatile Ifx_P_IN *)0xF003A224u).B.P8)
      {
        WdgEnable = 0u;
    ...
    case QSPI_WWDT_RUN_TIMER1:
    {
      ...
      if(((3*70u)+35u) > Qspi_WWDTest_Ctr)
      {
        Qspi_WWDTest_Ctr++;


        if((3*70u) <= Qspi_WWDTest_Ctr)
        {
          Qspi_SBC_TxRxData(0x5201,&RxData);
          Qspi_WWDT_WdgErrCnt[1] = ((RxData >> 1) & 0x0F);

          if((2u == Qspi_WWDT_WdgErrCnt[1])
            ||(Qspi_SBCError.bit.ParityCheck == 1))
          {
    ...
    case QSPI_WWDT_RUN_TIMER2:
    {
      ...
      if(((4*70u)+35u) > Qspi_WWDTest_Ctr)
      {
        Qspi_WWDTest_Ctr++;


        if((4*70u) <= Qspi_WWDTest_Ctr)
        {

          Qspi_SBC_TxRxData(0x5201,&RxData);
          Qspi_WWDT_WdgErrCnt[2] = ((RxData >> 1) & 0x0F);

          if((1u == Qspi_WWDT_WdgErrCnt[2])
            ||(Qspi_SBCError.bit.ParityCheck == 1))
          {
...
void Qspi_SBC_Check_NormalState(void)
{
  ...
  Qspi_SBC_TxRxData(0x4E00,&RxData);
...
# 836 "../30_Bsw/Mcal/Qspi/Qspi.c"
void Qspi_SBC_Check_QVRStatus(void)
{
  u16 TxData[3] =
  {0x4200,0x4001,0x4A01};
  u16 RxData[3];
  u16 i;
...
void Qspi_SBC_Check_RegStatus(void)
{
  ...
  Qspi_SBCError.bit.QVRStatus = 0;
  Qspi_SBC_TxRxData(0x4C01,&RxData);
...
void Qspi_SBC_TxRxData(u16 TxData,u16 *RxData)
{
  ...
  for(i=0;i<5;i++)
  {
    ...
    {
      (*(volatile Ifx_QSPI_DATAENTRY *)0xF0001C64u).U = TxData;
      while((*(volatile Ifx_QSPI_STATUS *)0xF0001C40u).B.TXF != 1); (*(volatile Ifx_QSPI_FLAGSCLEAR *)0xF0001C54u).B.TXC = 1; while((*(volatile Ifx_QSPI_STATUS *)0xF0001C40u).B.RXF != 1); (*(volatile Ifx_QSPI_FLAGSCLEAR *)0xF0001C54u).B.RXC = 1;;
      RxTemp = (*(volatile Ifx_QSPI_RXEXIT *)0xF0001C90u).U;
...
void Qspi_Cmd_Test10ms(QSPI_S_TEST *v)
{
  if(v->Enable)
  {
    ...
    (*(volatile Ifx_QSPI_DATAENTRY *)0xF0001C64u).U = v->TxData.all;
    while((*(volatile Ifx_QSPI_STATUS *)0xF0001C40u).B.TXF != 1); (*(volatile Ifx_QSPI_FLAGSCLEAR *)0xF0001C54u).B.TXC = 1; while((*(volatile Ifx_QSPI_STATUS *)0xF0001C40u).B.RXF != 1); (*(volatile Ifx_QSPI_FLAGSCLEAR *)0xF0001C54u).B.RXC = 1;;
    v->RxData.all = (*(volatile Ifx_QSPI_RXEXIT *)0xF0001C90u).U;
    v->Enable = 0;
  }
}
