# 1 "../30_Bsw/Scheduler/Scheduler_Asil.c"
# 1 "D:\\SVN\\IPB-11Kw\\LvDc-C01R0P0-Ceramicheater\\20_Make//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../30_Bsw/Scheduler/Scheduler_Asil.c"
# 20 "../30_Bsw/Scheduler/Scheduler_Asil.c"
...
# 25 "../30_Bsw/Scheduler/Scheduler_api.h" 2
...
# 21 "../30_Bsw/Scheduler/Scheduler_Asil.c" 2
...
# 23 "../30_Bsw/Scheduler/Scheduler_Asil.c" 2
...
# 24 "../30_Bsw/Scheduler/Scheduler_Asil.c" 2
...
# 25 "../30_Bsw/Scheduler/Scheduler_Asil.c" 2
...
# 33 "../30_Bsw/Scheduler/Scheduler_Asil.c" 2
...
#pragma section
# 53 "../30_Bsw/Scheduler/Scheduler_Asil.c" 2



# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 11 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".data.MPU_ASIL_VAR_INIT" aw 8
# 57 "../30_Bsw/Scheduler/Scheduler_Asil.c" 2
static u32 Timer_value = 0u;
static u32 Timer_history = 0u;
static u32 WdgStopTrigger = 0xFFFFFFFFu;
static u16 Isr_15us_Fire_Count = 0u;
static u16 Isr_100us_Fire_Count = 0u;
static u8 Isr_1ms_Fire_Count = 0u;
static u16 Qspi_TstSeqIndx = 0xFFFFu;
static u8 Pfm_flag = 1u;

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 24 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 67 "../30_Bsw/Scheduler/Scheduler_Asil.c" 2
...
# 87 "../30_Bsw/Scheduler/Scheduler_Asil.c" 2
# 98 "../30_Bsw/Scheduler/Scheduler_Asil.c"
void __attribute__ ((interrupt_handler)) Isr_Call15us(void)
{

  mpu_vSet_ActiveProtSet(0);

  if(0 == PSWReg_Rd0.B.PRS)
  {

    mg_vIsr_TimeMeasCalc(&Isr_TimeMeas,0,1,Isr_15usTick);
    ...
    if(1 == PSWReg_Rd0.B.S)
    {
      ...
      switch(Isr_15usTick)
      {
       ...
       mg_vIsr_TimeMeasCalc(&Isr_TimeMeas,0,0,Isr_15usTick);

      if (Pfm_flag == 0u)
      {
        if(Isr_15us_Fire_Count != 0xFFFFu)
        {
          Isr_15us_Fire_Count++;
        }
      }
...
# 159 "../30_Bsw/Scheduler/Scheduler_Asil.c"
void __attribute__ ((interrupt_handler)) Isr_Call100us(void)
{
  ...
  if(0 == PSWReg_Rd0.B.PRS)
  {
    ...
    mg_vIsr_TimeMeasCalc(&Isr_TimeMeas,1,1,0);
    IOHWSF_ACCESSPROT_vSwitchToSafeISR();
   if(1 == PSWReg_Rd0.B.S)
    {
  HsfbApp_Call100us();
  ...
  if((3u == Pfm_Capture.Sts)
   ||(4u == Main_ResetCnt)
   ||(0u != TRUSTED_Mpu_Err))
  {
    __asm("disable");
    for(WdgStopTrigger = 0u; WdgStopTrigger < 1450000U ; WdgStopTrigger++)
    {
   __asm("nop");
    }
  ...
  {
    if((100u) > Isr_100us_Fire_Count)
    {
   if(Pfm_Capture.Sts == 15u && !Flag_WDIDis)
   {
    ...
    else if((100u) < Isr_100us_Fire_Count)
    {

   Pfm_Capture.Sts = 0xFFu;

    }
# 231 "../30_Bsw/Scheduler/Scheduler_Asil.c"
  }
   mg_vIsr_TimeMeasCalc(&Isr_TimeMeas,1,0,0);

  if (Pfm_flag == 0u)
  {
    if(Isr_100us_Fire_Count != 0xFFFFu)
    {
...
# 262 "../30_Bsw/Scheduler/Scheduler_Asil.c"
static void __attribute__((noinline)) mg_vASIL_1msTask(void)
{
...
# 310 "../30_Bsw/Scheduler/Scheduler_Asil.c"
void __attribute__ ((interrupt_handler)) Isr_Call1ms(void)
{
  ...
  if(0 == PSWReg_Rd0.B.PRS)
  {
     ...
     mg_vIsr_TimeMeasCalc(&Isr_TimeMeas,2,1,0);
  ...
  mpu_vSet_ActiveProtSet(1);
  if(1 == PSWReg_Rd1.B.PRS)
  {
...
# 351 "../30_Bsw/Scheduler/Scheduler_Asil.c"
  mpu_vSet_ActiveProtSet(2);

  if(2 == PSWReg_Rd2.B.PRS)
  {
  ...
  if(0 == PSWReg_Rd0.B.PRS)
  {
    ...
    {
      Trusted_UdsRstReq_Flag = 0;
      Uds_ASILTask();
    }
     mg_vIsr_TimeMeasCalc(&Isr_TimeMeas,2,0,0);
    if (Pfm_flag == 0u)
    {
      if(Isr_1ms_Fire_Count != 0xFFu)
      {
        Isr_1ms_Fire_Count++;
      }
    }
...
# 405 "../30_Bsw/Scheduler/Scheduler_Asil.c"
void __attribute__ ((interrupt_handler)) Isr_Call10ms(void)
{
  ...
  if(0 == PSWReg_Rd0.B.PRS)
  {
     ...
     mg_vIsr_TimeMeasCalc(&Isr_TimeMeas,3,1,0);
    ComServ_10msTask();
    Isr_AppStatus10ms();
    Isr_ErrorDis10ms();
    Isr_SafetyError10ms();
    ...
    if (Pfm_flag == 0u)
    {
      ...
      Timer_value = (*(volatile Ifx_STM_TIM1 *)0xF0000014u).U;
    }
    mg_vPfm_IsrCounterChk();
    mg_vIsr_TimeMeasCalc(&Isr_TimeMeas,3,0,0);
  }
...
# 454 "../30_Bsw/Scheduler/Scheduler_Asil.c"
static void mg_vPfm_IsrCounterChk(void)
{
  ...
  if (Pfm_flag == 0u)
  {
    ...
    if(Pfm_Capture.FailureCnt != 10u)
    {

      if ((Isr_15us_Fire_Count != 0xFFFFu) || (Isr_100us_Fire_Count != 0xFFFFu) || (Isr_1ms_Fire_Count != 0xFFu))
      {
        ...
        if (((400u < Pfm_Capture.Isr_15usCnt) && (935u > Pfm_Capture.Isr_15usCnt))
         && ((60u < Pfm_Capture.Isr_100usCnt) && (140u > Pfm_Capture.Isr_100usCnt))
         && ((6u < Pfm_Capture.Isr_1msCnt) && (14u > Pfm_Capture.Isr_1msCnt))
         && ((37500u < Pfm_Capture.TimerDiff_10ms) && (87500u > Pfm_Capture.TimerDiff_10ms)))
        {
          Pfm_Capture.Sts = 15u;
        }
        else
...
# 519 "../30_Bsw/Scheduler/Scheduler_Asil.c"
  }
  ...
  else if (Pfm_flag == 1u)
  {
    ...
    Pfm_Capture.Sts = 0u;
    Pfm_Capture.FailureCnt = 0u;
    Timer_value = (*(volatile Ifx_STM_TIM1 *)0xF0000014u).U;
    Isr_15us_Fire_Count = 0u;
    Isr_100us_Fire_Count = 0u;
    Isr_1ms_Fire_Count = 0u;
    Pfm_Capture.Isr_15usCnt = 0u;
    Pfm_Capture.Isr_100usCnt = 0u;
    Pfm_Capture.Isr_1msCnt = 0u;
  }

  if ((Pfm_Capture.Sts != 15u) && (Pfm_Capture.Sts != 3u))
  {
    if(Pfm_flag != 1u)
    {
...
# 563 "../30_Bsw/Scheduler/Scheduler_Asil.c"
static void mg_vIsr_TimeMeasCalc(ISR_S_TIMEMEAS *v,u16 num,bit sign,u16 tick)
{
 int i;
 ...
 v->IsrLog[1] = v->IsrLog[0];
  ...
  v->IsrLog[0] = (*(volatile Ifx_STM_TIM0 *)0xF0000010u).U;
...
# 630 "../30_Bsw/Scheduler/Scheduler_Asil.c"
static void Isr_AppStatus10ms(void)
{
 ...
 Isr_AppStatus.CpuTime = ((u16)(0.0105*(*(volatile Ifx_STM_TIM5 *)0xF0000024u).U) & 0x000F) | ((u16)Main_HwVer.Ver << 4);
 ...
 Isr_AppStatus.Topology = HsfbPwm_ToMor.TopologyOut;
    ...
    IsrTime15usAvr = 0.5*( Isr_TimeMeas.IsrTimeOut[0][0]
              + Isr_TimeMeas.IsrTimeOut[0][1]);
 IsrTime100usAvr = Isr_TimeMeas.IsrTimeOut[1][0];
...
# 727 "../30_Bsw/Scheduler/Scheduler_Asil.c"
...
# 747 "../30_Bsw/Scheduler/Scheduler_Asil.c"
static void Isr_ErrorDis10ms(void)
{
 ...
 {
  HsfbDiag_ErrMask.ErrMask3 = 24571U & (~(((u16)1 << 0)));
  Qspi_SBCError.all = 0;
 }
 else
 {
  HsfbDiag_ErrMask.ErrMask3 = 24571U;
 }
}
# 772 "../30_Bsw/Scheduler/Scheduler_Asil.c"
static void Isr_SafetyError10ms(void)
{
  SafetyError[0] = (Safety_CfgError.all != 0);
  SafetyError[1] = (Qspi_SBCError.all != 0);
  SafetyError[2] = (CanE2E.RxErrOut != 0);
  SafetyError[3] = 0;
  ...
  if((Qspi_SBCError.all)&&(QSPI_TEST_FINISHED == Qspi_StrtUpTst_Sts))
  {
    if(0x2000u != Qspi_SBCError.all&&0xFFFF)
    {
...
#pragma section
# 820 "../30_Bsw/Scheduler/Scheduler_Asil.c" 2
