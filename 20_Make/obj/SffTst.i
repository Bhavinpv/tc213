# 1 "../30_Bsw/MicroTestLib/Static/SffTst.c"
# 1 "S:\\20_Make//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../30_Bsw/MicroTestLib/Static/SffTst.c"
# 39 "../30_Bsw/MicroTestLib/Static/SffTst.c"
...
# 40 "../30_Bsw/MicroTestLib/Static/SffTst.c" 2
# 1 "../30_Bsw/MicroTestLib/Static/SffTst.h" 1
# 41 "../30_Bsw/MicroTestLib/Static/SffTst.h"
...
# 42 "../30_Bsw/MicroTestLib/Static/SffTst.h" 2
# 1 "../30_Bsw/STL_common/Sl_Timeout.h" 1
# 43 "../30_Bsw/MicroTestLib/Static/SffTst.h" 2
...
# 44 "../30_Bsw/MicroTestLib/Static/SffTst.h" 2
...
# 45 "../30_Bsw/MicroTestLib/Static/SffTst.h" 2
...
# 41 "../30_Bsw/MicroTestLib/Static/SffTst.c" 2
...
# 42 "../30_Bsw/MicroTestLib/Static/SffTst.c" 2
...
# 43 "../30_Bsw/MicroTestLib/Static/SffTst.c" 2
...
# 44 "../30_Bsw/MicroTestLib/Static/SffTst.c" 2
# 1 "../30_Bsw/STL_common/ChipId.h" 1
# 45 "../30_Bsw/MicroTestLib/Static/SffTst.c" 2
# 120 "../30_Bsw/MicroTestLib/Static/SffTst.c"
# 1 "../30_Bsw/STL_common/Ifx_MemMap.h" 1
# 2642 "../30_Bsw/STL_common/Ifx_MemMap.h"
#pragma section ".text.STL_ASIL_CODE" ax 4
# 121 "../30_Bsw/MicroTestLib/Static/SffTst.c" 2
...
# 221 "../30_Bsw/MicroTestLib/Static/SffTst.c"
...
{
  Sl_TstRsltType Result = (0x25010aU);
  Sl_TstRsltType TempResult = (0x25010aU);
  Smu_AlarmActionType BackupData;

  {if((ParamSetIndex) != 0U) { }}


  *TstSignature = (uint32)(__crc32((unsigned_int)((uint32)TEST_ID_SFF_TST),(unsigned_int)((uint32)TstSeed)));
...
# 301 "../30_Bsw/MicroTestLib/Static/SffTst.c"
static Sl_TstRsltType SffTst_lCheckPrerequisites(void)
{
  Sl_TstRsltType Result = (0x25010aU);
  uint32 AlarmStatus;
  ...
  else if (((uint32)(0x01U)) == (*(volatile Ifx_SMU_RMCTL *)0xF0036B00u).B.TE)
  {
    Result = (0x251401U);
  }
  else if (0U != Smu_GetAlarmStatus(((uint8)(3U)), &AlarmStatus))
  {
    Result = (0x25020eU);
  }

  else if (AlarmStatus & ((uint32)(0x01U) << ((uint8)(27U))))
  {
    Result = (0x25020dU);
  }
  else
...
# 365 "../30_Bsw/MicroTestLib/Static/SffTst.c"
static Sl_TstRsltType SffTst_lInit
(
  Smu_AlarmActionType* const BackupData,
  uint32* const TstSignature
)
{
  ...
  if (0U != Smu_GetAlarmAction(((uint8)(3U)),
                                 ((uint8)(27U)),
                                 BackupData,
                                 &FspActionDummy))
  {
    Result = (0x250210U);
    *BackupData = ((Smu_AlarmActionType)0xFFU);
  }
  else
  {
    if (0U != Smu_SetAlarmAction(((uint8)(3U)),
                                   ((uint8)(27U)),
    ...
    else
    {
      ...
      (*(volatile Ifx_SMU_RMSTS *)0xF0036B08u).U = (uint32)((uint8)(0x00U));
      (*(volatile Ifx_SMU_RMEF *)0xF0036B04u).U = (uint32)((uint8)(0x00U));
...
# 459 "../30_Bsw/MicroTestLib/Static/SffTst.c"
static Sl_TstRsltType SffTst_lTstExecute
(
  uint32* const TstSignature
)
{
  Sl_TstRsltType Result = (0x25010aU);
  uint32 AlarmStatus = (uint32)((uint8)(0x00U));
  uint8 RmTimeout = ((uint8)(0x00U));
  uint32 SffRmActiveBits = ((uint32)((uint32)(0x07U)));
  uint32 SffRmErrorBits = ((uint8)(0x00U));
# 477 "../30_Bsw/MicroTestLib/Static/SffTst.c"
  Mcal_ResetSafetyENDINIT_Timed(((uint32)22960U));
  (*(volatile Ifx_SMU_KEYS *)0xF0036834u).U = ((uint32)(0xBCU));
  (*(volatile Ifx_SMU_RMCTL *)0xF0036B00u).U = ((uint32)(0x01U));
  (*(volatile Ifx_SMU_KEYS *)0xF0036834u).U = ((uint32)(0x00U));
  Mcal_SetSafetyENDINIT_Timed();
# 503 "../30_Bsw/MicroTestLib/Static/SffTst.c"
  while ((SffRmActiveBits != ((*(volatile Ifx_SMU_RMSTS *)0xF0036B08u).U & SffRmActiveBits))
                                            && (RmTimeout <= ((uint8)(0x80U))))
  {
    RmTimeout++;
  }

  if (RmTimeout >= ((uint8)(0x80U)))
  {
  ...
  {
    SffRmErrorBits = SffRmActiveBits & ((*(volatile Ifx_SMU_RMEF *)0xF0036B04u).U);
 if (((uint8)(0x00U)) != SffRmErrorBits)
    {
    ...
    else
    {
      ...
      {
        if (((uint32)(0x01U) << ((uint8)(27U))) !=
                                    (AlarmStatus & ((uint32)(0x01U) << ((uint8)(27U)))))
        {
  ...
  *TstSignature = (uint32)(__crc32((unsigned_int)(*TstSignature),(unsigned_int)((uint32)(AlarmStatus & ((uint32)(0x01U) << ((uint8)(27U)))))))
                                                                             ;


  return (Result);
}
# 618 "../30_Bsw/MicroTestLib/Static/SffTst.c"
static Sl_TstRsltType SffTst_lRestore
(
  const Smu_AlarmActionType* const BackupData,
  uint32* const TstSignature
)
{
  ...
  Mcal_ResetSafetyENDINIT_Timed(((uint32)22960U));
  (*(volatile Ifx_SMU_KEYS *)0xF0036834u).U = ((uint32)(0xBCU));
  (*(volatile Ifx_SMU_RMCTL *)0xF0036B00u).U = ((uint32)(0x00U));
  (*(volatile Ifx_SMU_KEYS *)0xF0036834u).U = ((uint32)(0x00U));
  Mcal_SetSafetyENDINIT_Timed();
  ...
  else if (0U != Smu_SetAlarmAction(((uint8)(3U)),
                                      ((uint8)(27U)),
                                      (*BackupData)))
  {
    Result = (0x250211U);
...
# 2654 "../30_Bsw/STL_common/Ifx_MemMap.h"
#pragma section
# 665 "../30_Bsw/MicroTestLib/Static/SffTst.c" 2
