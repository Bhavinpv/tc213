# 1 "../30_Bsw/MicroTestLib/Static/SfrCmpTst.c"
# 1 "S:\\20_Make//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../30_Bsw/MicroTestLib/Static/SfrCmpTst.c"
# 39 "../30_Bsw/MicroTestLib/Static/SfrCmpTst.c"
...
# 40 "../30_Bsw/MicroTestLib/Static/SfrCmpTst.c" 2
...
# 45 "../30_Bsw/MicroTestLib/Static/SfrCmpTst.h" 2
...
# 46 "../30_Bsw/MicroTestLib/Static/SfrCmpTst.h" 2
...
# 41 "../30_Bsw/MicroTestLib/Static/SfrCmpTst.c" 2


# 1 "../30_Bsw/STL_common/Ifx_MemMap.h" 1
# 2642 "../30_Bsw/STL_common/Ifx_MemMap.h"
#pragma section ".text.STL_ASIL_CODE" ax 4
# 44 "../30_Bsw/MicroTestLib/Static/SfrCmpTst.c" 2
# 68 "../30_Bsw/MicroTestLib/Static/SfrCmpTst.c"
static Sl_TstRsltType SfrTst_lSfrCmpTst
(
 const Sl_ParamSetType ParamSetIndex,
 uint32* const TstSignature
);
# 128 "../30_Bsw/MicroTestLib/Static/SfrCmpTst.c"
...
{
  Sl_TstRsltType Result = (0x2010aU);


  *TstSignature = (uint32)(__crc32((unsigned_int)(TEST_ID_SFR_CMP_TST),(unsigned_int)(TstSeed)));


  if (ParamSetIndex > (( 2U ) - 1U))
  {
...
# 192 "../30_Bsw/MicroTestLib/Static/SfrCmpTst.c"
static Sl_TstRsltType SfrTst_lSfrCmpTst
(
 const Sl_ParamSetType ParamSetIndex,
 uint32* const TstSignature
)
{
  ...
  if (AllAvailableSets[ParamSetIndex].NumberOfRegisters2Test > (112U))
  {
  ...
  else
  {
    ...
    if ((AllAvailableSets[ParamSetIndex].RegisterSet2Test[Index].RegisterBitWidth) == ((uint32)1U ))
    {
    CurrentRegValue =
    ...
    CurrentRegValue =
      ...
      & Mask))
      {
        ...
        ResultReg = ResultReg | (((uint32)0x5U) << ShiftBy);

        if(ResRegReset == 6U)
        {

          *TstSignature = (uint32)(__crc32((unsigned_int)(*TstSignature),(unsigned_int)(ResultReg)));
          ShiftBy = 0x0U;
          GroupCounter++;
      ...
      else
      {
        ...
        ResultReg = ResultReg | (((uint32)0x2U) << ShiftBy);

        Result = (Sl_TstRsltType)
                   (( (Sl_TstRsltType)(((((uint32)(TEST_ID_SFR_CMP_TST)) & (uint32)0xFFFF) << 16U) | ((((uint32)(((GroupCounter) + 0x11U))) & (uint32)0xFF) << 8U) | ((((uint32)((((uint32)ResRegReset) + 0x01U))) & (uint32)0xFF))) ));
...
# 2654 "../30_Bsw/STL_common/Ifx_MemMap.h"
#pragma section
# 290 "../30_Bsw/MicroTestLib/Static/SfrCmpTst.c" 2
