# 1 "../30_Bsw/MicroTestLib/Static/SmuTst.c"
# 1 "S:\\20_Make//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../30_Bsw/MicroTestLib/Static/SmuTst.c"
# 39 "../30_Bsw/MicroTestLib/Static/SmuTst.c"
# 1 "../30_Bsw/MicroTestLib/Static/SmuTst.h" 1
# 41 "../30_Bsw/MicroTestLib/Static/SmuTst.h"
...
# 42 "../30_Bsw/MicroTestLib/Static/SmuTst.h" 2
...
# 43 "../30_Bsw/MicroTestLib/Static/SmuTst.h" 2
...
# 44 "../30_Bsw/MicroTestLib/Static/SmuTst.h" 2
...
# 40 "../30_Bsw/MicroTestLib/Static/SmuTst.c" 2
...
# 41 "../30_Bsw/MicroTestLib/Static/SmuTst.c" 2
...
# 42 "../30_Bsw/MicroTestLib/Static/SmuTst.c" 2
...
# 43 "../30_Bsw/MicroTestLib/Static/SmuTst.c" 2
...
# 44 "../30_Bsw/MicroTestLib/Static/SmuTst.c" 2
# 1 "../30_Bsw/STL_common/ChipId.h" 1
# 45 "../30_Bsw/MicroTestLib/Static/SmuTst.c" 2
...
# 46 "../30_Bsw/MicroTestLib/Static/SmuTst.c" 2
# 1 "../30_Bsw/Common/TC21x/IfxSmu_bf.h" 1
# 47 "../30_Bsw/MicroTestLib/Static/SmuTst.c" 2
...
# 48 "../30_Bsw/MicroTestLib/Static/SmuTst.c" 2
# 1 "../30_Bsw/Common/TC21x/IfxScu_bf.h" 1
# 49 "../30_Bsw/MicroTestLib/Static/SmuTst.c" 2
...
# 50 "../30_Bsw/MicroTestLib/Static/SmuTst.c" 2
# 1 "../30_Bsw/Common/TC21x/IfxSrc_bf.h" 1
# 51 "../30_Bsw/MicroTestLib/Static/SmuTst.c" 2
...
# 52 "../30_Bsw/MicroTestLib/Static/SmuTst.c" 2
# 194 "../30_Bsw/MicroTestLib/Static/SmuTst.c"
# 1 "../30_Bsw/STL_common/Ifx_MemMap.h" 1
# 3321 "../30_Bsw/STL_common/Ifx_MemMap.h"
#pragma section ".data.STL_RAM_8BIT" aw 1
# 195 "../30_Bsw/MicroTestLib/Static/SmuTst.c" 2


static uint8 SmuTst_NmiTrapCount[(1U)];
static uint8 SmuTst_ExpectedTrap;

# 1 "../30_Bsw/STL_common/Ifx_MemMap.h" 1
# 3333 "../30_Bsw/STL_common/Ifx_MemMap.h"
#pragma section
# 201 "../30_Bsw/MicroTestLib/Static/SmuTst.c" 2
...
typedef struct SmuTst_Rt_BkupDataType
{
  ...
  Smu_AlarmActionType AlmActionBackup[(6U)];

  Std_ReturnType AlmActionBackupResult[(6U)];
...
# 2642 "../30_Bsw/STL_common/Ifx_MemMap.h"
#pragma section ".text.STL_ASIL_CODE" ax 4
# 239 "../30_Bsw/MicroTestLib/Static/SmuTst.c" 2
...
static Sl_TstRsltType SmuTst_lRtInitRtRegs(const uint32 SmuRtcValue);

static boolean SmuTst_lNmiTrapHandler (const uint32 trapID);
# 328 "../30_Bsw/MicroTestLib/Static/SmuTst.c"
...
{
  Sl_TstRsltType Result = (Sl_TstRsltType)(0x14010aU);
  Smu_AlarmActionType AlarmActionBkup = (Smu_AlarmActionType)(0x00U);
  Smu_FSPActionType FspActionDummy = (Smu_FSPActionType)(0x00U);
  uint32 AlarmStatus = (0x00U);
  uint8 TrapDisSmutBackup = (uint8)(0x00U);
  volatile uint8 TrapDelayCount = 0x15U;


  {if((ParamSetIndex) != 0U) { }}


  *TstSignature = (uint32)(__crc32((unsigned_int)((uint32)TEST_ID_SMU_TST_NMI),(unsigned_int)((uint32)TstSeed)));


  if (((Smu_StateType)1) != Smu_GetSmuState())
  {

    Result = (Sl_TstRsltType)(0x14020cU);
  }
  else if (0U != Smu_GetAlarmStatus((5U), &AlarmStatus))
  {

    Result = (Sl_TstRsltType)(0x14020eU);
  }
  else if (AlarmStatus & ((uint32)0x01U << (2U)))
  {

    Result = (Sl_TstRsltType)(0x14020dU);
  }
  else
  {

    SmuTst_ExpectedTrap = (uint8)(0U);
# 379 "../30_Bsw/MicroTestLib/Static/SmuTst.c"
    Result = (Sl_TstRsltType)(0x140103U);
    if (( (TRAP_ErrorType)0x00000000) ==
             TRAP_RegisterTrapHandlerAllCores((7U),
                                              &SmuTst_lNmiTrapHandler))
    {


      TrapDisSmutBackup = (uint8)(*(volatile Ifx_SCU_TRAPDIS *)0xF0036130u).B.SMUT;


      if (0U != Smu_GetAlarmAction((5U),
                                     (2U),
                                     &AlarmActionBkup,
                                     &FspActionDummy))
      {

        Result = (Sl_TstRsltType)(0x140210U);
      }

      else if (0U != Smu_SetAlarmAction((5U), (2U),
                                                      ((Smu_AlarmActionType)0x05U)))
      {

        Result = (Sl_TstRsltType)(0x140211U);
      }
      else
      {

        (*(volatile Ifx_SCU_TRAPCLR *)0xF003612Cu).B.SMUT = (0x01U);

        Mcal_ResetENDINIT();

        (*(volatile Ifx_SCU_TRAPDIS *)0xF0036130u).B.SMUT = (0x00U);
        Mcal_SetENDINIT();


        SmuTst_NmiTrapCount[(0x00U)] = (uint8)(0x00U);
# 424 "../30_Bsw/MicroTestLib/Static/SmuTst.c"
        SmuTst_ExpectedTrap = (7U);


        Result = (Sl_TstRsltType)(0x140201U);


        if (0U == Smu_SetAlarmStatus((5U), (2U)))
        {

          Result = (Sl_TstRsltType)(0x140102U);

          _dsync();


          while (TrapDelayCount > (uint8)(0x00U))
          {
            TrapDelayCount = TrapDelayCount - (uint8)(0x01U);
          }



          if (((0x01U) == (*(volatile Ifx_SCU_TRAPSTAT *)0xF0036124u).B.SMUT) &&
              (((0x01U) == SmuTst_NmiTrapCount[(0x00U)])
          ...
          {
            Result = (Sl_TstRsltType)(0x1401ffU);
          }
          ...
          if (0U != Smu_ClearAlarmStatus((5U), (2U)))
          {

            Result = (Sl_TstRsltType)(0x14020fU);
          }
        }


        if (0U != Smu_SetAlarmAction((5U), (2U),
                                                        AlarmActionBkup))
        {
      ...
      if (( (TRAP_ErrorType)0x00000000) !=
                  TRAP_UnregisterTrapHandlerAllCores((7U)))
      {

        Result = (Sl_TstRsltType)(0x140104U);
      }
      ...
      (*(volatile Ifx_SCU_TRAPDIS *)0xF0036130u).B.SMUT = TrapDisSmutBackup;
      Mcal_SetENDINIT();
    }
  }
...
# 551 "../30_Bsw/MicroTestLib/Static/SmuTst.c"
...
{
  Sl_TstRsltType Result = (Sl_TstRsltType)(0x12010aU);
  Smu_AlarmActionType AlarmActionBkup = (Smu_AlarmActionType)(0x00U);
  Smu_FSPActionType FspActionDummy = (Smu_FSPActionType)(0x00U);
  uint8 CoreId = (uint8)(0x00U);
  uint32 SrcSmu0Backup = (0x00U);
  uint32 SmuAgcBackup = (0x00U);
  uint32 AlarmStatus = (0x00U);
  ...
  *TstSignature = (uint32)(__crc32((unsigned_int)((uint32)TEST_ID_SMU_TST_IRQ),(unsigned_int)((uint32)TstSeed)));


  if (((Smu_StateType)1) != Smu_GetSmuState())
  {

    Result = (Sl_TstRsltType)(0x12020cU);
  }
  else if (0U != Smu_GetAlarmStatus((5U), &AlarmStatus))
  {

    Result = (Sl_TstRsltType)(0x12020eU);
  }
  else if (AlarmStatus & ((uint32)0x01U << (3U)))
  {

    Result = (Sl_TstRsltType)(0x12020dU);
  }
  else
  {
                                   ...
                                   &FspActionDummy))
    {
      ...
      Result = (Sl_TstRsltType)(0x120210U);
    }
    else
    {

      SmuAgcBackup = (*(volatile Ifx_SMU_AGC *)0xF003682Cu).U;


      CoreId = (uint8)((__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "(0xFE1C)" : "=d" (__res) :: "memory"); __res; })));


      SrcSmu0Backup = ((*(volatile Ifx_SRC_SRCR *)0xF0038D10u)).U;
      ...
      ((*(volatile Ifx_SRC_SRCR *)0xF0038D10u)).U =
        (unsigned_int)(((((*(volatile Ifx_SRC_SRCR *)0xF0038D10u)).U) &
        (~(((uint32)(0x1u) << (uint8)(10u)) |
        ((uint32)(0xffu) << (uint8)(0u)) |
        ((uint32)(0x1u) << (uint8)((uint8)(11u))) |
        ((uint32)(0x1U) << (uint8)(31U))))) |
        (((uint32)CoreId << (uint8)((uint8)(11u))) |
        ((uint32)(1U) << (uint8)(25u))));
      ...
      (*(volatile Ifx_SMU_AGC *)0xF003682Cu).U = (0x00000001U);
      ...
      Result = (Sl_TstRsltType)(0x120211U);


      if (0U == Smu_SetAlarmAction((5U), (3U),
                                                      ((Smu_AlarmActionType)0x02U)))
      {

        Result = (Sl_TstRsltType)(0x120201U);


        if (0U == Smu_SetAlarmStatus((5U), (3U)))
        {

          Result = (Sl_TstRsltType)(0x120102U);


          if (((*(volatile Ifx_SRC_SRCR *)0xF0038D10u)).B.SRR == (1U))
          {



            ((*(volatile Ifx_SRC_SRCR *)0xF0038D10u)).U = (unsigned_int)(((((*(volatile Ifx_SRC_SRCR *)0xF0038D10u)).U) |
                         ((uint32)(1U) <<
                                    (uint8)(25u))) &
                         (~((uint32)(0x1U) <<
                                    (uint8)(31U))));

            Result = (Sl_TstRsltType)(0x1201ffU);
          }


          if (0U != Smu_ClearAlarmStatus((5U), (3U)))
          {

            Result = (Sl_TstRsltType)(0x12020fU);
          }
        }
      ...
      ((*(volatile Ifx_SRC_SRCR *)0xF0038D10u)).U = SrcSmu0Backup;


      Mcal_ResetSafetyENDINIT_Timed(((uint32)22960U));

      (*(volatile Ifx_SMU_KEYS *)0xF0036834u).U = (unsigned_int)(((*(volatile Ifx_SMU_KEYS *)0xF0036834u).U & (unsigned_int)(0xFFFFFF00U)) | ((unsigned_int)0xBCU));
      (*(volatile Ifx_SMU_AGC *)0xF003682Cu).U = SmuAgcBackup;
...
# 773 "../30_Bsw/MicroTestLib/Static/SmuTst.c"
...
{
  Sl_TstRsltType Result = (Sl_TstRsltType)(0x11010aU);
  Sl_TstRsltType TempResult = (Sl_TstRsltType)(0x11010aU);
  uint32 AlarmStatusGrp2 = (0x00U);
  uint32 AlarmStatusGrp5 = (0x00U);
  Std_ReturnType Prerequisites = (Std_ReturnType)1U;
  SmuTst_Rt_BkupDataType RtBkupData;
  uint32 TempRecTimeStatus;


  const SmuTst_Rt_AlarmInfoType kRtAlarmInfo[(6U)] =
                    {
                      { (5U), (0U), (0x00U)},
                      { (5U), (1U), (0x00U)},
                      { (5U), (2U), (0x00U)},
  ...
  *TstSignature = (uint32)(__crc32((unsigned_int)((uint32)TEST_ID_SMU_TST_RT),(unsigned_int)((uint32)TstSeed)));


  if (((Smu_StateType)1) != Smu_GetSmuState())
  {

    Result = (Sl_TstRsltType)(0x11020cU);
  }
  else
  {

    Result = (Sl_TstRsltType)(0x11020eU);
    if (0U == Smu_GetAlarmStatus((2U), &AlarmStatusGrp2))
    {

      Result = (Sl_TstRsltType)(0x11020dU);
      if ((0x00U) == (AlarmStatusGrp2 & ((uint32)(((uint32)0x01U << ((uint8)(29U)))) | (uint32)(((uint32)0x01U << ((uint8)(30U)))))))
      {

        Result = (Sl_TstRsltType)(0x11020eU);
        if (0U == Smu_GetAlarmStatus((5U), &AlarmStatusGrp5))
        {

          Result = (Sl_TstRsltType)(0x11020dU);
          if ((0x00U) == (AlarmStatusGrp5 & (((uint32)0x01U << (0U)) | ((uint32)0x01U << (1U)) | ((uint32)0x01U << (2U)) | ((uint32)0x01U << (3U)))))
          {
            Prerequisites = (Std_ReturnType)0U;
          }
        }
      }
    }
    ...
    {
    TempResult = (Sl_TstRsltType) (0x110102U);
    }
...
# 929 "../30_Bsw/MicroTestLib/Static/SmuTst.c"
static Sl_TstRsltType SmuTst_lRtInit
(
  SmuTst_Rt_BkupDataType * const RtBkupData,
  const SmuTst_Rt_AlarmInfoType *RtAlarmInfo,
...
{
  Sl_TstRsltType Result = (Sl_TstRsltType)(0x11010aU);
  Std_ReturnType SmuResult = (Std_ReturnType)1U;
  uint8 SmuAlarmId = (uint8)(0x00U);
  Smu_FSPActionType SmuAlarmFspAction = (Smu_FSPActionType)(0x00U);


  RtBkupData->SmuRtcBackup = (*(volatile Ifx_SMU_RTC *)0xF0036830u).U;
  RtBkupData->SmuRtac0Backup = (*(volatile Ifx_SMU_RTAC0 *)0xF0036860u).U;
  RtBkupData->SmuRtac1Backup = (*(volatile Ifx_SMU_RTAC1 *)0xF0036864u).U;
  ...
  do
  {
    ...
    RtBkupData->AlmActionBackupResult[SmuAlarmId] = (Std_ReturnType)1U;


    if (0U != Smu_GetAlarmAction(RtAlarmInfo[SmuAlarmId].AlmGrp,
                                   RtAlarmInfo[SmuAlarmId].AlmId,
                                   &(RtBkupData->AlmActionBackup[SmuAlarmId]),
                                   &SmuAlarmFspAction))
    {
      SmuResult = (Std_ReturnType)1U;


      Result = (Sl_TstRsltType)(0x110210U);
    }

    else if (0U != Smu_SetAlarmAction(RtAlarmInfo[SmuAlarmId].AlmGrp,
                                       RtAlarmInfo[SmuAlarmId].AlmId,
                                       ((Smu_AlarmActionType)0x00U)))
    {
      ...
      RtBkupData->AlmActionBackupResult[SmuAlarmId] = (Std_ReturnType)0U;


      Result = (Sl_TstRsltType)(0x110211U);





      if (SmuAlarmId < (uint8)((6U) - (0x01U)))
      {
        SmuAlarmId = SmuAlarmId + (uint8)(0x01U);
    ...
    else
    {
      ...
      SmuAlarmId++;
      SmuResult = (Std_ReturnType)0U;
      Result = (Sl_TstRsltType)(0x1101ffU);
    }
  }while((SmuResult == 0U) && (SmuAlarmId < (6U)));



  *TstSignature = (uint32)(__crc32((unsigned_int)(*TstSignature),(unsigned_int)((uint32)SmuResult)));

  return Result;
}
# 1038 "../30_Bsw/MicroTestLib/Static/SmuTst.c"
static Sl_TstRsltType SmuTst_lRtRestore
(
 const SmuTst_Rt_BkupDataType * const RtBkupData,
 const SmuTst_Rt_AlarmInfoType *RtAlarmInfo,
...
)
{
  ...
  (*(volatile Ifx_SMU_KEYS *)0xF0036834u).U = (unsigned_int)(((*(volatile Ifx_SMU_KEYS *)0xF0036834u).U & (unsigned_int)(0xFFFFFF00U)) | ((unsigned_int)0xBCU));
  (*(volatile Ifx_SMU_RTC *)0xF0036830u).U = RtBkupData->SmuRtcBackup;
  (*(volatile Ifx_SMU_RTAC0 *)0xF0036860u).U = RtBkupData->SmuRtac0Backup;
  (*(volatile Ifx_SMU_RTAC1 *)0xF0036864u).U = RtBkupData->SmuRtac1Backup;

  (*(volatile Ifx_SMU_KEYS *)0xF0036834u).U = (uint32)(0U);

  (*(volatile Ifx_SMU_STS *)0xF0036824u).U = (0x00U);
  ...
  do
  {
    ...
    if (0U == (RtBkupData->AlmActionBackupResult[SmuAlarmId]))
    {

      if (0U != Smu_SetAlarmAction(RtAlarmInfo[SmuAlarmId].AlmGrp,
                                    RtAlarmInfo[SmuAlarmId].AlmId,
                                    RtBkupData->AlmActionBackup[SmuAlarmId]))
      {
        SmuResult = (Std_ReturnType)1U;
    ...
    SmuAlarmId++;
  }while((0U == SmuResult) && (SmuAlarmId < (6U)));
...
# 1137 "../30_Bsw/MicroTestLib/Static/SmuTst.c"
static Sl_TstRsltType SmuTst_lRtTimeoutTst
(
  uint32* const TstSignature
)
{
  Sl_TstRsltType Result = (Sl_TstRsltType)(0x11010aU);
  uint32 AlarmStatus = (0x00U);
  uint32 Timeout = 0x63FU;
  uint8 RtStatus0 = (uint8)(0x00U);
  uint8 RtStatus1 = (uint8)(0x00U);
  Std_ReturnType TempResult1 = (Std_ReturnType)1U;
  Std_ReturnType TempResult2 = (Std_ReturnType)1U;
  Std_ReturnType TempResult3 = (Std_ReturnType)1U;


  Result= SmuTst_lRtInitRtRegs((((uint32)0x01U << (uint8)(0u)) | ((uint32)0x01U << (uint8)(1u)) | ((uint32)0x13FU << (uint8)(8u))));
  if(Result == (0x1101ffU))
  {

  Result = (Sl_TstRsltType)(0x110201U);


  if (0U == Smu_SetAlarmStatus((5U), (0U)))
  {

    RtStatus0 = (uint8)(*(volatile Ifx_SMU_STS *)0xF0036824u).B.RTS0;
    RtStatus1 = (uint8)(*(volatile Ifx_SMU_STS *)0xF0036824u).B.RTS1;



    Result = (Sl_TstRsltType)(0x110102U);


    if (((0x01U) == RtStatus0) && ((0x01U) == RtStatus1))
    {


      while (Timeout > (0x00U))
      {
        Timeout = Timeout - (0x01U);

        if (0U != Smu_GetAlarmStatus((2U), &AlarmStatus))
        {
        ...
        {
          if (((uint32)(((uint32)0x01U << ((uint8)(29U)))) | (uint32)(((uint32)0x01U << ((uint8)(30U))))) != ((uint32)AlarmStatus & ((uint32)(((uint32)0x01U << ((uint8)(29U)))) | (uint32)(((uint32)0x01U << ((uint8)(30U)))))))
          {


            Result = (Sl_TstRsltType)(0x110103U);
          }
          else
          {
    ...
    TempResult1 = Smu_ClearAlarmStatus((5U), (0U));
    TempResult2 =
            Smu_ClearAlarmStatus(((uint8)(2U)), ((uint8)(29U)));
    TempResult3 =
            Smu_ClearAlarmStatus(((uint8)(2U)), ((uint8)(30U)));

    if ((0U != TempResult1) || (0U != TempResult2) || (0U != TempResult3))
    {

      Result = (Sl_TstRsltType)(0x11020fU);
    }
  }
  }


  *TstSignature = (uint32)(__crc32((unsigned_int)(*TstSignature),(unsigned_int)((uint32)((uint32)AlarmStatus & ((uint32)(((uint32)0x01U << ((uint8)(29U)))) | (uint32)(((uint32)0x01U << ((uint8)(30U)))))))))
                                                                            ;

  return Result;
}
# 1271 "../30_Bsw/MicroTestLib/Static/SmuTst.c"
static Sl_TstRsltType SmuTst_lRtStopTst
(
  uint32* const TstSignature
)
{
  ...
  Result = SmuTst_lRtInitRtRegs((((uint32)0x01U << (uint8)(0u)) | ((uint32)0x01U << (uint8)(1u)) | ((uint32)0xFFFFFFU << (uint8)(8u))));
  if(Result == (0x1101ffU))
  {
  Result = (Sl_TstRsltType)(0x110201U);


  if (0U == Smu_SetAlarmStatus((5U), (1U)))
  {
    ...
    Result = (Sl_TstRsltType)(0x110104U);


    if (((0x01U) == RtStatus0) && ((0x01U) == RtStatus1))
    {

      Result = (Sl_TstRsltType)(0x110105U);


      TempResult1 = Smu_RTStop((0x0U));
      TempResult2 = Smu_RTStop((0x1U));


      if ((0U == TempResult1) && (0U == TempResult2))
      {
        ...
        Result = (Sl_TstRsltType)(0x110107U);


        if (((0x00U) == RtStatus0) && ((0x00U) == RtStatus1))
        {
          ...
          while (Timeout > (0x00U))
          {
            ...
            else
            {
              ...
              if ((0x00U) != (AlarmStatus & ((uint32)(((uint32)0x01U << ((uint8)(29U)))) | (uint32)(((uint32)0x01U << ((uint8)(30U)))))))
              {


                Result = (Sl_TstRsltType)(0x110106U);
    ...
    if (0U != Smu_ClearAlarmStatus((5U), (1U)))
    {
...
# 1416 "../30_Bsw/MicroTestLib/Static/SmuTst.c"
static Sl_TstRsltType SmuTst_lRtMissedEventTst
(
  uint32* const TstSignature
)
{
  Sl_TstRsltType Result = (Sl_TstRsltType)(0x11010aU);
  uint8 TempRt0 = (uint8)(0x00U);
  uint8 TempRt1 = (uint8)(0x00U);
  uint8 MissedEvtStatus0 = (uint8)(0x00U);
  uint8 MissedEvtStatus1 = (uint8)(0x00U);
  Std_ReturnType TempResult1 = (Std_ReturnType)1U;
  Std_ReturnType TempResult2 = (Std_ReturnType)1U;
  ...
  if (0U == Smu_SetAlarmStatus((5U), (2U)))
  {
    ...
    TempRt0 = (uint8)(*(volatile Ifx_SMU_STS *)0xF0036824u).B.RTS0;
    TempRt1 = (uint8)(*(volatile Ifx_SMU_STS *)0xF0036824u).B.RTS1;



    Result = (Sl_TstRsltType)(0x110108U);


    if (((0x01U) == TempRt0) && ((0x01U) == TempRt1))
    {
      ...
      if (0U == Smu_SetAlarmStatus((5U), (3U)))
      {
        ...
        MissedEvtStatus0 = (uint8)(*(volatile Ifx_SMU_STS *)0xF0036824u).B.RTME0;
        MissedEvtStatus1 = (uint8)(*(volatile Ifx_SMU_STS *)0xF0036824u).B.RTME1;



        if (((0x01U) == MissedEvtStatus0) &&
                                            ((0x01U) == MissedEvtStatus1))
        {
          Result = (Sl_TstRsltType)(0x1101ffU);
        }
        else
        {
          ...
          Result = (Sl_TstRsltType)(0x110109U);
        }


        TempResult1 = Smu_ClearAlarmStatus((5U), (3U));
        if (0U != TempResult1)
        {
      ...
      if ((0U != TempResult1) || (0U != TempResult2))
      {
        ...
        Result = (Sl_TstRsltType)(0x11010bU);
      }
    }


    TempResult1 = Smu_ClearAlarmStatus((5U), (2U));
    if (0U != TempResult1)
    {
  ...
  *TstSignature = (uint32)(__crc32((unsigned_int)(*TstSignature),(unsigned_int)(((uint32)MissedEvtStatus0 & (uint32)MissedEvtStatus1))))
                                                                              ;

  return Result;
}
# 1535 "../30_Bsw/MicroTestLib/Static/SmuTst.c"
static Sl_TstRsltType SmuTst_lRtInitRtRegs(const uint32 SmuRtcValue)
{
  Sl_TstRsltType Result = (Sl_TstRsltType)(0x110102U);
  uint32 TempRecTimeStatus;
  ...
  (*(volatile Ifx_SMU_RTC *)0xF0036830u).U = SmuRtcValue;
  (*(volatile Ifx_SMU_RTAC0 *)0xF0036860u).U = (((uint32)((5U)) << (uint8)(0u)) | ((uint32)((0U)) << (uint8)(3u)) | ((uint32)((5U)) << (uint8)(8u)) | ((uint32)((1U)) << (uint8)(11u)) | ((uint32)((5U)) << (uint8)(16u)) | ((uint32)((2U)) << (uint8)(19u)) | ((uint32)((5U)) << (uint8)(24u)) | ((uint32)((3U)) << (uint8)(27u)));
  (*(volatile Ifx_SMU_RTAC1 *)0xF0036864u).U = (((uint32)((5U)) << (uint8)(0u)) | ((uint32)((0U)) << (uint8)(3u)) | ((uint32)((5U)) << (uint8)(8u)) | ((uint32)((1U)) << (uint8)(11u)) | ((uint32)((5U)) << (uint8)(16u)) | ((uint32)((2U)) << (uint8)(19u)) | ((uint32)((5U)) << (uint8)(24u)) | ((uint32)((3U)) << (uint8)(27u)));
...
# 1584 "../30_Bsw/MicroTestLib/Static/SmuTst.c"
static boolean SmuTst_lNmiTrapHandler (const uint32 trapID)
{
  uint8 CoreId = (uint8)(0x00U);
  ...
  if (SmuTst_ExpectedTrap == (7U))
  {

    SmuTst_NmiTrapCount[CoreId] = SmuTst_NmiTrapCount[CoreId] + (0x01U);
...
# 2654 "../30_Bsw/STL_common/Ifx_MemMap.h"
#pragma section
# 1610 "../30_Bsw/MicroTestLib/Static/SmuTst.c" 2
