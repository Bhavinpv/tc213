# 1 "../30_Bsw/TstM/Static/TstM.c"
# 1 "S:\\20_Make//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../30_Bsw/TstM/Static/TstM.c"
# 46 "../30_Bsw/TstM/Static/TstM.c"
...
# 47 "../30_Bsw/TstM/Static/TstM.c" 2
...
# 40 "../30_Bsw/MicroTestLib/Static/SriTst.h"
...
# 48 "../30_Bsw/TstM/Static/TstM.c" 2
...
# 49 "../30_Bsw/TstM/Static/TstM.c" 2
# 94 "../30_Bsw/TstM/Static/TstM.c"
# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 36 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".bss.MPU_ASIL_VAR_NOINIT" awB 8
# 95 "../30_Bsw/TstM/Static/TstM.c" 2
Sl_TstRsltType TstM_TestResults[(21U)];

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 49 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 98 "../30_Bsw/TstM/Static/TstM.c" 2


# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 61 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".rodata.MPU_ASIL_CONST" a
# 101 "../30_Bsw/TstM/Static/TstM.c" 2
extern const uint32 TstM_ExpTestSignature[(21U)];

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 74 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 104 "../30_Bsw/TstM/Static/TstM.c" 2


# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 36 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".bss.MPU_ASIL_VAR_NOINIT" awB 8
# 107 "../30_Bsw/TstM/Static/TstM.c" 2
uint32 TstM_TestSignatures[(21U)];

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 49 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 110 "../30_Bsw/TstM/Static/TstM.c" 2
# 119 "../30_Bsw/TstM/Static/TstM.c"
# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 120 "../30_Bsw/TstM/Static/TstM.c" 2
# 142 "../30_Bsw/TstM/Static/TstM.c"
void TstM_Init(void)
{
...
void TstM_PreRunTst(uint8 GroupIndex)
{
  ...
  Result = Sl_ExecPreRunTst((5U), GroupIndex, TstM_TestSignatures, TstM_TestResults);
  if (0U != Result)
  {
  ...
  switch(GroupIndex)
  {
    case(((uint8)0)):
    {
      TstIdxStart = TSTM_PRERUN_TRAP;
      TstIdxEnd = TSTM_PRERUN_REG_ACC_PROT;
      break;
    }
    case(((uint8)1)):
    {
      TstIdxStart = TSTM_PRERUN_REG_ACC_PROT;
      TstIdxEnd = TSTM_PRERUN_IR;
      break;
    }
    case(((uint8)2)):
    {
      TstIdxStart = TSTM_PRERUN_IR;
      TstIdxEnd = TSTM_PRERUN_LOCKSTEP;
      break;
    }
    case(((uint8)3)):
    {
      TstIdxStart = TSTM_PRERUN_LOCKSTEP;
      TstIdxEnd = TSTM_PRERUN_LOCKSTEP + 1;
      break;
    }
  }
...
# 262 "../30_Bsw/TstM/Static/TstM.c"
void TstM_InvalidateData(void)
{
  Sl_TstIndexType TstIdx;

  for (TstIdx = 0U; TstIdx < (21U); TstIdx++)
  {
    TstM_TestResults[TstIdx] = ((Sl_TstRsltType)0U);
    TstM_TestSignatures[TstIdx] = 0;
  }
}
# 300 "../30_Bsw/TstM/Static/TstM.c"
void TstM_Run(void)
{
  Std_ReturnType Result = 1U;

  Result = Sl_ExecRunTst((5U), ((uint8)0), TstM_TestSignatures, TstM_TestResults);
  if (0U != Result)
  {
    IOHWSF_vDefaultErrorHandler(IOHWSF_E_SAFETLIB_RUN_TEST_FAIL);
  }

  if(TstM_TestSignatures[TSTM_RUN_SFR_CMP] != TstM_ExpTestSignature[TSTM_RUN_SFR_CMP])
  {
    IOHWSF_vDefaultErrorHandler(IOHWSF_E_SAFETLIB_SIGNATURE_MISSMATCH_SFR_CMP_TST);
  }

}
# 335 "../30_Bsw/TstM/Static/TstM.c"
void TstM_SRCRegestersCheck(void)
{
  Std_ReturnType Result = 1U;

  Result = Sl_ExecRunTst((5U), ((uint8)1), TstM_TestSignatures, TstM_TestResults);
  if (0U != Result)
  {
    IOHWSF_vDefaultErrorHandler(IOHWSF_E_SAFETLIB_SRC_REG_CHECK_FAIL);
  }

  if(TstM_TestSignatures[TSTM_RUN_SRC_REGESTERS_CHECK] != TstM_ExpTestSignature[TSTM_RUN_SRC_REGESTERS_CHECK])
  {
...
#pragma section
# 352 "../30_Bsw/TstM/Static/TstM.c" 2
