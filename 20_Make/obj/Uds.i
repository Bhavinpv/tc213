# 1 "../30_Bsw/ComStack/Uds/Uds.c"
# 1 "D:\\SVN\\IPB-11Kw\\LvDc-C01R0P0-Ceramicheater\\20_Make//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../30_Bsw/ComStack/Uds/Uds.c"
# 25 "../30_Bsw/ComStack/Uds/Uds.c"
...
# 31 "../30_Bsw/ComStack/Uds/Uds.c" 2
...
# 32 "../30_Bsw/ComStack/Uds/Uds.c" 2
...
# 33 "../30_Bsw/ComStack/Uds/Uds.c" 2
...
extern bit Trusted_UdsRstReq_Flag;
 ...
 void Uds_Init( void );
 void Uds_Indication( eIndicationStatus_t status, uint8 *abData, uint16 dataLength );
 void Uds_Task( void );
 void Uds_ASILTask( void );
# 34 "../30_Bsw/ComStack/Uds/Uds.c" 2
...
# 35 "../30_Bsw/ComStack/Uds/Uds.c" 2
# 1 "../30_Bsw/ComStack/VerInfo/VerInfo_api.h" 1
# 9 "../30_Bsw/ComStack/VerInfo/VerInfo_api.h"
...
# 36 "../30_Bsw/ComStack/Uds/Uds.c" 2


# 1 "../40_Appl/HsfbCtrl/HsfbCtrl_GetParamData.h" 1
# 22 "../40_Appl/HsfbCtrl/HsfbCtrl_GetParamData.h"
...
# 23 "../40_Appl/HsfbCtrl/HsfbCtrl_GetParamData.h" 2

extern void HsfbCtrl_GetParamData(HSFBCTRL_S_PARAM *y);
# 39 "../30_Bsw/ComStack/Uds/Uds.c" 2
# 1 "../40_Appl/HsfbCtrl/HsfbCtrl_Param.h" 1
# 40 "../30_Bsw/ComStack/Uds/Uds.c" 2
...
# 12 "../40_Appl/HsfbCtrl/HsfbCtrl_types.h"
# 1 "../40_Appl/HsfbApp/HsfbApp_struct.h" 1
...
# 41 "../30_Bsw/ComStack/Uds/Uds.c" 2
# 1 "../30_Bsw/Mcal/Gtm/Gtm_scfg.h" 1
# 42 "../30_Bsw/ComStack/Uds/Uds.c" 2
...
# 133 "../30_Bsw/ComStack/Uds/Uds.c"
# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 137 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".rodata.MPU_QM_CONST" a
# 134 "../30_Bsw/ComStack/Uds/Uds.c" 2

const DiagServiceItem_t cs_ServicesModes[(4U)] =
{
# 153 "../30_Bsw/ComStack/Uds/Uds.c"
...
const DataIdItem_t cs_WriteDataIdItems[(2U)] =
{
...
const DataIdItem_t cs_ReadDataIdItems[(4U)] =
{
...
#pragma section
# 175 "../30_Bsw/ComStack/Uds/Uds.c" 2
# 235 "../30_Bsw/ComStack/Uds/Uds.c"
# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 112 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".bss.MPU_QM_VAR_NOINIT" awB 8
# 236 "../30_Bsw/ComStack/Uds/Uds.c" 2
...
#pragma section
# 247 "../30_Bsw/ComStack/Uds/Uds.c" 2
...
# 112 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".bss.MPU_QM_VAR_NOINIT" awB 8
# 253 "../30_Bsw/ComStack/Uds/Uds.c" 2
bit Trusted_UdsRstReq_Flag;

# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 125 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 256 "../30_Bsw/ComStack/Uds/Uds.c" 2
...
# 262 "../30_Bsw/ComStack/Uds/Uds.c" 2
# 271 "../30_Bsw/ComStack/Uds/Uds.c"
void Uds_Init( void )
{
...
# 318 "../30_Bsw/ComStack/Uds/Uds.c"
void Uds_Task( void )
{
  uint8 i=0;
  uint8 u8_RespCode = 0x11U;


  if (UdsRxReceived == e_UdsRxState)
  {
    if (0x11u == pu8_UdsData[(0x00U)])
    {
    ...
    else
    {
      ...
      for (i = 0; i < (4U); ++i)
      {
        ...
        if (cs_ServicesModes[i].Sid == pu8_UdsData[(0x00U)])
        {

          if (((void*)0) != cs_ServicesModes[i].func)
          {
              u8_RespCode = cs_ServicesModes[i].func(pu8_UdsData,
                                                   u16_UdsRxDataLength);

            if ((0x00U) != u8_RespCode)
            {

              Uds_SetNrc(pu8_UdsData, pu8_UdsData[(0x00U)], u8_RespCode);
            }
            e_UdsRxState = UdsRxIdle;
            break;
          }
          ...
          {
            Uds_SetNrc(pu8_UdsData, pu8_UdsData[(0x00U)],
                       0x12U);
          }
        }
      }
...
#pragma section
# 377 "../30_Bsw/ComStack/Uds/Uds.c" 2


# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 380 "../30_Bsw/ComStack/Uds/Uds.c" 2
# 391 "../30_Bsw/ComStack/Uds/Uds.c"
void Uds_ASILTask( void )
{
  uint8 u8_RespCode = 0x31U;
  e_UdsRxState = UdsRxError;

  if (((void*)0) != cs_ServicesModes[(0x01U)].func)
  {
    u8_RespCode = cs_ServicesModes[(0x01U)].func(pu8_UdsData,
                                            u16_UdsRxDataLength);
  }
  e_UdsRxState = UdsRxIdle;
  if ((0x00U) != u8_RespCode)
...
static inline uint8 Uds_EcuReset( uint8 *RxTxBuf, uint16 LenOfMsg )
{
  ...
  if (((uint16)LenOfMsg) == 2u)
  {

    if (RxTxBuf[(0x01U)] == 0x01u)
    {
        RxTxBuf[(0x00U)] = (RxTxBuf[(0x00U)] + (0x40U));
...
#pragma section
# 486 "../30_Bsw/ComStack/Uds/Uds.c" 2


# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 294 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_QM_CODE" ax 8
# 489 "../30_Bsw/ComStack/Uds/Uds.c" 2
# 498 "../30_Bsw/ComStack/Uds/Uds.c"
static inline void Uds_SetNrc( uint8 *RxTxBuff, uint8 Sid, uint8 Nrc )
{

  RxTxBuff[(0x00U)] = (0x7FU);
  RxTxBuff[(0x01U)] = Sid;
  RxTxBuff[(0x02U)] = Nrc;
...
# 521 "../30_Bsw/ComStack/Uds/Uds.c"
static inline uint8 Uds_DiagService10( uint8 *RxTxBuf, uint16 LenOfMsg )
{
  uint8 u8_RespCodeL=0x12U;
...
static inline uint8 Uds_DiagService22( uint8 *RxTxBuf, uint16 LenOfMsg )
{
  ...
  u16_DataId = ((RxTxBuf[(0x01U)] << 8U) & 0xFF00U) |
               (RxTxBuf[(0x02U)] & 0x00FFU);
  ...
  for (i = 0; i < (4U); ++i)
  {
    if (cs_ReadDataIdItems[i].DataId == u16_DataId)
    {
      ...
      if (((void*)0) != cs_ReadDataIdItems[i].func)
      {

        if (3U == LenOfMsg)
        {
          u8_RespCode = cs_ReadDataIdItems[i].func((0U),
                        &(RxTxBuf[(0x03U)]),
                        LenOfMsg-( (0x01U) + (0x02U) ));
          if ((0x00U) == u8_RespCode)
          {

            RxTxBuf[(0x00U)] = (RxTxBuf[(0x00U)] + (0x40U));

            u16_UdsTxDataLength = (0x01U) + (0x02U) +
...
static inline uint8 Uds_DiagService2E( uint8 *RxTxBuf, uint16 LenOfMsg )
{
  ...
  for (i = 0; i < (2U); ++i)
  {
    if (cs_WriteDataIdItems[i].DataId == u16_DataId)
    {
      ...
      if (((void*)0) != cs_WriteDataIdItems[i].func)
      {

        if((cs_WriteDataIdItems[i].Length + 3U) == LenOfMsg)
        {
          u8_RespCode = cs_WriteDataIdItems[i].func((1U),
                        &(RxTxBuf[(0x03U)]),
                        LenOfMsg-((0x01U) + (0x02U)));
          if ((0x00U) == u8_RespCode)
          {
...
# 307 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 654 "../30_Bsw/ComStack/Uds/Uds.c" 2
