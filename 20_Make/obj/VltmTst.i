# 1 "../30_Bsw/MicroTestLib/Static/VltmTst.c"
# 1 "S:\\20_Make//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../30_Bsw/MicroTestLib/Static/VltmTst.c"
# 39 "../30_Bsw/MicroTestLib/Static/VltmTst.c"
...
# 40 "../30_Bsw/MicroTestLib/Static/VltmTst.c" 2
# 1 "../30_Bsw/MicroTestLib/Static/VltmTst.h" 1
# 42 "../30_Bsw/MicroTestLib/Static/VltmTst.h"
# 1 "../30_Bsw/Common/Platform_Types.h" 1
# 43 "../30_Bsw/MicroTestLib/Static/VltmTst.h" 2
# 1 "../30_Bsw/STL_common/Sl_Timeout.h" 1
# 44 "../30_Bsw/MicroTestLib/Static/VltmTst.h" 2
...
# 46 "../30_Bsw/MicroTestLib/Static/VltmTst.h" 2
...
# 47 "../30_Bsw/MicroTestLib/Static/VltmTst.h" 2
# 1 "../30_Bsw/STL_common/ChipId.h" 1
# 48 "../30_Bsw/MicroTestLib/Static/VltmTst.h" 2
...
# 41 "../30_Bsw/MicroTestLib/Static/VltmTst.c" 2
...
# 42 "../30_Bsw/MicroTestLib/Static/VltmTst.c" 2
# 1 "../30_Bsw/Common/TC21x/IfxScu_bf.h" 1
# 43 "../30_Bsw/MicroTestLib/Static/VltmTst.c" 2
# 63 "../30_Bsw/MicroTestLib/Static/VltmTst.c"
# 1 "../30_Bsw/STL_common/Ifx_MemMap.h" 1
# 2642 "../30_Bsw/STL_common/Ifx_MemMap.h"
#pragma section ".text.STL_ASIL_CODE" ax 4
# 64 "../30_Bsw/MicroTestLib/Static/VltmTst.c" 2
...
# 138 "../30_Bsw/MicroTestLib/Static/VltmTst.c"
static Sl_TstRsltType VltmTst_lInit
(VltmTst_BackupDataType * const Vltm_BackupData)
{
  Sl_TstRsltType Result = (0xd010aU);
  ...
  Vltm_BackupData->EvrOvMon_Backup = (*(volatile Ifx_SCU_EVROVMON *)0xF00361A4u).U;
  Vltm_BackupData->EvrUvMon_Backup = (*(volatile Ifx_SCU_EVRUVMON *)0xF00361A0u).U;


  Vltm_BackupData->EvrMonCtrl_Backup = (*(volatile Ifx_SCU_EVRMONCTRL *)0xF00361A8u).U;


  Mcal_ResetSafetyENDINIT_Timed(((uint32)22960U));
  (*(volatile Ifx_SCU_EVRMONCTRL *)0xF00361A8u).U = (0x00210021U);
  Mcal_SetSafetyENDINIT_Timed();



  SmuResult1 = Smu_GetAlarmAction(( (uint8)(3U) ), ( (uint8)(11U) ),
                                  &(Vltm_BackupData->AlmActionBackupVDD_UV),
                                  &FspDummy);

  SmuResult2 = Smu_GetAlarmAction(( (uint8)(3U) ), ( (uint8)(12U) ),
                                  &(Vltm_BackupData->AlmActionBackupVDD_OV),
                                  &FspDummy);

  SmuResult3 = Smu_GetAlarmAction(( (uint8)(3U) ), ( (uint8)(15U) ),
                                  &(Vltm_BackupData->AlmActionBackupVDDP3_UV),
                                  &FspDummy);

  SmuResult4 = Smu_GetAlarmAction(( (uint8)(3U) ), ( (uint8)(16U) ),
                                  &(Vltm_BackupData->AlmActionBackupVDDP3_OV),
                                  &FspDummy);
# 202 "../30_Bsw/MicroTestLib/Static/VltmTst.c"
  if ( (SmuResult1 != 0U) || (SmuResult2 != 0U) || (SmuResult3 != 0U) ||
       (SmuResult4 != 0U) )

  {
    Vltm_BackupData->GetAlmActionResult = 1U;
    Result = (0xd0210U);
  }
  else
  {
    Vltm_BackupData->GetAlmActionResult = 0U;


    if(0U == Smu_GetAlarmStatus(( (uint8)(3U) ), &AlarmStatus))
    {

      if ((AlarmStatus & ( ( ( (uint32)((uint32)1U << (uint8)( (uint8)(11U) ) )) | ( (uint32)((uint32)1U << (uint8)( (uint8)(15U) )))) | ( ( (uint32)((uint32)1U << (uint8)( (uint8)(12U) ) )) | ( (uint32)((uint32)1U << (uint8)( (uint8)(16U) ) ))) )) != 0U)
      {
        Result = (0xd020dU);
      }
    }
    ...
    if((0xd010aU) == Result)
    {
      ...
      SmuResult1 = Smu_SetAlarmAction(( (uint8)(3U) ),
                                      ( (uint8)(11U) ),
                                      ((Smu_AlarmActionType)0x00U));

      SmuResult2 = Smu_SetAlarmAction(( (uint8)(3U) ),
                                      ( (uint8)(12U) ),
                                      ((Smu_AlarmActionType)0x00U));

      SmuResult3 = Smu_SetAlarmAction(( (uint8)(3U) ),
                                      ( (uint8)(15U) ),
                                      ((Smu_AlarmActionType)0x00U));
      ...
      SmuResult4 = Smu_SetAlarmAction(( (uint8)(3U) ),
                                      ( (uint8)(16U) ),
                                      ((Smu_AlarmActionType)0x00U));
# 260 "../30_Bsw/MicroTestLib/Static/VltmTst.c"
      if((SmuResult1 != 0U) || (SmuResult2 != 0U) || (SmuResult3 != 0U) ||
         (SmuResult4 != 0U))
...
# 301 "../30_Bsw/MicroTestLib/Static/VltmTst.c"
static Sl_TstRsltType VltmTst_lRestore
(const VltmTst_BackupDataType * const Vltm_BackupData)
{
  ...
  Mcal_ResetSafetyENDINIT_Timed(((uint32)22960U));
  (*(volatile Ifx_SCU_EVROVMON *)0xF00361A4u).U = Vltm_BackupData->EvrOvMon_Backup;

  Mcal_SetSafetyENDINIT_Timed();


  Mcal_ResetSafetyENDINIT_Timed(((uint32)22960U));
  (*(volatile Ifx_SCU_EVRUVMON *)0xF00361A0u).U = Vltm_BackupData->EvrUvMon_Backup;
  Mcal_SetSafetyENDINIT_Timed();


  Mcal_ResetSafetyENDINIT_Timed(((uint32)22960U));
  (*(volatile Ifx_SCU_EVRMONCTRL *)0xF00361A8u).U = Vltm_BackupData->EvrMonCtrl_Backup;
  Mcal_SetSafetyENDINIT_Timed();


  if(0U == Vltm_BackupData->GetAlmActionResult)
  {
    SmuResult1 = Smu_SetAlarmAction(( (uint8)(3U) ),
                                    ( (uint8)(11U) ),
                                    Vltm_BackupData->AlmActionBackupVDD_UV);
    ...
    SmuResult4 = Smu_SetAlarmAction(( (uint8)(3U) ),
                                    ( (uint8)(16U) ),
                                    Vltm_BackupData->AlmActionBackupVDDP3_OV);
# 363 "../30_Bsw/MicroTestLib/Static/VltmTst.c"
    if((SmuResult1 != 0U) || (SmuResult2 != 0U) || (SmuResult3 != 0U) ||
       (SmuResult4 != 0U))
...
# 407 "../30_Bsw/MicroTestLib/Static/VltmTst.c"
static Sl_TstRsltType VltmTst_lClearSMUAlarms(void)
{
  Sl_TstRsltType Result;
  Std_ReturnType SmuResult1 = 1U;
  ...
  SmuResult1 = Smu_ClearAlarmStatus(( (uint8)(3U) ), ( (uint8)(11U) ));
  SmuResult2 = Smu_ClearAlarmStatus(( (uint8)(3U) ), ( (uint8)(12U) ));
  SmuResult3 = Smu_ClearAlarmStatus(( (uint8)(3U) ), ( (uint8)(15U) ));
  SmuResult4 = Smu_ClearAlarmStatus(( (uint8)(3U) ), ( (uint8)(16U) ));
# 433 "../30_Bsw/MicroTestLib/Static/VltmTst.c"
  if ( (SmuResult1 != 0U) || (SmuResult2 != 0U) || (SmuResult3 != 0U) ||
       (SmuResult4 != 0U) )
...
# 477 "../30_Bsw/MicroTestLib/Static/VltmTst.c"
static Sl_TstRsltType VltmTst_lCheckUnderVoltage
(
  uint32* const TstSignature
)
{
  ...
  uint32 Timeout = 0U;
  boolean EndLoop = 0;
  Std_ReturnType SmuResult = 0U;
  uint32 AlarmStatus = 0U;

  Mcal_ResetSafetyENDINIT_Timed(((uint32)22960U));


  (*(volatile Ifx_SCU_EVRUVMON *)0xF00361A0u).B.SWDUVVAL = ((uint8)0x80);
  Mcal_SetSafetyENDINIT_Timed();



  Mcal_ResetSafetyENDINIT_Timed(((uint32)22960U));
  (*(volatile Ifx_SCU_EVRUVMON *)0xF00361A0u).U = (0x00FF00FFU);
  Mcal_SetSafetyENDINIT_Timed();

  Mcal_ResetSafetyENDINIT_Timed(((uint32)22960U));
  (*(volatile Ifx_SCU_EVROVMON *)0xF00361A4u).U = (0x00FF00FFU);
  Mcal_SetSafetyENDINIT_Timed();
  ...
  while (Timeout > 0U)
  {
    SmuResult = Smu_GetAlarmStatus(( (uint8)(3U) ), &AlarmStatus);
    ...
    else
    {
      ...
      if ((AlarmStatus & ( ( (uint32)((uint32)1U << (uint8)( (uint8)(11U) ) )) | ( (uint32)((uint32)1U << (uint8)( (uint8)(15U) ))))) != ( ( (uint32)((uint32)1U << (uint8)( (uint8)(11U) ) )) | ( (uint32)((uint32)1U << (uint8)( (uint8)(15U) )))))
      {
  ...
  if (EndLoop != 1)
  {
# 543 "../30_Bsw/MicroTestLib/Static/VltmTst.c"
    if ((AlarmStatus & ( (uint32)((uint32)1U << (uint8)( (uint8)(15U) )))) == 0U)
    {
      Result = (0xd3005U);
    }

    else if ((AlarmStatus & ( (uint32)((uint32)1U << (uint8)( (uint8)(11U) ) ))) == 0U)
    {
      Result = (0xd3006U);
    }
    else
  ...
  *TstSignature = (uint32)((__crc32((unsigned_int)(*TstSignature),(unsigned_int)((AlarmStatus & ( ( (uint32)((uint32)1U << (uint8)( (uint8)(11U) ) )) | ( (uint32)((uint32)1U << (uint8)( (uint8)(15U) ))))))))
                                                                     );

  return Result;
}
# 592 "../30_Bsw/MicroTestLib/Static/VltmTst.c"
static Sl_TstRsltType VltmTst_lCheckOverVoltage
(
  uint32* const TstSignature
)
{
  ...
  Mcal_ResetSafetyENDINIT_Timed(((uint32)22960U));
  (*(volatile Ifx_SCU_EVRUVMON *)0xF00361A0u).U = (0x00000000U);
  Mcal_SetSafetyENDINIT_Timed();

  Mcal_ResetSafetyENDINIT_Timed(((uint32)22960U));
  (*(volatile Ifx_SCU_EVROVMON *)0xF00361A4u).U = (0x00000000U);
  Mcal_SetSafetyENDINIT_Timed();
  ...
  while (Timeout > 0U)
  {
    ...
    else
    {
      ...
      if ((AlarmStatus & ( ( (uint32)((uint32)1U << (uint8)( (uint8)(12U) ) )) | ( (uint32)((uint32)1U << (uint8)( (uint8)(16U) ) )))) != ( ( (uint32)((uint32)1U << (uint8)( (uint8)(12U) ) )) | ( (uint32)((uint32)1U << (uint8)( (uint8)(16U) ) ))))
      {
  ...
  if (EndLoop != 1)
  {
# 651 "../30_Bsw/MicroTestLib/Static/VltmTst.c"
    if ((AlarmStatus & ( (uint32)((uint32)1U << (uint8)( (uint8)(16U) ) ))) == 0U)
    {
      Result = (0xd3002U);
    }

    else if ((AlarmStatus & ( (uint32)((uint32)1U << (uint8)( (uint8)(12U) ) ))) == 0U)
    {
      Result = (0xd3003U);
    }
    else
  ...
  *TstSignature = (uint32)((__crc32((unsigned_int)(*TstSignature),(unsigned_int)((AlarmStatus & ( ( (uint32)((uint32)1U << (uint8)( (uint8)(12U) ) )) | ( (uint32)((uint32)1U << (uint8)( (uint8)(16U) ) )))))))
                                                                     );


  return Result;
}
# 728 "../30_Bsw/MicroTestLib/Static/VltmTst.c"
...
)
{
  ...
  uint32 EvruvMon = (uint32)(*(volatile Ifx_SCU_EVRUVMON *)0xF00361A0u).B.LCK;
  uint32 EvrovMon = (uint32)(*(volatile Ifx_SCU_EVROVMON *)0xF00361A4u).B.LCK;

  {if((ParamSetIndex) != 0U) { }}


  *TstSignature = (uint32)(__crc32((unsigned_int)(TEST_ID_VLTM_TST),(unsigned_int)(TstSeed)));
  ...
  if (((Smu_StateType)1) == Smu_GetSmuState())
  {
    ...
    EvrMonCtrl = (uint32)
    (((*(volatile Ifx_SCU_EVRMONCTRL *)0xF00361A8u).U & (0x40000000U)) >> (30u));
    ...
    else if((*(volatile Ifx_SCU_EVRSTAT *)0xF00360B0u).B.BGPROK == 0U)
    {
      Result = (0xd0107U);
    }
    else
...
# 2654 "../30_Bsw/STL_common/Ifx_MemMap.h"
#pragma section
# 818 "../30_Bsw/MicroTestLib/Static/VltmTst.c" 2
