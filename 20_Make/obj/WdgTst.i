# 1 "../30_Bsw/MicroTestLib/Static/WdgTst.c"
# 1 "S:\\20_Make//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../30_Bsw/MicroTestLib/Static/WdgTst.c"
# 42 "../30_Bsw/MicroTestLib/Static/WdgTst.c"
# 1 "../30_Bsw/MicroTestLib/Static/WdgTst.h" 1
# 42 "../30_Bsw/MicroTestLib/Static/WdgTst.h"
...
# 43 "../30_Bsw/MicroTestLib/Static/WdgTst.h" 2
...
# 45 "../30_Bsw/MicroTestLib/Static/WdgTst.h" 2
...
# 47 "../30_Bsw/MicroTestLib/Static/WdgTst.h" 2
...
# 43 "../30_Bsw/MicroTestLib/Static/WdgTst.c" 2
...
# 44 "../30_Bsw/MicroTestLib/Static/WdgTst.c" 2
...
# 45 "../30_Bsw/MicroTestLib/Static/WdgTst.c" 2
...
# 46 "../30_Bsw/MicroTestLib/Static/WdgTst.c" 2
...
# 47 "../30_Bsw/MicroTestLib/Static/WdgTst.c" 2
...
# 48 "../30_Bsw/MicroTestLib/Static/WdgTst.c" 2
...
# 49 "../30_Bsw/MicroTestLib/Static/WdgTst.c" 2
...
# 50 "../30_Bsw/MicroTestLib/Static/WdgTst.c" 2
...
# 51 "../30_Bsw/MicroTestLib/Static/WdgTst.c" 2
# 1 "../30_Bsw/Common/TC21x/IfxSrc_bf.h" 1
# 52 "../30_Bsw/MicroTestLib/Static/WdgTst.c" 2
# 97 "../30_Bsw/MicroTestLib/Static/WdgTst.c"
typedef struct WdgTst_DataType
{
    Smu_AlarmActionType CpuWdgAlrmBackup;
...
# 122 "../30_Bsw/MicroTestLib/Static/WdgTst.c"
# 1 "../30_Bsw/STL_common/Ifx_MemMap.h" 1
# 3374 "../30_Bsw/STL_common/Ifx_MemMap.h"
#pragma section ".data.STL_RAM_32BIT" aw 4
# 123 "../30_Bsw/MicroTestLib/Static/WdgTst.c" 2
...
#pragma section
# 129 "../30_Bsw/MicroTestLib/Static/WdgTst.c" 2
# 138 "../30_Bsw/MicroTestLib/Static/WdgTst.c"
# 1 "../30_Bsw/STL_common/Ifx_MemMap.h" 1
# 2642 "../30_Bsw/STL_common/Ifx_MemMap.h"
#pragma section ".text.STL_ASIL_CODE" ax 4
# 139 "../30_Bsw/MicroTestLib/Static/WdgTst.c" 2
...
# 159 "../30_Bsw/MicroTestLib/Static/WdgTst.c"
 static __inline__ void WdgTst_lResetEndinit( sint8 WdgType )
 {
    (WdgType == -1) ?
 ...
 static __inline__ void WdgTst_lSetEndinit( sint8 WdgType )
 {
    (WdgType == -1) ?
 ...
 static __inline__ void WdgTst_lWdtModifyAccess( sint8 WdgType, const uint32 NewPassword, const uint32 NewReload )
 {
    (WdgType == -1) ?
 ...
 static __inline__ void WdgTst_lWdtCheckAccess( sint8 WdgType, const uint32 CheckPassword, const uint32 CheckReload )
 {
    (WdgType == -1) ?
 ...
 static __inline__ uint32 WdgTst_lWdtPwSequence( sint8 WdgType, const uint32 Password )
 {
    return ((WdgType == -1) ?
...
# 252 "../30_Bsw/MicroTestLib/Static/WdgTst.c"
Sl_TstRsltType WdgTst_WdgCpuTst(const Sl_ParamSetType ParamSetIndex,
                                 const uint8 TstSeed,
                                 uint32* const TstSignature)

{
    Sl_TstRsltType Result = (0xb0102U);


    *TstSignature = (uint32) (__crc32((unsigned_int)((uint32)TEST_ID_CPU_WDG_TST),(unsigned_int)((uint32)TstSeed)));
    ...
    if ( ParamSetIndex < ( 1U ) )
    {
        ...
        if (((Smu_StateType)1) == Smu_GetSmuState())
        {
            ...
            uint8 CurrCpu = (uint8)((__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "(0xFE1C)" : "=d" (__res) :: "memory"); __res; }))) & 0x7u;


            WdgTst_CtrlSet.TstSignature = TstSignature;
            WdgTst_CtrlSet.WdgType = (sint8) CurrCpu;
            WdgTst_CtrlSet.WdtPtr = (volatile Ifx_SCU_WDTCPU*) &((volatile Ifx_SCU_WDTCPU*)((volatile void *)&(*(volatile Ifx_SCU_WDTCPU_CON0 *)0xF0036100u)))[CurrCpu];
            WdgTst_CtrlSet.AlarmId = (( (uint8)(18U) ) + CurrCpu);
            ...
            if ( (0xb01ffU) == Result )
            {
                ...
                if ( ((0xb01ffU) == Result) &&
                   ( WdgTstCpu_ConfigRoot[ParamSetIndex].WdgTstPflowMonEn == 1) )
                {
...
# 358 "../30_Bsw/MicroTestLib/Static/WdgTst.c"
Sl_TstRsltType WdgTst_WdgSafetyTst(const Sl_ParamSetType ParamSetIndex,
                                    const uint8 TstSeed,
                                    uint32* const TstSignature)
{
    Sl_TstRsltType Result = (0xc0102U);


    *TstSignature = (uint32) (__crc32((unsigned_int)((uint32)TEST_ID_SAFETY_WDG_TST),(unsigned_int)((uint32)TstSeed)));
    ...
    if ( ParamSetIndex < ( 1U ) )
    {
        ...
        if (((Smu_StateType)1) == Smu_GetSmuState())
        {
            ...
            WdgTst_CtrlSet.WdtPtr = (volatile Ifx_SCU_WDTCPU*)((volatile void *)&(*(volatile Ifx_SCU_WDTS_CON0 *)0xF00360F0u));
            WdgTst_CtrlSet.AlarmId = ( (uint8)(17U) );
            WdgTst_CtrlSet.AlarmMask = ( (uint32)1u << ( (uint8)(17U) ) );
            ...
            if ( (0xc01ffU) == Result )
            {
                ...
                if ( ((0xc01ffU) == Result) &&
                     (WdgTstSafety_ConfigRoot[ParamSetIndex].WdgTstPflowMonEn == 1) )
                {
...
# 456 "../30_Bsw/MicroTestLib/Static/WdgTst.c"
static Sl_TstRsltType WdgTst_lInit(WdgTst_DataType* const TestDataPtr, uint32 TestId)
{
    Sl_TstRsltType Result;
    Smu_FSPActionType FspDummy;
    Std_ReturnType SmuResultTemp1 = 1U, SmuResultTemp2 = 1U, SmuResultTemp3 = 1U;
    ...
    if (Sl_GetSpinLock( SL_SMUALRMGRP3_SPNLCK_ID, (146280U)) == 0U)
    {
        ...
        if (Smu_GetAlarmStatus(( ((uint8)(3U)) ), &AlarmStatus) == 0U)
        {
            if (TestId == (uint32)TEST_ID_CPU_WDG_TST)
            {
              Result = (0xb020dU);
            ...
            AlarmStatus &= (( ( (uint32)1u << ( (uint8)(17U) ) ) | ( (uint32)1u << ( (uint8)(21U) ) ) | ( (uint32)1u << ( (uint8)(31U) ) )) | TestDataPtr->AlarmMask);
            if (AlarmStatus == 0u)
            {


                TestDataPtr->AllWdgAlrmBackup = ((Smu_AlarmActionType)0xFFU);
                TestDataPtr->CpuWdgAlrmBackup = ((Smu_AlarmActionType)0xFFU);
                TestDataPtr->SpbAccAlrmBackup = ((Smu_AlarmActionType)0xFFU);
                ...
                SmuResultTemp1 = Smu_GetAlarmAction(( ((uint8)(3U)) ), ( (uint8)(21U) ), &(TestDataPtr->AllWdgAlrmBackup), &FspDummy);
                SmuResultTemp2 = Smu_GetAlarmAction(( ((uint8)(3U)) ), TestDataPtr->AlarmId,&(TestDataPtr->CpuWdgAlrmBackup), &FspDummy);
                SmuResultTemp3 = Smu_GetAlarmAction(( ((uint8)(3U)) ), ( (uint8)(31U) ), &(TestDataPtr->SpbAccAlrmBackup), &FspDummy);
                if ((0U == SmuResultTemp1) && (0U == SmuResultTemp2) && (0U == SmuResultTemp3))
                {
                    if (TestId == (uint32)TEST_ID_CPU_WDG_TST)
                    {
                      Result = (0xb0211U);
                    ...
                    SmuResultTemp1 = Smu_SetAlarmAction(( ((uint8)(3U)) ), ( (uint8)(21U) ), ((Smu_AlarmActionType)0x00U));
                    SmuResultTemp2 = Smu_SetAlarmAction(( ((uint8)(3U)) ), TestDataPtr->AlarmId, ((Smu_AlarmActionType)0x00U));
                    SmuResultTemp3 = Smu_SetAlarmAction(( ((uint8)(3U)) ), ( (uint8)(31U) ), ((Smu_AlarmActionType)0x00U));
                     if ((0U == SmuResultTemp1) && (0U == SmuResultTemp2) && (0U == SmuResultTemp3))
                    {
                        if (TestId == (uint32)TEST_ID_CPU_WDG_TST)
                        {
...
# 589 "../30_Bsw/MicroTestLib/Static/WdgTst.c"
 static Sl_TstRsltType WdgTst_lRestore(const WdgTst_DataType* const TestDataPtr, uint32 TestId)
 {
    Sl_TstRsltType Result;
    Std_ReturnType SmuResultTemp1 = 1U, SmuResultTemp2 = 1U, SmuResultTemp3 = 1U;
    ...
    if ( ((Smu_AlarmActionType)0xFFU) != TestDataPtr->AllWdgAlrmBackup)
    {
        SmuResultTemp1 = Smu_SetAlarmAction( ( ((uint8)(3U)) ), ( (uint8)(21U) ), TestDataPtr->AllWdgAlrmBackup );
    }

    if ( ((Smu_AlarmActionType)0xFFU) != TestDataPtr->CpuWdgAlrmBackup)
    {
        SmuResultTemp2 = Smu_SetAlarmAction( ( ((uint8)(3U)) ), TestDataPtr->AlarmId, TestDataPtr->CpuWdgAlrmBackup );
    }

    if ( ((Smu_AlarmActionType)0xFFU) != TestDataPtr->SpbAccAlrmBackup)
    {
        SmuResultTemp3 = Smu_SetAlarmAction( ( ((uint8)(3U)) ), ( (uint8)(31U) ), TestDataPtr->SpbAccAlrmBackup );
    }


 TempRegRead = (uint32)((*(volatile Ifx_SBCU_ECON *)0xF0030020u)).U;
    ...
    WdgTst_lWdtModifyAccess( TestDataPtr->WdgType,
                             TestDataPtr->WdtxCon0Backup & ( 0xFFFFu ),
...
# 701 "../30_Bsw/MicroTestLib/Static/WdgTst.c"
static Sl_TstRsltType WdgTst_lEndinitTst( const WdgTst_DataType* const TestDataPtr, uint32 TestId )
{
    Sl_TstRsltType Result;
    Std_ReturnType SmuResultTemp1 = 1U, SmuResultTemp2 = 1U, SmuResultTemp3 = 1U;
    ...
    uint32 TestDataAlarmMask = ((TestDataPtr->AlarmMask) | ( (uint32)1u << ( (uint8)(21U) ) )) ;

 WdgTst_ExpectedTrap = ( 0u );


    WdgTst_lResetEndinit(WdgId);

    ThisWdt->CON1.U = ( 0x0000000Cu );
    ...
    WdgTst_SbeTrapSeen = 0u;


    if (( (TRAP_ErrorType)0x00000000) == TRAP_RegisterTrapHandler(( 4u ), &WdgTst_lDAETrap))
    {
        volatile TRAP_ErrorType dummy;


        WdgTst_ExpectedTrap = ( 3u );


        ThisWdt->CON1.U ^= ( 0x00000008u );
        _dsync();

        dummy = TRAP_UnregisterTrapHandler(( 4u ));
        {if((dummy) != 0U) { }}
    }


    if (ThisWdt->CON1.U == ( 0x0000000Cu ))
    {
        if (WdgTst_SbeTrapSeen == 1u)
        {
            ...
            *TestSig = (uint32) (__crc32((unsigned_int)(*TestSig),(unsigned_int)((uint32) ThisWdt->CON1.U)));
        }
    }


    if (((0xb01ffU) == Result) || ((0xc01ffU) == Result))
    {
        uint32 AlarmStatus = 0u;
        uint32 TimeOut = (0x400U);
        ...
        while (TimeOut > 0u)
        {
            ...
            if (0U != Smu_GetAlarmStatus(( ((uint8)(3U)) ), &AlarmStatus))
            {
                if (TestId == (uint32)TEST_ID_CPU_WDG_TST)
                {
                  Result = (0xb020eU);
        ...
        *TestSig = (uint32) (__crc32((unsigned_int)(*TestSig),(unsigned_int)((AlarmStatus & (TestDataAlarmMask | ( (uint32)1u << ( (uint8)(31U) ) ))))));



    }

    SmuResultTemp1 = Smu_ClearAlarmStatus(( ((uint8)(3U)) ), ( (uint8)(31U) ));
    SmuResultTemp2 = Smu_ClearAlarmStatus(( ((uint8)(3U)) ), TestDataPtr->AlarmId);
    SmuResultTemp3 = Smu_ClearAlarmStatus(( ((uint8)(3U)) ), ( (uint8)(21U) ));
...
# 909 "../30_Bsw/MicroTestLib/Static/WdgTst.c"
static Sl_TstRsltType WdgTst_lProgFlowTst(const WdgTst_DataType* const TestDataPtr, uint32 TestId)
{
    Sl_TstRsltType Result;
    Ifx_SCU_WDTCPU* ThisWdt = TestDataPtr->WdtPtr;
    ...
    if (((0xb01ffU) == Result) || ((0xc01ffU) == Result))
    {
        ...
        if (((0xb01ffU) == Result) || ((0xc01ffU) == Result))
        {
            ...
            if (((0xb01ffU) == Result) || ((0xc01ffU) == Result))
            {
                ...
                Result = WdgTst_lWdgPfWrongPwdTst( TestDataPtr, TestId, ( (uint8)1u ) );
                if (((0xb01ffU) == Result) || ((0xc01ffU) == Result))
                {

                    Result = WdgTst_lWdgPfWrongPwdTst( TestDataPtr, TestId, ( (uint8)0u ) );
                }
            }
        }
    }
...
# 982 "../30_Bsw/MicroTestLib/Static/WdgTst.c"
static Sl_TstRsltType WdgTst_lWdgPfTimeoutTst( const WdgTst_DataType* const TestDataPtr, uint32 TestId )
{
    Sl_TstRsltType Result;
    Std_ReturnType SmuResultTemp1 = 1U, SmuResultTemp2 = 1U;
    Ifx_SCU_WDTCPU* ThisWdt = TestDataPtr->WdtPtr;
    uint32 TimeOut = (0x400U);
    uint32 AlarmStatus = 0u;
    sint8 WdgId = TestDataPtr->WdgType;
    ...
    WdgTst_lWdtModifyAccess( WdgId, ( 0xFFFFFFFFu ), ( 0xFFFFu ) - 3u);


    WdgTst_lResetEndinit(WdgId);
    ThisWdt->CON1.B.DR = 0u;
    WdgTst_lSetEndinit(WdgId);
    ...
    *(TestDataPtr->TstSignature) = (uint32) (__crc32((unsigned_int)(*(TestDataPtr->TstSignature)),(unsigned_int)((AlarmStatus & TestDataAlarmMask))));


    WdgTst_lResetEndinit(WdgId);
    ThisWdt->CON1.B.DR = 1u;
    WdgTst_lSetEndinit(WdgId);

    SmuResultTemp1 = Smu_ClearAlarmStatus(( ((uint8)(3U)) ), TestDataPtr->AlarmId);
    SmuResultTemp2 = Smu_ClearAlarmStatus(( ((uint8)(3U)) ), ( (uint8)(21U) ));

    if ((0U != SmuResultTemp1) || (0U != SmuResultTemp2))
    {
        if (TestId == (uint32)TEST_ID_CPU_WDG_TST)
        {
          Result = (0xb020fU);
...
# 1113 "../30_Bsw/MicroTestLib/Static/WdgTst.c"
static Sl_TstRsltType WdgTst_lWdgPfNoErrorTst( const WdgTst_DataType* const TestDataPtr, uint32 TestId )
{
    Sl_TstRsltType Result;
    Ifx_SCU_WDTCPU* ThisWdt = TestDataPtr->WdtPtr;
    uint32 AlarmStatus = 0u;
    uint32 Password = ( 0x000Cu );
    uint32 TimeOut = (0x400U);
    sint8 WdgId = TestDataPtr->WdgType;
    uint32 TestDataAlarmMask = ((TestDataPtr->AlarmMask) | ( (uint32)1u << ( (uint8)(21U) ) )) ;
    ...
    WdgTst_lWdtModifyAccess ( WdgId, Password, ( 0xFFFFu ) - ( 20u ));

    con1tmp.U = ThisWdt->CON1.U;
    con1tmp.B.PAR = 1U;
    con1tmp.B.TCR = 1U;
    con1tmp.B.TCTR = (2u*( 20u ))/10u;
    con1tmp.B.DR = 0U;
    ...
    WdgTst_lWdtCheckAccess( WdgId, Password, (~((uint32)ThisWdt->SR.B.TIM)) & ( 0xFFFFu ) );
    ...
    while (TimeOut > 0u)
    {
        ...
        if (ThisWdt->SR.B.TIM >= (( 0xFFFFu ) - (( 20u )/2u)))
        {
...
# 1266 "../30_Bsw/MicroTestLib/Static/WdgTst.c"
static Sl_TstRsltType WdgTst_lWdgPfWrongAccTimeTst( const WdgTst_DataType* const TestDataPtr, uint32 TestId )
{
    Sl_TstRsltType Result;
    Std_ReturnType SmuResultTemp1 = 1U, SmuResultTemp2 = 1U;
    ...
    WdgTst_lWdtCheckAccess( WdgId, Password, (~((uint32)(( 0xFFFFu ) - (4u*( 20u )))) & ( 0xFFFFu )));
...
# 1407 "../30_Bsw/MicroTestLib/Static/WdgTst.c"
static Sl_TstRsltType WdgTst_lWdgPfWrongPwdTst( const WdgTst_DataType* const TestDataPtr, uint32 TestId, uint8 PasswordType )
{
    Sl_TstRsltType Result;
    Std_ReturnType SmuResultTemp1 = 1U, SmuResultTemp2 = 1U;
    ...
    WdgTst_lWdtCheckAccess( WdgId, Password, ( 0xFFFFFFFFu ) );
...
# 1543 "../30_Bsw/MicroTestLib/Static/WdgTst.c"
static boolean WdgTst_lDAETrap (const uint32 TIN)
{
    boolean TrapExpected = (boolean)0;

    if ((WdgTst_ExpectedTrap == ( 3u )) && (TIN == ( 3u )))
    {
...
# 2654 "../30_Bsw/STL_common/Ifx_MemMap.h"
#pragma section
# 1567 "../30_Bsw/MicroTestLib/Static/WdgTst.c" 2
