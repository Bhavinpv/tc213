# 1 "../30_Bsw/iohw/Static/iohwsf.c"
# 1 "D:\\SVN\\IPB-11Kw\\LvDc-C01R0P0-Ceramicheater\\20_Make//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../30_Bsw/iohw/Static/iohwsf.c"
# 21 "../30_Bsw/iohw/Static/iohwsf.c"
...
# 22 "../30_Bsw/iohw/Static/iohwsf.c" 2
# 1 "../30_Bsw/iohw/Static/iohwsf_Reset.h" 1
# 53 "../30_Bsw/iohw/Static/iohwsf_Reset.h"
extern void IOHWSF_vCheckRSRCON2_CSS0_Bit(void);
# 23 "../30_Bsw/iohw/Static/iohwsf.c" 2
# 1 "../30_Bsw/TstM/Static/TstM.h" 1
# 41 "../30_Bsw/TstM/Static/TstM.h"
...
# 24 "../30_Bsw/iohw/Static/iohwsf.c" 2
...
# 25 "../30_Bsw/iohw/Static/iohwsf.c" 2
...
# 26 "../30_Bsw/iohw/Static/iohwsf.c" 2
...
# 27 "../30_Bsw/iohw/Static/iohwsf.c" 2
...
# 28 "../30_Bsw/iohw/Static/iohwsf.c" 2
...
# 31 "../30_Bsw/iohw/Static/iohwsf.c" 2
...
# 32 "../30_Bsw/iohw/Static/iohwsf.c" 2
...
# 22 "../30_Bsw/Mcal/Can/can_driver.h" 2
...
# 23 "../30_Bsw/Scheduler/Scheduler_api.h"
# 1 "../20_Make/project.h" 1
# 24 "../30_Bsw/Scheduler/Scheduler_api.h" 2

# 1 "../30_Bsw/Common/Delta_commen/StandardTypes.h" 1
# 26 "../30_Bsw/Scheduler/Scheduler_api.h" 2
...
# 27 "../30_Bsw/Scheduler/Scheduler_api.h" 2
# 1 "../30_Bsw/Mcal/Can/can_driver.h" 1
...
# 32 "../30_Bsw/Scheduler/Scheduler_api.h" 2
...
# 36 "../30_Bsw/Scheduler/Scheduler_api.h" 2
...
# 33 "../30_Bsw/iohw/Static/iohwsf_AccessProt.h"
# 1 "../30_Bsw/Compilers/IfxCpu_IntrinsicsGnuc.h" 1
...
# 33 "../30_Bsw/iohw/Static/iohwsf.c" 2

# 1 "../30_Bsw/Common/TC21x/IfxScu_bf.h" 1
# 35 "../30_Bsw/iohw/Static/iohwsf.c" 2
# 98 "../30_Bsw/iohw/Static/iohwsf.c"
# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 99 "../30_Bsw/iohw/Static/iohwsf.c" 2
...
static inline void mg_setProgramCache(boolean enable)
{
    ...
    uint16 wdtPassword = mg_getCpuWatchdogPasswordInline(&(*(Ifx_SCU *)0xF0036000u).WDTCPU[0]);

    {
        mg_clearCpuEndinitInline(&(*(Ifx_SCU *)0xF0036000u).WDTCPU[0], wdtPassword);
        Ifx_CPU_PCON0 pcon0;
        pcon0.U = 0;
        pcon0.B.PCBYP = enable ? 0 : 1;
        do { unsigned __newval = (unsigned) (pcon0.U); __asm__ volatile ("mtcr LO:" "0x920C" ", %0" :: "d" (__newval) : "memory"); } while (0);
        mg_setCpuEndinitInline(&(*(Ifx_SCU *)0xF0036000u).WDTCPU[0], wdtPassword);
    }
...
#pragma section
# 282 "../30_Bsw/iohw/Static/iohwsf.c" 2
...
# 288 "../30_Bsw/iohw/Static/iohwsf.c" 2
...
#pragma section
# 294 "../30_Bsw/iohw/Static/iohwsf.c" 2
...
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 312 "../30_Bsw/iohw/Static/iohwsf.c" 2
...
void IOHWSF_vMcSafeStartUpChecks(void)
{
  ...
  if(( (Sl_FlsPrgRsltType)0xFFU ) != Sl_ChkProgErrorPattern())
  {
  ...
  TstM_PreRunTst(((uint8)0));

  TstM_PreRunTst(((uint8)1));

  TstM_PreRunTst(((uint8)2));



  TstM_PreRunTst(((uint8)3));

}

void IOHWSF_vMcSafeSwitchToRunState(void)
{
  Std_ReturnType tResult = 1U;
  uint16 u16CpuWdtPassword;

  (*(volatile Ifx_P_IOCR8 *)0xF003D318u).B.PC8 = ((uint32)0x10);
  ...
  tResult = Sl_SwitchTstPhase(((Sl_TstPhaseType)3U));
  ...
  u16CpuWdtPassword = mg_getCpuWatchdogPasswordInline(&(*(Ifx_SCU *)0xF0036000u).WDTCPU[0]);
  mg_clearCpuEndinitInline(&(*(Ifx_SCU *)0xF0036000u).WDTCPU[0], u16CpuWdtPassword);

  (*(volatile Ifx_SCU_TRAPDIS *)0xF0036130u).U &= ((uint32)0xFFFFFFF7);

  mg_setCpuEndinitInline(&(*(Ifx_SCU *)0xF0036000u).WDTCPU[0], u16CpuWdtPassword);
...
Std_ReturnType __attribute__ ((noinline)) IOHWSF_tPreRunPreHook (uint8 GroupIndex)
{
  ...
  switch(GroupIndex)
  {
    case(((uint8)0)):
    {
      ...
      ((uint32*)0x70100000)[0] = 0;
      ((uint32*)0x70100000)[1] = 0;


     _dsync(); do { unsigned __newval = (unsigned) (((0U))); __asm__ volatile ("mtcr LO:" "(0x9010)" ", %0" :: "d" (__newval) : "memory"); } while (0); _isync();


     _dsync(); do { unsigned __newval = (unsigned) (((0U))); __asm__ volatile ("mtcr LO:" "(0x9018)" ", %0" :: "d" (__newval) : "memory"); } while (0); _isync();
...
static void mg_vMcu_PerformReset(void)
{
  ...
  (*(volatile Ifx_SCU_RSTCON *)0xF0036058u).B.SW = ((uint8)0x01U);
  (*(volatile Ifx_SCU_SWRSTCON *)0xF0036060u).B.SWRSTREQ = ((uint8)0x01U);


  mg_setSafetyEndinit(u16EndinitSfty_pw);


  for(LoopCount = 0U;LoopCount<(uint32)((uint32)0xFFFFFFFFU);LoopCount++)
  {
    __asm("nop");
  }
}
...
static void mg_vSramEccPreAou(void)
{
  ...
  u16Timeout = ((uint16)0xFFFF);
  while(((*(volatile Ifx_MTU_CLC *)0xF0060000u).B.DISS > 0U) && (u16Timeout > 0U))
  {
    u16Timeout--;
  }
  ...
  (*(volatile Ifx_MTU_MEMTEST0 *)0xF0060010u).U = ((uint32)0x24000);

  while(((uint32)0x24000) != (*(volatile Ifx_MTU_MEMTEST0 *)0xF0060010u).U)
  {
  }

  (*(volatile Ifx_MC_ECCD *)0xF0062110u).U |= ((uint32)0x7800);
  (*(volatile Ifx_MC_ECCD *)0xF0061E10u).U |= ((uint32)0x7800);

  (*(volatile Ifx_MTU_MEMTEST0 *)0xF0060010u).U = ((uint32)0);


  while(((uint32)0x1) == (*(volatile Ifx_MTU_MEMSTAT0 *)0xF0060038u).B.CPU0PTAIU)
  {
  }
...
static void mg_vClkmPreAou(void)
{
  ...
  Smu_ClearAlarmStatus(((uint8)3), ((uint8)3));
  Smu_ClearAlarmStatus(((uint8)3), ((uint8)4));
  Smu_ClearAlarmStatus(((uint8)3), ((uint8)5));
  Smu_ClearAlarmStatus(((uint8)3), ((uint8)6));
  Smu_ClearAlarmStatus(((uint8)3), ((uint8)7));
  Smu_ClearAlarmStatus(((uint8)3), ((uint8)8));
  Smu_ClearAlarmStatus(((uint8)3), ((uint8)9));
}
...
static void mg_vPmuPreAou(void)
{
  ...
  (*(volatile Ifx_FLASH_FCON *)0xF8002014u).B.NSAFECC = 0;
...
static void mg_vVlmPreAou(void)
{
  ...
  (*(volatile Ifx_SCU_EVROVMON *)0xF00361A4u).U = ((uint32)0x9E00FD);
  ...
  (*(volatile Ifx_SCU_EVRUVMON *)0xF00361A0u).U = ((uint32)0x8100D6);


  mg_setSafetyEndinit(u16EndinitSfty_pw);


  while((((uint32)0x9E00FD) != (*(volatile Ifx_SCU_EVROVMON *)0xF00361A4u).U) || (((uint32)0x8100D6) != (*(volatile Ifx_SCU_EVRUVMON *)0xF00361A0u).U))
  {
  }
}
...
static inline void __attribute__((__always_inline__)) mg_vBusMpuPreAou(void)
{
  ...
  Smu_ClearAlarmStatus(((uint8)0), ((uint8)1));

  u32PcxiRegister = ((__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "(0xFE00)" : "=d" (__res) :: "memory"); __res; })));


  pu32CsaBaseAddress = (uint32*)((uint32)(u32PcxiRegister & ((uint32)0x0FFFF)) << ((uint32)0x6));
  pu32CsaBaseAddress = (uint32*)((uint32)pu32CsaBaseAddress | (uint32)((uint32)(u32PcxiRegister & ((uint32)0xF0000)) << ((uint32)12)));
  pu32PswRegister = pu32CsaBaseAddress + 1;


  mg_u32PswRegister = *pu32PswRegister;
  u32PswRegister = mg_u32PswRegister & (~(((uint32)0x4000)));
...
static inline void __attribute__((__always_inline__)) mg_vBusMpuPostAou(void)
{
  ...
  u32PswRegister = u32PswRegister | (mg_u32PswRegister & (((uint32)0x4000)));
  *pu32PswRegister = u32PswRegister;
}
...
# 255 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section
# 700 "../30_Bsw/iohw/Static/iohwsf.c" 2
