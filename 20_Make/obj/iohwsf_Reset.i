...
# 25 "../30_Bsw/iohw/Static/iohwsf_Reset.c" 2
...
# 26 "../30_Bsw/iohw/Static/iohwsf_Reset.c" 2
...
# 27 "../30_Bsw/iohw/Static/iohwsf_Reset.c" 2
# 59 "../30_Bsw/iohw/Static/iohwsf_Reset.c"
# 1 "../30_Bsw/Mpu/MPU_MemMap.h" 1
# 242 "../30_Bsw/Mpu/MPU_MemMap.h"
#pragma section ".text.MPU_ASIL_CODE" ax 8
# 60 "../30_Bsw/iohw/Static/iohwsf_Reset.c" 2
void IOHWSF_vCheckRSRCON2_CSS0_Bit(void)
{
    if(0U == (*(volatile Ifx_SCU_RSTCON2 *)0xF0036064u).B.CSS0)
    {
...
#pragma section
# 71 "../30_Bsw/iohw/Static/iohwsf_Reset.c" 2
