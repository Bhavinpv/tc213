...
# 60 "../30_Bsw/Mpu/mpu.c" 2
# 74 "../30_Bsw/Mpu/mpu.c"
void mpu_vInit(void)
{
  u8 mpuConfig_Sts = 0x0000;
  PSWReg_Rd0.U = 0x00000980u;
  PSWReg_Rd1.U = 0x00000980u;
  PSWReg_Rd2.U = 0x00000980u;
  PSWReg_Rd3.U = 0x00000980u;
  ...
  mpuConfig_Sts |= mpu_u8SetProtRange(0);
  mpuConfig_Sts |= mpu_u8SetProtAccess(0);


  mpuConfig_Sts |= mpu_u8SetProtRange(1);
  mpuConfig_Sts |= mpu_u8SetProtAccess(1);


  mpuConfig_Sts |= mpu_u8SetProtRange(2);
  mpuConfig_Sts |= mpu_u8SetProtAccess(2);
...
static u8 mpu_u8SetProtRange(uint8 protectionSet)
{
  ...
  switch(protectionSet)
  {
    ...
    case 0:
      ...
      mpu_vDefine_DataProtRange((uint32)(__START_DSPR), (uint32)(__DSPR_DEFAULT_VAR_START), 0);

      mpu_vDefine_DataProtRange((uint32)(__DSPR_DEFAULT_VAR_END), 0xF8820000, 1);

      mpu_vDefine_DataProtRange((uint32)(__PSPR_ASIL_RAMCODE_START), (uint32)(__PSPR_ASIL_RAMCODE_END), 12);


      mpu_vDefine_CodeProtRange(0x80000000, 0x80080000, 0);

      mpu_vDefine_CodeProtRange((uint32)(__PSPR_ASIL_RAMCODE_START), (uint32)(__PSPR_ASIL_RAMCODE_END), 1);
      status = 0x01;
      break;
    case 1:

      mpu_vDefine_DataProtRange((uint32)(__DSPR_ASIL_VAR_START), (uint32)(__DSPR_ASIL_VAR_END), 2);

      mpu_vDefine_DataProtRange((uint32)(__DSPR_QM_VAR_START), (uint32)(__DSPR_QM_VAR_END), 3);

      mpu_vDefine_DataProtRange((uint32)(__USTACK0_END), (uint32)(__USTACK0), 4);

      mpu_vDefine_DataProtRange((uint32)(__ISTACK0_END), (uint32)(__ISTACK0), 5);

      mpu_vDefine_DataProtRange((uint32)(__CSA0), (uint32)(__CSA0_END), 6);

      mpu_vDefine_DataProtRange(0x80000000, 0x80080000, 7);

      mpu_vDefine_DataProtRange(0xAF000000, 0xAF018000, 8);

      mpu_vDefine_DataProtRange(0xAF100000, 0xAF102000, 9);

      mpu_vDefine_DataProtRange(0xF0000000, 0xF8820000, 10);

      mpu_vDefine_DataProtRange(0xA0000000, 0xA0080000, 11);
    ...
    case 2:
      ...
      mpu_vDefine_DataProtRange((uint32)(__DSPR_QM_PMA_VAR_START), (uint32)(__DSPR_QM_PMA_VAR_END), 13);
...
static u8 mpu_u8SetProtAccess(uint8 protectionSet)
{
  ...
  switch(protectionSet)
  {
    case 0:
      ...
      mpu_vEnable_DataRd(0, 0);
      mpu_vEnable_DataRd(0, 1);
      mpu_vEnable_DataRd(0, 12);
      mpu_vEnable_DataRd(0, 13);

      mpu_vEnable_DataWr(0, 0);
      mpu_vEnable_DataWr(0, 1);
      mpu_vEnable_DataWr(0, 12);
      mpu_vEnable_DataWr(0, 13);

      mpu_vEnable_CodeExe(0, 0);

      mpu_vEnable_CodeExe(0, 1);
      status = 0x10;
      break;
    case 1:

      mpu_vEnable_DataRd(1, 2);
      mpu_vEnable_DataRd(1, 3);
      mpu_vEnable_DataRd(1, 4);
      mpu_vEnable_DataRd(1, 5);
      mpu_vEnable_DataRd(1, 6);
      mpu_vEnable_DataRd(1, 7);
      mpu_vEnable_DataRd(1, 8);
      mpu_vEnable_DataRd(1, 9);
      mpu_vEnable_DataRd(1, 10);
      mpu_vEnable_DataRd(1, 11);
      mpu_vEnable_DataRd(1, 13);

      mpu_vEnable_DataWr(1, 3);
      mpu_vEnable_DataWr(1, 4);
      mpu_vEnable_DataWr(1, 5);
      mpu_vEnable_DataWr(1, 6);
      mpu_vEnable_DataWr(1, 7);
      mpu_vEnable_DataWr(1, 8);
      mpu_vEnable_DataWr(1, 9);
      mpu_vEnable_DataWr(1, 10);
      mpu_vEnable_DataWr(1, 11);
      mpu_vEnable_DataWr(1, 13);

      mpu_vEnable_CodeExe(1, 0);
      status = 0x20;
      break;
    case 2:

      mpu_vEnable_DataRd(2, 2);
      mpu_vEnable_DataRd(2, 3);
      mpu_vEnable_DataRd(2, 4);
      mpu_vEnable_DataRd(2, 5);
      mpu_vEnable_DataRd(2, 6);
      mpu_vEnable_DataRd(2, 7);



      mpu_vEnable_DataRd(2, 11);
      mpu_vEnable_DataRd(2, 13);


      mpu_vEnable_DataWr(2, 4);
      mpu_vEnable_DataWr(2, 5);
      mpu_vEnable_DataWr(2, 6);
      mpu_vEnable_DataWr(2, 7);



      mpu_vEnable_DataWr(2, 11);
      mpu_vEnable_DataWr(2, 13);

      mpu_vEnable_CodeExe(2, 0);
...
static u8 mpu_u8Enable_MemProt(void)
{
  ...
  sysconValue.U = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xFE14" : "=d" (__res) :: "memory"); __res; }));

  sysconValue.B.PROTEN = 1;

  do { unsigned __newval = (unsigned) (sysconValue.U); __asm__ volatile ("mtcr LO:" "0xFE14" ", %0" :: "d" (__newval) : "memory"); } while (0);
  __asm ("isync");
  sysconRead.U = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xFE14" : "=d" (__res) :: "memory"); __res; }));
  IfxScuWdt_setCpuEndinit(IfxScuWdt_getCpuWatchdogPassword());
  Protection_Status = sysconRead.B.PROTEN;
  return Protection_Status;
}
# 338 "../30_Bsw/Mpu/mpu.c"
...
static void mpu_vDefine_DataProtRange(uint32 lowerBoundAddress, uint32 upperBoundAddress, uint8 range)
{
  ...
  {
    case 0:
        do { unsigned __newval = (unsigned) (lowerBoundAddress); __asm__ volatile ("mtcr LO:" "0xC000" ", %0" :: "d" (__newval) : "memory"); } while (0);
        do { unsigned __newval = (unsigned) (upperBoundAddress); __asm__ volatile ("mtcr LO:" "0xC004" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 1:
        do { unsigned __newval = (unsigned) (lowerBoundAddress); __asm__ volatile ("mtcr LO:" "0xC008" ", %0" :: "d" (__newval) : "memory"); } while (0);
        do { unsigned __newval = (unsigned) (upperBoundAddress); __asm__ volatile ("mtcr LO:" "0xC00C" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 2:
        do { unsigned __newval = (unsigned) (lowerBoundAddress); __asm__ volatile ("mtcr LO:" "0xC010" ", %0" :: "d" (__newval) : "memory"); } while (0);
        do { unsigned __newval = (unsigned) (upperBoundAddress); __asm__ volatile ("mtcr LO:" "0xC014" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 3:
        do { unsigned __newval = (unsigned) (lowerBoundAddress); __asm__ volatile ("mtcr LO:" "0xC018" ", %0" :: "d" (__newval) : "memory"); } while (0);
        do { unsigned __newval = (unsigned) (upperBoundAddress); __asm__ volatile ("mtcr LO:" "0xC01C" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 4:
        do { unsigned __newval = (unsigned) (lowerBoundAddress); __asm__ volatile ("mtcr LO:" "0xC020" ", %0" :: "d" (__newval) : "memory"); } while (0);
        do { unsigned __newval = (unsigned) (upperBoundAddress); __asm__ volatile ("mtcr LO:" "0xC024" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 5:
        do { unsigned __newval = (unsigned) (lowerBoundAddress); __asm__ volatile ("mtcr LO:" "0xC028" ", %0" :: "d" (__newval) : "memory"); } while (0);
        do { unsigned __newval = (unsigned) (upperBoundAddress); __asm__ volatile ("mtcr LO:" "0xC02C" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 6:
        do { unsigned __newval = (unsigned) (lowerBoundAddress); __asm__ volatile ("mtcr LO:" "0xC030" ", %0" :: "d" (__newval) : "memory"); } while (0);
        do { unsigned __newval = (unsigned) (upperBoundAddress); __asm__ volatile ("mtcr LO:" "0xC034" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 7:
        do { unsigned __newval = (unsigned) (lowerBoundAddress); __asm__ volatile ("mtcr LO:" "0xC038" ", %0" :: "d" (__newval) : "memory"); } while (0);
        do { unsigned __newval = (unsigned) (upperBoundAddress); __asm__ volatile ("mtcr LO:" "0xC03C" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 8:
        do { unsigned __newval = (unsigned) (lowerBoundAddress); __asm__ volatile ("mtcr LO:" "0xC040" ", %0" :: "d" (__newval) : "memory"); } while (0);
        do { unsigned __newval = (unsigned) (upperBoundAddress); __asm__ volatile ("mtcr LO:" "0xC044" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 9:
        do { unsigned __newval = (unsigned) (lowerBoundAddress); __asm__ volatile ("mtcr LO:" "0xC048" ", %0" :: "d" (__newval) : "memory"); } while (0);
        do { unsigned __newval = (unsigned) (upperBoundAddress); __asm__ volatile ("mtcr LO:" "0xC04C" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 10:
        do { unsigned __newval = (unsigned) (lowerBoundAddress); __asm__ volatile ("mtcr LO:" "0xC050" ", %0" :: "d" (__newval) : "memory"); } while (0);
        do { unsigned __newval = (unsigned) (upperBoundAddress); __asm__ volatile ("mtcr LO:" "0xC054" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 11:
        do { unsigned __newval = (unsigned) (lowerBoundAddress); __asm__ volatile ("mtcr LO:" "0xC058" ", %0" :: "d" (__newval) : "memory"); } while (0);
        do { unsigned __newval = (unsigned) (upperBoundAddress); __asm__ volatile ("mtcr LO:" "0xC05C" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 12:
        do { unsigned __newval = (unsigned) (lowerBoundAddress); __asm__ volatile ("mtcr LO:" "0xC060" ", %0" :: "d" (__newval) : "memory"); } while (0);
        do { unsigned __newval = (unsigned) (upperBoundAddress); __asm__ volatile ("mtcr LO:" "0xC064" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 13:
        do { unsigned __newval = (unsigned) (lowerBoundAddress); __asm__ volatile ("mtcr LO:" "0xC068" ", %0" :: "d" (__newval) : "memory"); } while (0);
        do { unsigned __newval = (unsigned) (upperBoundAddress); __asm__ volatile ("mtcr LO:" "0xC06C" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 14:
        do { unsigned __newval = (unsigned) (lowerBoundAddress); __asm__ volatile ("mtcr LO:" "0xC070" ", %0" :: "d" (__newval) : "memory"); } while (0);
        do { unsigned __newval = (unsigned) (upperBoundAddress); __asm__ volatile ("mtcr LO:" "0xC074" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 15:
        do { unsigned __newval = (unsigned) (lowerBoundAddress); __asm__ volatile ("mtcr LO:" "0xC078" ", %0" :: "d" (__newval) : "memory"); } while (0);
        do { unsigned __newval = (unsigned) (upperBoundAddress); __asm__ volatile ("mtcr LO:" "0xC07C" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
  }
  __asm ("isync");
}
# 472 "../30_Bsw/Mpu/mpu.c"
static void mpu_vDefine_CodeProtRange(uint32 lowerBoundAddress, uint32 upperBoundAddress, uint8 range)
{
  ...
  {
    case 0:
        do { unsigned __newval = (unsigned) (lowerBoundAddress); __asm__ volatile ("mtcr LO:" "0xD000" ", %0" :: "d" (__newval) : "memory"); } while (0);
        do { unsigned __newval = (unsigned) (upperBoundAddress); __asm__ volatile ("mtcr LO:" "0xD004" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 1:
        do { unsigned __newval = (unsigned) (lowerBoundAddress); __asm__ volatile ("mtcr LO:" "0xD008" ", %0" :: "d" (__newval) : "memory"); } while (0);
        do { unsigned __newval = (unsigned) (upperBoundAddress); __asm__ volatile ("mtcr LO:" "0xD00C" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 2:
        do { unsigned __newval = (unsigned) (lowerBoundAddress); __asm__ volatile ("mtcr LO:" "0xD010" ", %0" :: "d" (__newval) : "memory"); } while (0);
        do { unsigned __newval = (unsigned) (upperBoundAddress); __asm__ volatile ("mtcr LO:" "0xD014" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 3:
        do { unsigned __newval = (unsigned) (lowerBoundAddress); __asm__ volatile ("mtcr LO:" "0xD018" ", %0" :: "d" (__newval) : "memory"); } while (0);
        do { unsigned __newval = (unsigned) (upperBoundAddress); __asm__ volatile ("mtcr LO:" "0xD01C" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 4:
        do { unsigned __newval = (unsigned) (lowerBoundAddress); __asm__ volatile ("mtcr LO:" "0xD020" ", %0" :: "d" (__newval) : "memory"); } while (0);
        do { unsigned __newval = (unsigned) (upperBoundAddress); __asm__ volatile ("mtcr LO:" "0xD024" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 5:
        do { unsigned __newval = (unsigned) (lowerBoundAddress); __asm__ volatile ("mtcr LO:" "0xD028" ", %0" :: "d" (__newval) : "memory"); } while (0);
        do { unsigned __newval = (unsigned) (upperBoundAddress); __asm__ volatile ("mtcr LO:" "0xD02C" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 6:
        do { unsigned __newval = (unsigned) (lowerBoundAddress); __asm__ volatile ("mtcr LO:" "0xD030" ", %0" :: "d" (__newval) : "memory"); } while (0);
        do { unsigned __newval = (unsigned) (upperBoundAddress); __asm__ volatile ("mtcr LO:" "0xD034" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 7:
        do { unsigned __newval = (unsigned) (lowerBoundAddress); __asm__ volatile ("mtcr LO:" "0xD038" ", %0" :: "d" (__newval) : "memory"); } while (0);
        do { unsigned __newval = (unsigned) (upperBoundAddress); __asm__ volatile ("mtcr LO:" "0xD03C" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
  }
  __asm ("isync");
}
# 527 "../30_Bsw/Mpu/mpu.c"
static void mpu_vEnable_DataRd(uint8 protectionSet, uint8 range)
{
  ...
  {
    case 0:
        DPRERegisterValue.U = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xE010" : "=d" (__res) :: "memory"); __res; }));
        break;
    case 1:
        DPRERegisterValue.U = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xE014" : "=d" (__res) :: "memory"); __res; }));
        break;
    case 2:
        DPRERegisterValue.U = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xE018" : "=d" (__res) :: "memory"); __res; }));
        break;
    case 3:
        DPRERegisterValue.U = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xE01C" : "=d" (__res) :: "memory"); __res; }));
        break;
  }
  ...
  {
    case 0:
        do { unsigned __newval = (unsigned) (DPRERegisterValue.U); __asm__ volatile ("mtcr LO:" "0xE010" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 1:
        do { unsigned __newval = (unsigned) (DPRERegisterValue.U); __asm__ volatile ("mtcr LO:" "0xE014" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 2:
        do { unsigned __newval = (unsigned) (DPRERegisterValue.U); __asm__ volatile ("mtcr LO:" "0xE018" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 3:
        do { unsigned __newval = (unsigned) (DPRERegisterValue.U); __asm__ volatile ("mtcr LO:" "0xE01C" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
  }
  __asm ("isync");
}
# 583 "../30_Bsw/Mpu/mpu.c"
static void mpu_vEnable_DataWr(uint8 protectionSet, uint8 range)
{
  ...
  {
    case 0:
        DPWERegisterValue.U = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xE020" : "=d" (__res) :: "memory"); __res; }));
        break;
    case 1:
        DPWERegisterValue.U = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xE024" : "=d" (__res) :: "memory"); __res; }));
        break;
    case 2:
        DPWERegisterValue.U = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xE028" : "=d" (__res) :: "memory"); __res; }));
        break;
    case 3:
        DPWERegisterValue.U = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xE02C" : "=d" (__res) :: "memory"); __res; }));
        break;
  }
  ...
  {
    case 0:
        do { unsigned __newval = (unsigned) (DPWERegisterValue.U); __asm__ volatile ("mtcr LO:" "0xE020" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 1:
        do { unsigned __newval = (unsigned) (DPWERegisterValue.U); __asm__ volatile ("mtcr LO:" "0xE024" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 2:
        do { unsigned __newval = (unsigned) (DPWERegisterValue.U); __asm__ volatile ("mtcr LO:" "0xE028" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 3:
        do { unsigned __newval = (unsigned) (DPWERegisterValue.U); __asm__ volatile ("mtcr LO:" "0xE02C" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
  }
  __asm ("isync");
}
# 640 "../30_Bsw/Mpu/mpu.c"
static void mpu_vEnable_CodeExe(uint8 protectionSet, uint8 range)
{
  ...
  {
    case 0:
        CPXERegisterValue.U = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xE000" : "=d" (__res) :: "memory"); __res; }));
        break;
    case 1:
        CPXERegisterValue.U = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xE004" : "=d" (__res) :: "memory"); __res; }));
        break;
    case 2:
        CPXERegisterValue.U = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xE008" : "=d" (__res) :: "memory"); __res; }));
        break;
    case 3:
        CPXERegisterValue.U = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xE00C" : "=d" (__res) :: "memory"); __res; }));
        break;
  }
  ...
  {
    case 0:
        do { unsigned __newval = (unsigned) (CPXERegisterValue.U); __asm__ volatile ("mtcr LO:" "0xE000" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 1:
        do { unsigned __newval = (unsigned) (CPXERegisterValue.U); __asm__ volatile ("mtcr LO:" "0xE004" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 2:
        do { unsigned __newval = (unsigned) (CPXERegisterValue.U); __asm__ volatile ("mtcr LO:" "0xE008" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
    case 3:
        do { unsigned __newval = (unsigned) (CPXERegisterValue.U); __asm__ volatile ("mtcr LO:" "0xE00C" ", %0" :: "d" (__newval) : "memory"); } while (0);
        break;
  }
  __asm ("isync");
}
