  ...
  ) 
{
  ...
  uint32                  SourceAddress1[4] = {10U,20U,30U,40U};
  uint32                  DestAddress1[4] = {0U,0U,0U,0U};
  uint32                  SourceAddress2[4] = {1U,2U,3U,4U};
  uint32                  DestAddress2[4] = {0U,0U,0U,0U};
  uint32                  Sdcrc_me0;
  uint32                  Sdcrc_me1;
  uint32                  Rdcrc_me0;
  uint32                  Rdcrc_me1;  
...

{
  ...
  /* the values at source and destination addresses is arbitrarily chosen. 
     The contents do not matter */
  volatile uint32         SourceAddressTx[4] = {50U,60U,70U,80U};
  volatile uint32         DestAddressTx[4] = {0U,0U,0U,0U}; 
  volatile uint32         SourceAddress[4] = {100U,200U,300U,400U};
  volatile uint32         DestAddress[4] = {0U,0U,0U,0U};
  uint32                  Err0;
  uint32                  Err1;
  uint32                  DmaICH1 = 0U;
  uint32                  Timeout = DMA_TRANSFER_WAITTIMEOUT;
...
{
  Sl_TstRsltType       Result = DMA_TIMESTAMP_TEST_NOTEXECUTED; 
  uint32               SourceAddress1 = 10U;
  uint32               SourceAddress2 = 1U;
  uint32               DmaICH1 = 0U; 
  uint32               DmaICH2 = 0U;
