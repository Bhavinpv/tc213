...
/*IFX_MISRA_RULE_19_07_STATUS=Function like macro used to call the Tricore
intrinsic function*/
/* [PIPB-6718] - to be uncommented when using compiler v4.6.3 */
#if 1
#define CRC32(b, a) (__crc32((unsigned_int)(b),(unsigned_int)(a)))
#else /* to be used when using compiler v4.6.6.1 */
#define CRC32(a, b) (__crc32((unsigned_int)(b),(unsigned_int)(a)))
#endif
