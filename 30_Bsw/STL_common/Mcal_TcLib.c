...
#if ( MCAL_NO_OF_CORES == 3U )
uint32 *pMcal_IntDisableCounter[MCAL_NO_OF_CORES] = {&Mcal_IntDisableCounter[0],
              &Mcal_IntDisableCounter[1], &Mcal_IntDisableCounter[2]};
#elif ( MCAL_NO_OF_CORES == 2U )
uint32 *pMcal_IntDisableCounter[MCAL_NO_OF_CORES] = {&Mcal_IntDisableCounter[0],
              &Mcal_IntDisableCounter[1]};
#else /*( MCAL_NO_OF_CORES == 1U )*/
uint32 *pMcal_IntDisableCounter[MCAL_NO_OF_CORES] ={&Mcal_IntDisableCounter[0]};
#endif
#endif
...
#if ( MCAL_NO_OF_CORES == 3U )
uint32 *pMcal_SavedIntState[MCAL_NO_OF_CORES] = {&Mcal_SavedIntState[0],\
                    &Mcal_SavedIntState[1], &Mcal_SavedIntState[2]};
#elif ( MCAL_NO_OF_CORES == 2U )
uint32 *pMcal_SavedIntState[MCAL_NO_OF_CORES] = {&Mcal_SavedIntState[0],\
                                            &Mcal_SavedIntState[1]};
#else
uint32 *pMcal_SavedIntState[MCAL_NO_OF_CORES] = {&Mcal_SavedIntState[0]};
#endif
#endif
...
#if ( MCAL_NO_OF_CORES > 1U )
/*******************************************************************************
** Traceability     : [cover parentID=SAS_NAS_HE2_MCALLIB_PR75_6,
SAS_NAS_HE1_MCALLIB_PR75_6,SAS_NAS_MCALLIB_PR472]             [/cover]        **
**                                                                            **
...
SAS_NAS_HE1_MCALLIB_PR75_7,SAS_NAS_HE2_MCALLIB_PR75_7,SAS_NAS_MCALLIB_PR472]
                                                              [/cover]        **
**                                                                            **
...
uint32 Mcal_LockResource(uint32 *ResourcePtr)
{
  ...
  */
  ...
  if( ResourcePtr != NULL_PTR )
  {
    ...
    /*
    DSYNC is included after acquiring semaphore based on HW Errata:CPU_TC.H019
    */
    DSYNC();               
  }
...
void  Mcal_UnlockResource(uint32* ResourcePtr)
{
  ...
  {
    /*
    DSYNC is included before releasing semaphore based on HW Errata:CPU_TC.H019
    */
    DSYNC();  
    /*
