...
#define MCAL_SW_PATCH_VERSION  (7)
...
/* DSPR values for 21x chip*/
#define MCAL_DSPR0_SIZE      (0x0000C000U)
...
extern uint32 *pMcal_IntDisableCounter[MCAL_NO_OF_CORES];
#endif
/*This code section is added to test the fault case scenario */
#ifdef IFX_MCALLIB_DEBUG_WDGFINJ
extern uint32 *pMcal_SavedIntState[MCAL_NO_OF_CORES];
#endif
