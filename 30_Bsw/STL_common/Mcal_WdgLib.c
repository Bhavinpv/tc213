...
/*This code section is added to test the fault case scenario */
#ifdef IFX_MCALLIB_DEBUG_WDGFINJ
#if ( MCAL_NO_OF_CORES == 3U )
volatile uint32 *pMcal_ResetEndInitCounter[MCAL_NO_OF_CORES] =
    { &Mcal_ResetEndInitCounter[0], &Mcal_ResetEndInitCounter[1],
      &Mcal_ResetEndInitCounter[2] };
#elif (MCAL_NO_OF_CORES == 2U )
volatile uint32 *pMcal_ResetEndInitCounter[MCAL_NO_OF_CORES] =
    { &Mcal_ResetEndInitCounter[0], &Mcal_ResetEndInitCounter[1]};
#else
volatile uint32 *pMcal_ResetEndInitCounter[MCAL_NO_OF_CORES] =
  {&Mcal_ResetEndInitCounter[0]};
#endif
uint32 *pMcal_SafetyResetEndInitCounter = &Mcal_SafetyResetEndInitCounter;
uint32 *pMcal_WdgSafetyEndInitSem = &Mcal_WdgSafetyEndInitSem;
uint32 *pMcal_WdgSafetyEndInitSemRedn = &Mcal_WdgSafetyEndInitSemRedn;
#endif
...
/*This code section is added to test the fault case scenario */
#ifdef IFX_MCALLIB_DEBUG
uint32 *pSwdt_TimValue;
uint32 *pWdt0_TimValue;
#if ( MCAL_NO_OF_CORES > 1U )
uint32 *pWdt1_TimValue;
#endif
#if ( MCAL_NO_OF_CORES == 3U )
uint32 *pWdt2_TimValue;
#endif
#endif
...
/*This code section is added to test the fault case scenario */
#ifdef IFX_MCALLIB_DEBUG
void mcalLibWdgTestInitFn(void)
{
    /* Initialize the global pointers with static */
    pSwdt_TimValue = &Swdt_TimValue;
    pWdt0_TimValue = &Wdt0_TimValue;
    #if ( MCAL_NO_OF_CORES > 1U )
    pWdt1_TimValue = &Wdt1_TimValue;
    #endif
    #if ( MCAL_NO_OF_CORES == 3U )
    pWdt2_TimValue = &Wdt2_TimValue;
    #endif
}
#endif
/*******************************************************************************
