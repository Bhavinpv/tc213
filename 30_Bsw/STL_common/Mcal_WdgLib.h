...
extern uint32 *pSwdt_TimValue;
extern uint32 *pWdt0_TimValue;
#if ( MCAL_NO_OF_CORES > 1U )
extern uint32 *pWdt1_TimValue;
#endif
#if ( MCAL_NO_OF_CORES == 3U )
extern uint32 *pWdt2_TimValue;
#endif
#endif
/*This code section is added to test the fault case scenario */
#ifdef IFX_MCALLIB_DEBUG_WDGFINJ
extern volatile uint32 *pMcal_ResetEndInitCounter[MCAL_NO_OF_CORES];
extern uint32 *pMcal_SafetyResetEndInitCounter;
extern uint32 *pMcal_WdgSafetyEndInitSem;
extern uint32 *pMcal_WdgSafetyEndInitSemRedn;
#endif

#ifdef IFX_MCALLIB_DEBUG
extern void mcalLibWdgTestInitFn(void);
#endif
/*******************************************************************************
